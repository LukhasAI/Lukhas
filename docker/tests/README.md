...
This directory contains the test suite for the docker module.
...
- **`test_docker_unit.py`** - Unit tests for individual components
- **`test_docker_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=docker --cov-report=html
```
