...
2. Validate configuration: `python -c "import docker; print('OK')"`
3. Review logs in `logs/docker.log`
...
```bash
# Check module health
python -m docker --health-check

# Validate configuration
python -m docker --validate-config

# Test connections
python -m docker --test-connections

# Generate diagnostic report
python -m docker --diagnostic-report
```
