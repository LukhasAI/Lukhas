...
const UI_TEXT = {
  en: {
    ...
    protectedBy: 'Protected by passkeys (WebAuthn) and layered security controls',
  ...
  es: {
    ...
    protectedBy: 'Protegido por llaves de acceso (WebAuthn) y controles de seguridad por capas',
