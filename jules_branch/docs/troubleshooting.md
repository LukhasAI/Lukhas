...
# Jules--Branch Troubleshooting Guide
...
2. Validate configuration: `python -c "import Jules--branch; print('OK')"`
3. Review logs in `logs/Jules--branch.log`
...
```bash
# Check module health
python -m Jules--branch --health-check

# Validate configuration
python -m Jules--branch --validate-config

# Test connections
python -m Jules--branch --test-connections

# Generate diagnostic report
python -m Jules--branch --diagnostic-report
```
