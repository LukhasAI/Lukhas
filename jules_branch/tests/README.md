...
- **`test_Jules--branch_unit.py`** - Unit tests for individual components
- **`test_Jules--branch_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=Jules--branch --cov-report=html
```
