...
async def test_improvements():
    ...
    for i in range(5):
        ...
        print(f"   Drift {drift:.3f}: {'⚠️ EXCEEDS' if exceeds else '✅ OK'} "
    ...
    test_inputs = [
        ...
        {"valence": 0.0, "arousal": 0.2, "intensity": 0.8},    # Should be FOCUSED
        {"valence": 0.5, "arousal": 0.5, "intensity": 0.6},    # Should be CREATIVE
        {"valence": -0.7, "arousal": 0.2, "intensity": 0.5},   # Should be INTROSPECTIVE
        {"valence": 0.0, "arousal": 0.3, "intensity": 0.2},    # Should be DIFFUSE
    ]
    ...
    for inputs in test_inputs:
        ...
        print(f"   V={inputs['valence']:+.1f}, A={inputs['arousal']:.1f}, I={inputs['intensity']:.1f} "
