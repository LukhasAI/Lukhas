# Recovered_Components Troubleshooting Guide
...
2. Validate configuration: `python -c "import recovered_components; print('OK')"`
3. Review logs in `logs/recovered_components.log`
...
```bash
# Check module health
python -m recovered_components --health-check

# Validate configuration
python -m recovered_components --validate-config

# Test connections
python -m recovered_components --test-connections

# Generate diagnostic report
python -m recovered_components --diagnostic-report
```
