...
# Test_Data Troubleshooting Guide
...
2. Validate configuration: `python -c "import test_data; print('OK')"`
3. Review logs in `logs/test_data.log`
...
```bash
# Check module health
python -m test_data --health-check

# Validate configuration
python -m test_data --validate-config

# Test connections
python -m test_data --test-connections

# Generate diagnostic report
python -m test_data --diagnostic-report
```
