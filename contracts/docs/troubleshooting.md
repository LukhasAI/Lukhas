...
2. Validate configuration: `python -c "import contracts; print('OK')"`
3. Review logs in `logs/contracts.log`
...
```bash
# Check module health
python -m contracts --health-check

# Validate configuration
python -m contracts --validate-config

# Test connections
python -m contracts --test-connections

# Generate diagnostic report
python -m contracts --diagnostic-report
```
