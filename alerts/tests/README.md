...
This directory contains the test suite for the alerts module.
...
- **`test_alerts_unit.py`** - Unit tests for individual components
- **`test_alerts_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=alerts --cov-report=html
```
