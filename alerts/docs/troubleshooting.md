...
2. Validate configuration: `python -c "import alerts; print('OK')"`
...
```bash
# Check module health
python -m alerts --health-check

# Validate configuration
python -m alerts --validate-config

# Test connections
python -m alerts --test-connections

# Generate diagnostic report
python -m alerts --diagnostic-report
```
