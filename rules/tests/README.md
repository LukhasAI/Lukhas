...
This directory contains the test suite for the rules module.
...
- **`test_rules_unit.py`** - Unit tests for individual components
- **`test_rules_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=rules --cov-report=html
```
