...
2. Validate configuration: `python -c "import rules; print('OK')"`
3. Review logs in `logs/rules.log`
...
```bash
# Check module health
python -m rules --health-check

# Validate configuration
python -m rules --validate-config

# Test connections
python -m rules --test-connections

# Generate diagnostic report
python -m rules --diagnostic-report
```
