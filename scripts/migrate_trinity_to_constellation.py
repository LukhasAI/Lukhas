...
class TrinityToConstellationMigrator:
    ...
    def __init__(self, root_path: str = "."):
        ...
        self.stats = {"files_processed": 0, "files_modified": 0, "replacements_made": 0, "errors": []}
    ...
    def run_migration(self, dry_run: bool = False) -> None:
        ...
        logger.info(
            f"📈 Summary: {self.stats['files_modified']}/{self.stats['files_processed']} files modified, {self.stats['replacements_made']} replacements"
        )
