#!/usr/bin/env python3
"""
Batch annotate B018 violations with T4 annotations.
Specifically targets the __all__ module export validation pattern.
"""
...
T4_ANNOTATION = """# T4: code=B018 | ticket=GH-1031 | owner=matriz-team | status=accepted
# reason: Module export validation - __all__ check for dynamic adapter loading
# estimate: 0h | priority: low | dependencies: none
"""


def get_b018_violations():
    """Get all B018 violations from T4 check."""
