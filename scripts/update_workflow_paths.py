...
PATH_REPLACEMENTS = [
    ...
    (r'isort --check-only lukhas/ tests/', 'isort --check-only consciousness/ identity/ governance/ memory/ core/ bio/ tests/'),
    ...
    (r'grep -r "from lukhas\.quarantine" lukhas/ candidate/', 'grep -r "from lukhas.quarantine" consciousness/ identity/ governance/ memory/ core/ bio/ labs/'),
    ...
    (r'if grep -q "ProductionGuardian" lukhas/governance/guardian\.py', 'if grep -q "ProductionGuardian" labs/governance/guardian/guardian.py'),
    ...
    (r'startswith\(\("lukhas/","MATRIZ/"\)\)', 'startswith(("consciousness/","identity/","governance/","memory/","core/","bio/","MATRIZ/"))'),
    (r"path\.startswith\(\(\"lukhas/\", \"MATRIZ/\"\)\)", 'path.startswith(("consciousness/", "identity/", "governance/", "memory/", "core/", "bio/", "MATRIZ/"))'),
    ...
    (r"'lukhas/': 'Core LUKHAS',", "'consciousness/': 'Consciousness',\n              'identity/': 'Identity',\n              'governance/': 'Governance',\n              'memory/': 'Memory',\n              'core/': 'Core',"),
    (r"'lukhas/core/',", "'core/',"),
    ...
    # Comments
    (r'# Phase B: Hot paths \(lukhas/adapters, lukhas/core/reliability\)', '# Phase B: Hot paths (bridge/adapters, core/reliability)'),
