...
def main():
    ...
    unknown_owners = [d for d in docs if d.get("owner") == "unknown" and not d.get("redirect")]
    ...
    print(
        "python3 scripts/owners_queue.py | gh issue create --title 'Docs: Owner Assignment Queue' --body-file - --label 'docs:ownership'"
    )
    print()
