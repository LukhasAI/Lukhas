...
2. Validate configuration: `python -c "import scripts; print('OK')"`
3. Review logs in `logs/scripts.log`
...
```bash
# Check module health
python -m scripts --health-check

# Validate configuration
python -m scripts --validate-config

# Test connections
python -m scripts --test-connections

# Generate diagnostic report
python -m scripts --diagnostic-report
```
