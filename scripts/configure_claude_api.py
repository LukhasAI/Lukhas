...
def update_env_file(key: str, value: str):
    ...
    if not found:
        ...
        updated_lines.append("# Anthropic API Key: https://console.anthropic.com/\n")
        updated_lines.append(f"{key}={value}\n")
...
def interactive_setup():
    ...
    print_header("🤖 Claude API Configuration for LUKHAS")
...
def main():
    ...
    # Test mode
    if args.test:
        print_header("🧪 Testing Claude API Configuration")
