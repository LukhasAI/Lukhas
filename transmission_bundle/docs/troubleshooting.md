...
# Transmission_Bundle Troubleshooting Guide
...
2. Validate configuration: `python -c "import transmission_bundle; print('OK')"`
3. Review logs in `logs/transmission_bundle.log`
...
```bash
# Check module health
python -m transmission_bundle --health-check

# Validate configuration
python -m transmission_bundle --validate-config

# Test connections
python -m transmission_bundle --test-connections

# Generate diagnostic report
python -m transmission_bundle --diagnostic-report
```
