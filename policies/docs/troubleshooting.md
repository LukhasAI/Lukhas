...
# Policies Troubleshooting Guide
...
2. Validate configuration: `python -c "import policies; print('OK')"`
3. Review logs in `logs/policies.log`
...
```bash
# Check module health
python -m policies --health-check

# Validate configuration
python -m policies --validate-config

# Test connections
python -m policies --test-connections

# Generate diagnostic report
python -m policies --diagnostic-report
```
