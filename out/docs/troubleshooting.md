...
2. Validate configuration: `python -c "import out; print('OK')"`
3. Review logs in `logs/out.log`
...
```bash
# Check module health
python -m out --health-check

# Validate configuration
python -m out --validate-config

# Test connections
python -m out --test-connections

# Generate diagnostic report
python -m out --diagnostic-report
```
