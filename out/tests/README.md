...
- **`test_out_unit.py`** - Unit tests for individual components
- **`test_out_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=out --cov-report=html
```
