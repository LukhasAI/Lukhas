    ...
    def parse_enum_call_args(
        ...
        if isinstance(names, StrExpr):
            ...
            if is_StrExpr_list(seq_items):
                ...
                return self.fail_enum_call_arg(
                    f"{class_name}() with tuple or list expects strings or (name, value) pairs",
                    call,
                )
            ...
            if (
                ...
                return self.fail_enum_call_arg(
                    f"Second argument of {class_name}() must be string, tuple, list or dict literal for mypy to determine Enum members",
                    call,
                )
        else:
