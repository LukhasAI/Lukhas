    ...
    def test(*args: Any, **kwargs: Any) -> None:
        ...
        for c in cases:
            ...
            assert expected_error not in expected_errors, (
                ...
                f"expect an error for {expected_error}"
            )
...
class StubtestMiscUnit(unittest.TestCase):
    def test_output(self) -> None:
        ...
        expected = (
            f"{TEST_MODULE_NAME}.bad is inconsistent, "
    ...
    def test_mypy_build(self) -> None:
        ...
        assert output == (
            f"error: not checking stubs due to failed mypy compile:\n{TEST_MODULE_NAME}.pyi:1: "
            "error: Invalid syntax  [syntax]\n"
        )

        output = run_stubtest(stub="def f(): ...\ndef f(): ...", runtime="", options=[])
        assert output == (
            f"error: not checking stubs due to mypy build errors:\n{TEST_MODULE_NAME}.pyi:2: "
