...
class Goto(ControlOp):
    ...
    def __repr__(self) -> str:
        return f"<Goto {self.label.label}>"
...
class MethodCall(RegisterOp):
    ...
    def __init__(self, obj: Value, method: str, args: list[Value], line: int = -1) -> None:
        ...
        assert method_ir is not None, f"{self.receiver_type.name} doesn't have method {method}"
...
class GetAttr(RegisterOp):
    ...
    def __init__(
        ...
        assert isinstance(obj.type, RInstance), f"Attribute access not supported: {obj.type}"
