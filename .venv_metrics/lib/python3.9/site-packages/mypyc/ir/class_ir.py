...
class ClassIR:
    ...
    def __repr__(self) -> str:
        return (
            "ClassIR("
            f"name={self.name}, module_name={self.module_name}, "
            f"is_trait={self.is_trait}, is_generated={self.is_generated}, "
            f"is_abstract={self.is_abstract}, is_ext_class={self.is_ext_class}, "
            f"is_final_class={self.is_final_class}"
            ")"
        )
    ...
    def deserialize(cls, data: JsonDict, ctx: DeserMaps) -> ClassIR:
        ...
        assert fullname in ctx.classes, f"Class {fullname} not in deser class map"
...
def deserialize_vtable_entry(data: JsonDict, ctx: DeserMaps) -> VTableMethod:
    ...
    assert False, "Bogus vtable .class: {}".format(data[".class"])
