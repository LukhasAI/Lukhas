...
# Trace_Logs Troubleshooting Guide
...
2. Validate configuration: `python -c "import trace_logs; print('OK')"`
3. Review logs in `logs/trace_logs.log`
...
```bash
# Check module health
python -m trace_logs --health-check

# Validate configuration
python -m trace_logs --validate-config

# Test connections
python -m trace_logs --test-connections

# Generate diagnostic report
python -m trace_logs --diagnostic-report
```
