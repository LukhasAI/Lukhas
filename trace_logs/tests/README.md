...
- **`test_trace_logs_unit.py`** - Unit tests for individual components
- **`test_trace_logs_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=trace_logs --cov-report=html
```
