...
This directory contains the test suite for the audit module.
...
- **`test_audit_unit.py`** - Unit tests for individual components
- **`test_audit_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=audit --cov-report=html
```
