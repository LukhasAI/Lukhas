...
2. Validate configuration: `python -c "import audit; print('OK')"`
3. Review logs in `logs/audit.log`
...
```bash
# Check module health
python -m audit --health-check

# Validate configuration
python -m audit --validate-config

# Test connections
python -m audit --test-connections

# Generate diagnostic report
python -m audit --diagnostic-report
```
