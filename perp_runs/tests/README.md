...
This directory contains the test suite for the perp_runs module.
...
- **`test_perp_runs_unit.py`** - Unit tests for individual components
- **`test_perp_runs_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=perp_runs --cov-report=html
```
