...
# Perp_Runs Troubleshooting Guide
...
2. Validate configuration: `python -c "import perp_runs; print('OK')"`
3. Review logs in `logs/perp_runs.log`
...
```bash
# Check module health
python -m perp_runs --health-check

# Validate configuration
python -m perp_runs --validate-config

# Test connections
python -m perp_runs --test-connections

# Generate diagnostic report
python -m perp_runs --diagnostic-report
```
