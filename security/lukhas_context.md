...
type: documentation
---
# Security Module Context - Vendor-Neutral AI Guidance
...
- **🛡️ Watch Star (Guardian)**: Primary security enforcement
- **⚛️ Anchor Star (Identity)**: Identity protection and authentication
- **✦ Trail Star (Memory)**: Security audit trail and logging
...
│   ├── README.md
│   ├── GUARDIAN_CAPABILITIES_GUIDE.md
│   ├── GUARDIAN_SECURITY_ARCHITECTURE.md
│   ├── SECURITY_AUTOMATION_GUIDE.md
...
- **I (Intent)**: Identity verification with ΛID
...
The security module works closely with the Guardian system (🛡️):
...
- **Identity** ([../identity/](../identity/)) - ΛID authentication and authorization
