...
def scan_consciousness_security() -> dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            if not MEMORY_AVAILABLE:
                threats_detected.append(
                    {"type": "memory_unavailable", "severity": "medium", "message": "Memory system not available"}
                )
        except ImportError:
            threats_detected.append(
                {"type": "memory_import_failure", "severity": "high", "message": "Cannot import memory system"}
            )
        ...
        try:
            ...
            threats_detected.append(
                {"type": "agent_import_failure", "severity": "high", "message": "Cannot import agent system"}
            )
