...
2. Validate configuration: `python -c "import security; print('OK')"`
3. Review logs in `logs/security.log`
...
```bash
# Check module health
python -m security --health-check

# Validate configuration
python -m security --validate-config

# Test connections
python -m security --test-connections

# Generate diagnostic report
python -m security --diagnostic-report
```
