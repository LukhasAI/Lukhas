    ...
    def __init__(
        ...
        *,
        ...
        if ctype == "CPyTagged":
            ...
            assert False, f"Unrecognized ctype: {ctype!r}"
...
class RTuple(RType):
    ...
    def __str__(self) -> str:
        return "tuple[{}]".format(", ".join(str(typ) for typ in self.types))

    def __repr__(self) -> str:
        return "<RTuple {}>".format(", ".join(repr(typ) for typ in self.types))
...
class RUnion(RType):
    ...
    def __repr__(self) -> str:
        return "<RUnion {}>".format(", ".join(str(item) for item in self.items))

    def __str__(self) -> str:
        return "union[{}]".format(", ".join(str(item) for item in self.items))
