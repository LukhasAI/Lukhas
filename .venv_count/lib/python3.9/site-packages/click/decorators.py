...
def command(
    ...
    cls: t.Optional[type[CmdType]] = None,
    **attrs: t.Any,
...
def group(
    ...
    cls: t.Optional[type[GrpType]] = None,
    **attrs: t.Any,
...
def argument(
    *param_decls: str, cls: t.Optional[type[Argument]] = None, **attrs: t.Any
) -> t.Callable[[FC], FC]:
...
def option(
    *param_decls: str, cls: t.Optional[type[Option]] = None, **attrs: t.Any
) -> t.Callable[[FC], FC]:
