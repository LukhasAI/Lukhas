...
def batch(iterable: t.Iterable[V], batch_size: int) -> list[tuple[V, ...]]:
...
class Context:
    ...
    def __init__(
        ...
        help_option_names: t.Optional[list[str]] = None,
    ...
    def find_object(self, object_type: type[V]) -> t.Optional[V]:
...
class Command(BaseCommand):
    ...
    def __init__(
        ...
        params: t.Optional[list["Parameter"]] = None,
...
class MultiCommand(Command):
    ...
    ) -> tuple[t.Optional[str], t.Optional[Command], list[str]]:
...
class Group(MultiCommand):
    ...
    #:
    #: .. versionadded:: 8.0
    command_class: t.Optional[type[Command]] = None
    ...
    #:
    #: .. versionadded:: 8.0
    group_class: t.Optional[t.Union[type["Group"], type[type]]] = None
...
class CommandCollection(MultiCommand):
    ...
    def __init__(
        self,
        name: t.Optional[str] = None,
        sources: t.Optional[list[MultiCommand]] = None,
        **attrs: t.Any,
    ) -> None:
        super().__init__(name, **attrs)
        #: The list of registered multi commands.
        self.sources: list[MultiCommand] = sources or []
...
class Parameter:
    ...
    def __init__(
        ...
        shell_complete: t.Optional[
            t.Callable[
                ...
                t.Union[list["CompletionItem"], list[str]],
            ]
        ] = None,
    ) -> None:
    ...
    ) -> tuple[t.Optional[str], list[str], list[str]]:
        raise NotImplementedError()
    ...
    def handle_parse_result(
        self, ctx: Context, opts: t.Mapping[str, t.Any], args: list[str]
    ...
    def get_help_record(self, ctx: Context) -> t.Optional[tuple[str, str]]:
        pass
