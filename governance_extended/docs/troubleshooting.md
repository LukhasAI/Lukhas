...
# Governance_Extended Troubleshooting Guide
...
2. Validate configuration: `python -c "import governance_extended; print('OK')"`
3. Review logs in `logs/governance_extended.log`
...
```bash
# Check module health
python -m governance_extended --health-check

# Validate configuration
python -m governance_extended --validate-config

# Test connections
python -m governance_extended --test-connections

# Generate diagnostic report
python -m governance_extended --diagnostic-report
```
