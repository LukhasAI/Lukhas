...
This directory contains the test suite for the governance_extended module.
...
- **`test_governance_extended_unit.py`** - Unit tests for individual components
- **`test_governance_extended_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=governance_extended --cov-report=html
```
