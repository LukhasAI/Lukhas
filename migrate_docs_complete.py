...
VOCABULARY = {
    ...
    'owner': ['core-dev', 'consciousness-architect', 'memory-specialist', 'identity-specialist', 
              'bio-specialist', 'quantum-specialist', 'guardian-specialist', 'vision-specialist',
              'dream-specialist', 'ethics-officer', 'integration-engineer', 'api-specialist',
              'testing-specialist', 'principal-repo-surgeon', 'brand-manager', 'docs-maintainer'],
    'tags': ['architecture', 'consciousness', 'memory', 'identity', 'bio', 'quantum', 'dream',
             'vision', 'ethics', 'guardian', 'api', 'integration', 'testing', 'deployment',
             'security', 'performance', 'migration', 'tutorial', 'reference', 'troubleshooting'],
    'facets': {
...
def categorize_file(filepath):
    ...
    if any(x in path_str for x in ['constellation', 'framework', 'architecture', 'theory', 
                                   'consciousness', 'quantum', 'bio', 'matrix', 'matriz']):
        return 'concepts'
