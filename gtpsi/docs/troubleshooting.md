...
2. Validate configuration: `python -c "import gtpsi; print('OK')"`
3. Review logs in `logs/gtpsi.log`
...
```bash
# Check module health
python -m gtpsi --health-check

# Validate configuration
python -m gtpsi --validate-config

# Test connections
python -m gtpsi --test-connections

# Generate diagnostic report
python -m gtpsi --diagnostic-report
```
