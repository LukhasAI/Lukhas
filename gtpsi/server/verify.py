...
from .. import (
    GestureType, RiskLevel, GestureFeatures, GestureChallenge, 
    GestureApproval, requires_gtpsi_approval, get_action_risk_level,
    get_max_approval_time, HIGH_RISK_ACTIONS
)
...
async def demonstrate_gtpsi_workflow():
    ...
    from ..edge import MockStrokeData, EdgeGestureProcessor, create_gesture_recognizer
