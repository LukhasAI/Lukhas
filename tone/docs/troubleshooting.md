...
2. Validate configuration: `python -c "import tone; print('OK')"`
3. Review logs in `logs/tone.log`
...
```bash
# Check module health
python -m tone --health-check

# Validate configuration
python -m tone --validate-config

# Test connections
python -m tone --test-connections

# Generate diagnostic report
python -m tone --diagnostic-report
```
