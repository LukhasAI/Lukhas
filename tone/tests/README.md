...
This directory contains the test suite for the tone module.
...
- **`test_tone_unit.py`** - Unit tests for individual components
- **`test_tone_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=tone --cov-report=html
```
