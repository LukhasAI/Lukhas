...
Each star represents a domain of consciousness technology, from Identity (⚛️) 
to Dreams (🌙) to Ethics (⚖️), forming a complete navigation system."
...
```mermaid
graph TD
    A[Creating LUKHAS Content?] --> B{Who is the audience?}
    ...
    D --> I[Use Constellation Framework 🌟]
    I --> J[8 stars: Full constellation navigation]
    I --> K[User benefit and experience focus]
    I --> L[Metaphorical and accessible language]
```
