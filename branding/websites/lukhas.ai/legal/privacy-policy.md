...
**Data Controller**: LUKHAS AI Inc.
**Address**: 123 Innovation Drive, San Francisco, CA 94103, United States

**Privacy Contact**: privacy@lukhas.ai
...
- **Cloud Infrastructure**: AWS (US-East, EU-Central regions) (data hosting, compute)
- **Authentication Services**: WebAuthn credential storage providers
- **Analytics**: Aggregated usage analytics (anonymized)
- **Payment Processing**: Stripe (for paid tiers)
...
**Exercise Rights**: Contact privacy@lukhas.ai
...
The Service is not intended for users under 18 years old. We do not knowingly collect data from children. If you believe we have collected data from a child, contact privacy@lukhas.ai and we will promptly delete it.
...
- **Transparency Reports**: Quarterly data request statistics at lukhas.ai/transparency
- **Security Updates**: Security advisories at lukhas.ai/security
- **Data Processing Agreement**: Enterprise DPA available at lukhas.ai/legal/dpa
- **Subprocessors List**: Third-party processors at lukhas.ai/legal/subprocessors
