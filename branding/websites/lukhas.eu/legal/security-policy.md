...
**EU Data Residency**:
- All EU data stored in Frankfurt, Germany (AWS eu-central-1)
...
- Security advisories published at lukhas.eu/security
...
Current subprocessors: lukhas.eu/legal/subprocessors
- Cloud infrastructure: AWS (EU-Central-1 Frankfurt)
- Email services: SendGrid (EU region)
- Analytics: Self-hosted EU (anonymized) (anonymized only)
- Payment processing: Stripe (EU entity)
...
- Quarterly transparency reports: lukhas.eu/transparency
- Security advisories: lukhas.eu/security
...
### 16.1 Security Team
**Security Email**: security-eu@lukhas.eu
**PGP Key**: 1234 5678 90AB CDEF 1234 5678 90AB CDEF 1234 5678
**PGP Key Location**: lukhas.eu/pgp-key.asc
...
- Published on lukhas.eu/security
...
- [ ] Report suspicious activity to security-eu@lukhas.eu
...
**For security vulnerabilities, contact**: security-eu@lukhas.eu
