...
This directory contains the test suite for the branding module.
...
- **`test_branding_unit.py`** - Unit tests for individual components
- **`test_branding_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=branding --cov-report=html
```
