...
# Branding Troubleshooting Guide
...
2. Validate configuration: `python -c "import branding; print('OK')"`
3. Review logs in `logs/branding.log`
...
```bash
# Check module health
python -m branding --health-check

# Validate configuration
python -m branding --validate-config

# Test connections
python -m branding --test-connections

# Generate diagnostic report
python -m branding --diagnostic-report
```
