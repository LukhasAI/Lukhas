...
### 1.1 Governing Law
{{#IF_EU}}
These Terms are governed by the laws of the European Union and {{EU_MEMBER_STATE}}. All disputes shall be resolved in accordance with EU regulations including GDPR and the EU AI Act.
{{/IF_EU}}

{{#IF_US}}
These Terms are governed by the laws of {{US_STATE}} and the United States. All disputes shall be resolved in accordance with applicable federal and state regulations.
{{/IF_US}}

{{#IF_GENERAL}}
These Terms are governed by international best practices and the laws of {{JURISDICTION}}.
{{/IF_GENERAL}}
...
{{#IF_US}}
### 6.2 US Privacy Regulations
For US users, we comply with applicable state regulations (CCPA, CPRA, etc.):
- **Disclosure**: Annual privacy notice updates
- **Opt-out rights**: Do Not Sell My Personal Information
- **Data access**: Free data access requests (twice annually)
...
All prices are in {{CURRENCY}} and exclude applicable taxes.
{{/IF_PAID_SERVICE}}
...
- {{LIABILITY_CAP_AMOUNT}}, whichever is GREATER
...
Before filing a claim, contact us at {{LEGAL_EMAIL}} to attempt informal resolution.
...
You may terminate your account at any time through account settings or by contacting {{SUPPORT_EMAIL}}.
...
|---------|------|---------|
| 1.0 | {{VERSION_1_DATE}} | Initial Terms of Service |
