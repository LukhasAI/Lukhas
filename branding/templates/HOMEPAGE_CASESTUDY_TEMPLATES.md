## Lukhas Branding: Homepage & Case Study Templates
This document provides canonical templates for Lukhas homepage and case study markdown files, designed to ensure consistency, accessibility, and evidence-backed claims across all Lukhas web properties.
