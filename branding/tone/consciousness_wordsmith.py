...
"""
LUKHAS Consciousness Wordsmith Module
...
# Export the main class with a shorter alias for easier imports
ConsciousnessWordsmith = LUKHASConsciousnessWordsmith

__all__ = ["ConsciousnessWordsmith", "LUKHASConsciousnessWordsmith"]
