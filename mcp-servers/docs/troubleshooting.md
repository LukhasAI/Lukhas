...
2. Validate configuration: `python -c "import mcp-servers; print('OK')"`
3. Review logs in `logs/mcp-servers.log`
...
```bash
# Check module health
python -m mcp-servers --health-check

# Validate configuration
python -m mcp-servers --validate-config

# Test connections
python -m mcp-servers --test-connections

# Generate diagnostic report
python -m mcp-servers --diagnostic-report
```
