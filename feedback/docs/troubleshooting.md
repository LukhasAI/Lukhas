...
# Feedback Troubleshooting Guide
...
2. Validate configuration: `python -c "import feedback; print('OK')"`
3. Review logs in `logs/feedback.log`
...
```bash
# Check module health
python -m feedback --health-check

# Validate configuration
python -m feedback --validate-config

# Test connections
python -m feedback --test-connections

# Generate diagnostic report
python -m feedback --diagnostic-report
```
