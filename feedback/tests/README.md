...
This directory contains the test suite for the feedback module.
...
- **`test_feedback_unit.py`** - Unit tests for individual components
- **`test_feedback_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=feedback --cov-report=html
```
