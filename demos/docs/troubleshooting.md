...
2. Validate configuration: `python -c "import demos; print('OK')"`
3. Review logs in `logs/demos.log`
...
```bash
# Check module health
python -m demos --health-check

# Validate configuration
python -m demos --validate-config

# Test connections
python -m demos --test-connections

# Generate diagnostic report
python -m demos --diagnostic-report
```
