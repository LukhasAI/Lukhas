...
This directory contains the test suite for the demos module.
...
- **`test_demos_unit.py`** - Unit tests for individual components
- **`test_demos_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=demos --cov-report=html
```
