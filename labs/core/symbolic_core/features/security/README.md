...
status: active
type: documentation
module: core.symbolic_core.features.security
version: 1.0.0
---
...
Production engine for applying security levels to LUKHAS glyphs. Supports:
...
```python
from labs.core.symbolic_core.features.security import GlyphRedactorEngine
...
Active production module - current implementation of glyph security.
