...
2. Validate configuration: `python -c "import candidate; print('OK')"`
3. Review logs in `logs/candidate.log`
...
```bash
# Check module health
python -m candidate --health-check

# Validate configuration
python -m candidate --validate-config

# Test connections
python -m candidate --test-connections

# Generate diagnostic report
python -m candidate --diagnostic-report
```
