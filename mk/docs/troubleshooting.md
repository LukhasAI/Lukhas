...
2. Validate configuration: `python -c "import mk; print('OK')"`
3. Review logs in `logs/mk.log`
...
```bash
# Check module health
python -m mk --health-check

# Validate configuration
python -m mk --validate-config

# Test connections
python -m mk --test-connections

# Generate diagnostic report
python -m mk --diagnostic-report
```
