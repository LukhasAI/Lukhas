...
2. Validate configuration: `python -c "import serve; print('OK')"`
3. Review logs in `logs/serve.log`
...
```bash
# Check module health
python -m serve --health-check

# Validate configuration
python -m serve --validate-config

# Test connections
python -m serve --test-connections

# Generate diagnostic report
python -m serve --diagnostic-report
```
