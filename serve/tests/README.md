...
This directory contains the test suite for the serve module.
...
- **`test_serve_unit.py`** - Unit tests for individual components
- **`test_serve_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=serve --cov-report=html
```
