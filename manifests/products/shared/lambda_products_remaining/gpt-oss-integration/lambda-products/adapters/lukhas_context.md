# products.shared.lambda_products_remaining.gpt-oss-integration.lambda-products.adapters
...
- **Logging**: `products.shared.lambda_products_remaining.gpt-oss-integration.lambda-products.adapters: INFO`
