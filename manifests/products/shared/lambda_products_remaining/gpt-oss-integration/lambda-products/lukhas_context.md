# products.shared.lambda_products_remaining.gpt-oss-integration.lambda-products
...
- **Logging**: `products.shared.lambda_products_remaining.gpt-oss-integration.lambda-products: INFO`
