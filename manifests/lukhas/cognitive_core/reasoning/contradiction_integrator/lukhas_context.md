...
owner: unassigned
colony: -
manifest_path: manifests/lukhas/cognitive_core/reasoning/contradiction_integrator/module.manifest.json
matriz: [thought]
---
...
- **Logging**: `lukhas.cognitive_core.reasoning.contradiction_integrator: INFO`
