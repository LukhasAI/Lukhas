...
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/lukhas/memory/backends/faiss_store/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `lukhas.memory.backends.faiss_store: INFO`
