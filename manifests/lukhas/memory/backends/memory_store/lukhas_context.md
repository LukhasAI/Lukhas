---
module: lukhas.memory.backends.memory_store
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/lukhas/memory/backends/memory_store/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `lukhas.memory.backends.memory_store: INFO`
