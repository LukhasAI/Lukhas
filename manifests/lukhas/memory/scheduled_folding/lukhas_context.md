...
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/lukhas/memory/scheduled_folding/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `lukhas.memory.scheduled_folding: INFO`
