---
module: lukhas.governance.guardian.guardian_impl
star: 🛡️ Watch (Guardian)
tier: T3_standard
owner: unassigned
colony: ethics
manifest_path: manifests/lukhas/governance/guardian/guardian_impl/module.manifest.json
matriz: [risk]
---
...
- **Logging**: `lukhas.governance.guardian.guardian_impl: INFO`
