...
owner: unassigned
colony: simulation
manifest_path: manifests/candidate/consciousness/systems/cognitive_systems/module.manifest.json
matriz: [thought]
---
...
- **Logging**: `candidate.consciousness.systems.cognitive_systems: INFO`
