...
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/interfaces/base/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `candidate.memory.interfaces.base: INFO`
