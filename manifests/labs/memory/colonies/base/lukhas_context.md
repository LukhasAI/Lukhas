---
module: candidate.memory.colonies.base
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/colonies/base/module.manifest.json
matriz: [memory]
---
# candidate.memory.colonies.base
...
- **Logging**: `candidate.memory.colonies.base: INFO`
