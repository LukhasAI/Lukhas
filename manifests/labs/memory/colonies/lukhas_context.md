---
module: candidate.memory.colonies
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/colonies/module.manifest.json
matriz: [memory]
---
# candidate.memory.colonies
...
- **Logging**: `candidate.memory.colonies: INFO`
