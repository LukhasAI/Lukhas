---
module: candidate.memory.temporal
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/temporal/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `candidate.memory.temporal: INFO`
