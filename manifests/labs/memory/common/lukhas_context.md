---
module: candidate.memory.common
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/common/module.manifest.json
matriz: [memory]
---
# candidate.memory.common
...
- **Logging**: `candidate.memory.common: INFO`
