---
module: candidate.memory.systems.memory_learning
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/systems/memory_learning/module.manifest.json
matriz: [memory]
---
# candidate.memory.systems.memory_learning
...
- **Logging**: `candidate.memory.systems.memory_learning: INFO`
