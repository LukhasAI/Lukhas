---
module: candidate.memory.episodic
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/episodic/module.manifest.json
matriz: [memory]
---
# candidate.memory.episodic
...
- **Logging**: `candidate.memory.episodic: INFO`
