...
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/learning/flagship/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `candidate.memory.learning.flagship: INFO`
