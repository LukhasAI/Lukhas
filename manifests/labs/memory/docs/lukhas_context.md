---
module: candidate.memory.docs
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/docs/module.manifest.json
matriz: [memory]
---
# candidate.memory.docs
...
- **Logging**: `candidate.memory.docs: INFO`
