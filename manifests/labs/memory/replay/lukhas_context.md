---
module: candidate.memory.replay
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/replay/module.manifest.json
matriz: [memory]
---
# candidate.memory.replay
...
- **Logging**: `candidate.memory.replay: INFO`
