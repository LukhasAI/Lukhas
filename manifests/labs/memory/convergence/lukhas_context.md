---
module: candidate.memory.convergence
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/convergence/module.manifest.json
matriz: [memory]
---
# candidate.memory.convergence
...
- **Logging**: `candidate.memory.convergence: INFO`
