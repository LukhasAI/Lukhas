---
module: candidate.memory.core.interfaces
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/core/interfaces/module.manifest.json
matriz: [memory]
---
# candidate.memory.core.interfaces
...
- **Logging**: `candidate.memory.core.interfaces: INFO`
