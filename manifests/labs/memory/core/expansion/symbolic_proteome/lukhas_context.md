...
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/core/expansion/symbolic_proteome/module.manifest.json
matriz: [memory]
---
...
- **Logging**: `candidate.memory.core.expansion.symbolic_proteome: INFO`
