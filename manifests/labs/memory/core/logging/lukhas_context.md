---
module: candidate.memory.core.logging
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/core/logging/module.manifest.json
matriz: [memory]
---
# candidate.memory.core.logging
...
- **Logging**: `candidate.memory.core.logging: INFO`
