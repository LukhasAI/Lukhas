---
module: candidate.memory.core
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/core/module.manifest.json
matriz: [memory]
---
# candidate.memory.core
...
- **Logging**: `candidate.memory.core: INFO`
