---
module: candidate.memory.core.chain
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/core/chain/module.manifest.json
matriz: [memory]
---
# candidate.memory.core.chain
...
- **Logging**: `candidate.memory.core.chain: INFO`
