---
module: candidate.memory.core.tracker
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/core/tracker/module.manifest.json
matriz: [memory]
---
# candidate.memory.core.tracker
...
- **Logging**: `candidate.memory.core.tracker: INFO`
