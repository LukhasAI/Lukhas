---
module: candidate.memory.services.base
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/services/base/module.manifest.json
matriz: [memory]
---
# candidate.memory.services.base
...
- **Logging**: `candidate.memory.services.base: INFO`
