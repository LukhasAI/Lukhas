---
module: candidate.memory.adapters
star: ✦ Trail (Memory)
tier: T2_important
owner: triage@lukhas
colony: memory
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/memory/adapters/module.manifest.json
matriz: [memory]
---
# candidate.memory.adapters
...
- **Logging**: `candidate.memory.adapters: INFO`
