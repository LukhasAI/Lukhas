---
module: candidate.core.orchestration.config
star: Supporting
tier: T4_experimental
owner: unassigned
colony: -
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/core/orchestration/config/module.manifest.json
matriz: [intent]
---
# candidate.core.orchestration.config
...
- **Logging**: `candidate.core.orchestration.config: INFO`
