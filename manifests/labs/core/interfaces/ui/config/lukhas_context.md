---
module: candidate.core.interfaces.ui.config
star: 🔬 Horizon (Vision)
tier: T3_standard
owner: unassigned
colony: interface
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/core/interfaces/ui/config/module.manifest.json
matriz: [action]
---
# candidate.core.interfaces.ui.config
...
- **Logging**: `candidate.core.interfaces.ui.config: INFO`
