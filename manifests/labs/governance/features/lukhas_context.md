---
module: candidate.governance.features
star: 🛡️ Watch (Guardian)
tier: T2_important
owner: triage@lukhas
colony: -
manifest_path: /Users/agi_dev/LOCAL-REPOS/Lukhas-main-worktree/manifests/labs/governance/features/module.manifest.json
matriz: [risk]
---
# candidate.governance.features
...
- **Logging**: `candidate.governance.features: INFO`
