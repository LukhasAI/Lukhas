...
---
module: candidate.consciousness.states
star: 🌊 Flow (Consciousness)
tier: T2_important
owner: unassigned
colony: simulation
manifest_path: manifests/labs/consciousness/states/module.manifest.json
matriz: [thought]
---
...
- **Logging**: `candidate.consciousness.states: INFO`
