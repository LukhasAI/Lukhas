...
owner: unassigned
colony: -
manifest_path: manifests/labs/orchestration/brain/neuro_symbolic/neuro_symbolic_engine/module.manifest.json
matriz: [intent]
---
...
- **Logging**: `candidate.orchestration.brain.neuro_symbolic.neuro_symbolic_engine: INFO`
