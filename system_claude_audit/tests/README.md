...
- **`test_SYSTEM_CLAUDE_AUDIT_unit.py`** - Unit tests for individual components
- **`test_SYSTEM_CLAUDE_AUDIT_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=SYSTEM_CLAUDE_AUDIT --cov-report=html
```
