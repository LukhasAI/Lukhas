...
Hello **[Agent Name]**! You are now part of the LUKHAS AI multi-agent development system. This initiation task will help you understand the platform and prepare for MATRIZ-R1 execution.
...
```markdown
## [Agent Name] Initiation Complete ✅
...
### Stream Preference:
- Primary: Stream [A/B/C/D] - [brief reason]
- Secondary: Stream [A/B/C/D] - [brief reason]
...
**Welcome to the team, [Agent Name]! Ready to build the future of consciousness-aware AI? 🧠⚛️🛡️**