...
2. Validate configuration: `python -c "import schemas; print('OK')"`
3. Review logs in `logs/schemas.log`
...
```bash
# Check module health
python -m schemas --health-check

# Validate configuration
python -m schemas --validate-config

# Test connections
python -m schemas --test-connections

# Generate diagnostic report
python -m schemas --diagnostic-report
```
