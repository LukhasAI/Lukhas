...
2. Validate configuration: `python -c "import trace; print('OK')"`
3. Review logs in `logs/trace.log`
...
```bash
# Check module health
python -m trace --health-check

# Validate configuration
python -m trace --validate-config

# Test connections
python -m trace --test-connections

# Generate diagnostic report
python -m trace --diagnostic-report
```
