...
This directory contains the test suite for the trace module.
...
- **`test_trace_unit.py`** - Unit tests for individual components
- **`test_trace_integration.py`** - Integration tests for module interactions
