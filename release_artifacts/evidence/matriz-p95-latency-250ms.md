...
artifacts:
  - path: '../matriz-p95-latency-2025-q3.json'
    type: json
    hash: sha256-pending
...
# Evidence: MATRIZ achieves <250ms p95 reasoning latency under production load

## Claim Summary

- **Statement**: MATRIZ achieves <250ms p95 reasoning latency under production load
- **Type**: performance
- **Domains**: lukhas.ai, lukhas.eu
...
1. **matriz-p95-latency-2025-q3.json** - Supporting data
   - Path: `release_artifacts/matriz-p95-latency-2025-q3.json`
   - Format: JSON
   - [View artifact](../matriz-p95-latency-2025-q3.json)

2. **global-latency-benchmarks-2024.json** - Supporting data
