...
artifacts:
  - path: '../lambda-id-security-audit-2024.pdf.md'
    type: markdown
    hash: sha256-pending
...
# Evidence: ΛiD JWT token validation with <10ms latency

## Claim Summary

- **Statement**: ΛiD JWT token validation with <10ms latency
- **Type**: performance
- **Domains**: lukhas.id
...
1. **lambda-id-security-audit-2024.pdf.md** - Supporting data
   - Path: `release_artifacts/lambda-id-security-audit-2024.pdf.md`
   - Format: MD
   - [View artifact](../lambda-id-security-audit-2024.pdf.md)
