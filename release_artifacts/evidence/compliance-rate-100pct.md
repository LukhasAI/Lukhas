...
artifacts:
  - path: '../guardian-compliance-2025-Q3.pdf.md'
    type: markdown
    hash: sha256-pending
  - path: '../gdpr-compliance-validation.json'
    type: json
    hash: sha256-pending
...
# Evidence: 100% compliance with applicable federal and state regulations

## Claim Summary

- **Statement**: 100% compliance with applicable federal and state regulations
- **Type**: compliance
- **Domains**: lukhas.us, lukhas.eu
...
2. **gdpr-compliance-validation.json** - Supporting data
   - Path: `release_artifacts/gdpr-compliance-validation.json`
   - Format: JSON
   - [View artifact](../gdpr-compliance-validation.json)
