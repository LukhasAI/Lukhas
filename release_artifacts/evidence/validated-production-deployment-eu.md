...
artifacts:
  - path: '../guardian-compliance-2025-Q3.pdf.md'
    type: markdown
    hash: sha256-pending
  - path: '../matriz-87-percent-complete-2025-q4.json'
    type: json
    hash: sha256-pending
...
# Evidence: TRL 1-9 coverage with validated production deployments

## Claim Summary

- **Statement**: TRL 1-9 coverage with validated production deployments
- **Type**: operational
- **Domains**: lukhas.eu
...
1. **guardian-compliance-2025-Q3.pdf.md** - Supporting data
   - Path: `release_artifacts/guardian-compliance-2025-Q3.pdf.md`
   - Format: MD
   - [View artifact](../guardian-compliance-2025-Q3.pdf.md)

2. **matriz-87-percent-complete-2025-q4.json** - Supporting data
   - Path: `release_artifacts/matriz-87-percent-complete-2025-q4.json`
   - Format: JSON
   - [View artifact](../matriz-87-percent-complete-2025-q4.json)
