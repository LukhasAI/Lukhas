...
This workspace is for the adapter-integration-specialist to implement their assigned components.

### Key Responsibilities
See CLAUDE_ARMY/tasks/adapter-integration-specialist_tasks.md for detailed task list.
