# Vocabulary_Refresh_Data Troubleshooting Guide
...
2. Validate configuration: `python -c "import vocabulary_refresh_data; print('OK')"`
3. Review logs in `logs/vocabulary_refresh_data.log`
...
```bash
# Check module health
python -m vocabulary_refresh_data --health-check

# Validate configuration
python -m vocabulary_refresh_data --validate-config

# Test connections
python -m vocabulary_refresh_data --test-connections

# Generate diagnostic report
python -m vocabulary_refresh_data --diagnostic-report
```
