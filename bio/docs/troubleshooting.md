...
2. Validate configuration: `python -c "import bio; print('OK')"`
3. Review logs in `logs/bio.log`
...
```bash
# Check module health
python -m bio --health-check

# Validate configuration
python -m bio --validate-config

# Test connections
python -m bio --test-connections

# Generate diagnostic report
python -m bio --diagnostic-report
```
