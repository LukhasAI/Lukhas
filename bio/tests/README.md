...
This directory contains the test suite for the bio module.
...
- **`test_bio_unit.py`** - Unit tests for individual components
- **`test_bio_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=bio --cov-report=html
```
