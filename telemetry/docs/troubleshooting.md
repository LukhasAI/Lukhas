...
2. Validate configuration: `python -c "import telemetry; print('OK')"`
3. Review logs in `logs/telemetry.log`
...
```bash
# Check module health
python -m telemetry --health-check

# Validate configuration
python -m telemetry --validate-config

# Test connections
python -m telemetry --test-connections

# Generate diagnostic report
python -m telemetry --diagnostic-report
```
