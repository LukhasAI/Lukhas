...
2. Validate configuration: `python -c "import vivox; print('OK')"`
3. Review logs in `logs/vivox.log`
...
```bash
# Check module health
python -m vivox --health-check

# Validate configuration
python -m vivox --validate-config

# Test connections
python -m vivox --test-connections

# Generate diagnostic report
python -m vivox --diagnostic-report
```
