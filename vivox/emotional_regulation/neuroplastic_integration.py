...
# Import tag system
try:
    from core.tags.registry import TagRegistry, TagDefinition, TagCategory
...
class VIVOXNeuroplasticLearner:
    ...
    def get_learning_statistics(self) -> Dict[str, Any]:
        ...
        for strategy in strategy_stats:
            ...
            strategy_stats[strategy]["average_effectiveness"] = (
                strategy_stats[strategy]["total_effectiveness"] / count
            )
...
class VIVOXTagSystemIntegration:
    ...
    async def process_emotional_tags(self, 
        ...
        try:
            ...
            neuroplastic_tags = await self.neuroplastic_learner.learn_from_regulation(
