...
class VIVOXEVRNDemo:
    ...
    async def demo_anomaly_detection(self):
        ...
        for scenario in scenarios:
            ...
            # Detect anomalies
            vectors = [
                thermal_perception.to_vector(),
                motion_perception.to_vector()
            ]
            
            anomalies = await self.evrn.detect_anomalies(
                vectors,
                context={'demo_scenario': scenario['name']}
            )
    ...
    async def demo_multimodal_fusion(self):
        ...
        perceptions.append(PerceptualVector(
