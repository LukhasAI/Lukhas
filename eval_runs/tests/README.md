...
- **`test_eval_runs_unit.py`** - Unit tests for individual components
- **`test_eval_runs_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=eval_runs --cov-report=html
```
