# Eval_Runs Troubleshooting Guide
...
2. Validate configuration: `python -c "import eval_runs; print('OK')"`
3. Review logs in `logs/eval_runs.log`
...
```bash
# Check module health
python -m eval_runs --health-check

# Validate configuration
python -m eval_runs --validate-config

# Test connections
python -m eval_runs --test-connections

# Generate diagnostic report
python -m eval_runs --diagnostic-report
```
