...
from core.events.contracts import (
    ...
    MemoryFoldCreated, MemoryFoldCompressed, MemoryConsolidationCompleted,
    ConsciousnessStateChanged, DecisionMade, ReflectionCompleted,
    DreamGenerated, DreamAnalyzed,
    QuantumStateCreated, QuantumStateCollapsed,
    EmotionalStateChanged, EmotionalRegulationApplied,
    EthicalViolationDetected, PolicyApplied,
    ExternalMessageReceived, ExternalMessageSent,
    SystemStressLevelChanged, ModuleHealthChanged,
