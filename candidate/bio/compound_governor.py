...
from .energy.spirulina_atp_system import SpirulinaATPHybridSystem, EnergyHarvestResult
...
class BioCompoundGovernor:
    ...
    async def _regulate_emotional_oscillators(self, health_metrics: Dict[str, float], 
                                           energy_result: Dict[str, Any]) -> Dict[str, float]:
    ...
    async def _coordinate_repair_systems(self, health_metrics: Dict[str, float], 
                                       energy_result: Dict[str, Any]) -> Dict[str, float]:
    ...
    async def _optimize_energy_distribution(self, energy_result: Dict[str, Any], 
                                          health_metrics: Dict[str, float]) -> Dict[str, float]:
    ...
    def get_system_status_report(self) -> Dict[str, Any]:
        ...
        stability_trend = "improving" if len(recent_stability) > 1 and recent_stability[-1] > recent_stability[0] else "stable"
