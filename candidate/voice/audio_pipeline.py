...
from candidate.voice.audio_processing import (
    AudioBuffer, AudioFormat, LUKHASAudioProcessor, ProcessingQuality
)
from candidate.voice.voice_effects import VoiceEffectsProcessor, VoiceEffectType, EffectIntensity
from candidate.voice.voice_modulator import VoiceModulator, VoiceModulationMode
from candidate.voice.tts_integration import LUKHASTTSService, TTSRequest, TTSResponse
        ...
        try:
            ...
            for stage in self.config.enabled_stages:
                ...
                try:
                    ...
                    elif stage == PipelineStage.TTS_SYNTHESIS:
                        current_data, stage_metadata = await processor.process(current_data, {})
