...
This directory contains the test suite for the candidate module.
...
- **`test_candidate_unit.py`** - Unit tests for individual components
- **`test_candidate_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=candidate --cov-report=html
```
