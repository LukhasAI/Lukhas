...
logger.info(
    "ΛTRACE: Initializing response_reasoning_summary_text_delta_event.py module (Data Model Definition). Module: %s",
    __file__
)
...
logger.debug(
    "ResponseReasoningSummaryTextDeltaEvent data model class defined.",
    class_name="ResponseReasoningSummaryTextDeltaEvent",
