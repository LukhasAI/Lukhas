...
logger.info(
    "ΛTRACE: Initializing response_reasoning_summary_text_done_event.py module (Data Model Definition). Module: %s",
    __file__
)
...
logger.debug(
    "ResponseReasoningSummaryTextDoneEvent data model class defined.",
    class_name="ResponseReasoningSummaryTextDoneEvent",
