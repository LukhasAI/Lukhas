    ...
    return json.dumps(
        {
            ...
            "symbols": [
                {
                    "symbol": "Path",
                    "meaning": "Your life journey and the choices ahead",
                },
                {
                    "symbol": "Light",
                    "meaning": "Clarity and enlightenment coming into your life",
                },
            ],
...
def interpret_dream():
    ...
    try:
        ...
        if interpretation:
            return jsonify({"success": True, "interpretation": interpreter.to_json()})
        else:
            return (
                jsonify(
                    {
        ...
        return (
            jsonify({"success": False, "error": interpreter.t("interpretationError")}),
            500,
        )
