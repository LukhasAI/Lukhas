...
def test_orchestration_components():
    ...
    try:
        ...
        from .multi_ai_orchestrator import MultiAIOrchestrator, OrchestrationRequest, TaskType, AIProvider
        ...
        print(f"✅ MultiAIOrchestrator initialized")
        ...
        async def test_async_components():
            try:
                ...
                context_data = await context_manager.get_context(context_id)
...
def test_external_adapters():
    ...
    try:
        from ..external_adapters import OAuthManager, GmailAdapter
