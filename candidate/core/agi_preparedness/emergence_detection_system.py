...
class EmergenceDetectionSystem:
    ...
    async def process_capability_measurement(self, 
        ...
        try:
            ...
            for signal in detected_signals:
                ...
                for callback in self.detection_callbacks:
                    try:
                        ...
                        self.logger.error(f"Detection callback failed: {str(e)}")
            ...
            self.logger.error(f"Capability measurement processing failed: {str(e)}")
            return []
    ...
    def generate_emergence_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "detection_summary": {
                ...
                "capability_domains_monitored": len(set(buffer.split('_', 1)[1] for buffer in self.capability_buffers.keys())),
                "ai_systems_monitored": len(set(buffer.split('_', 1)[0] for buffer in self.capability_buffers.keys())),
