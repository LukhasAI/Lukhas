    ...
    def report_symbolic_state(self, module_summary: dict) -> str:
        ...
        if module_summary["functions"]:
            ...
            if len(module_summary["functions"]) > 5:
                report_lines.append(f"   ... and {len(module_summary['functions'])} - 5} more")  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        ...
        if module_summary["classes"]:
            ...
            if len(module_summary["classes"]) > 5:
                report_lines.append(f"   ... and {len(module_summary['classes'])} - 5} more")  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
