...
class SwarmResourceScheduler:
    def __init__(self, swarm_hub: SwarmHub):  # noqa: F821
    ...
    def schedule_task(self, task):
        ...
        for colony_id, info in self.swarm_hub.colonies.items():
            colony = info["colony"]
            if colony.resource_state == ResourceState.CRITICAL:  # noqa: F821
                continue
    ...
    print(f"--> Best colony for memory task: {winner}")  # noqa: F821
    print(f"--> Best colony for creative task: {winner}")  # noqa: F821
