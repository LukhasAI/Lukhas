...
try:
    ...
    from .matriz_consciousness_identity_signals import IdentitySignalType, consciousness_identity_signal_emitter  # noqa: F401 # TODO[T4-UNUSED-IMPORT]: kept for MATRIZ-R2 trace integration
