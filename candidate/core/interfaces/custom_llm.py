...
class CustomLlm(UncheckedBaseModel):
    ...
    if IS_PYDANTIC_V2:
        model_config: typing.ClassVar[pydantic.ConfigDict] = pydantic.ConfigDict(
            extra="allow",
            frozen=True,
            # ΛVALIDATE_ASSIGNMENT_TODO: Consider validate_assignment=True for
            # stricter model updates if applicable.
        )
    ...
    def log_creation(cls, values):
        ...
        # This logging is more effective with Pydantic V2 or if UncheckedBaseModel
        # ensures fields are present.
        log.debug(
            "CustomLlm instance created/validated",
            url=getattr(values, "url", None),
        )
        return values
