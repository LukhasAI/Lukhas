...
st.set_page_config(page_title="LUCΛS Dream Export", page_icon="🌙")  # noqa: F821  # TODO: st
st.title("🌙 Symbolic Dream Export Panel")  # noqa: F821  # TODO: st
...
if DATA_PATH.exists():
    ...
    st.error("Dream payload file not found.")  # noqa: F821  # TODO: st
    st.stop()  # noqa: F821  # TODO: st

# Filter controls
st.sidebar.header("🔍 Filter Dreams")  # noqa: F821  # TODO: st
...
selected_tiers = st.sidebar.multiselect("Filter by Tier", tiers)  # noqa: F821  # TODO: st
selected_tags = st.sidebar.multiselect("Filter by Tags", all_tags)  # noqa: F821  # TODO: st
selected_emojis = st.sidebar.multiselect("Filter by Emoji", all_emojis)  # noqa: F821  # TODO: st
filter_voice = st.sidebar.checkbox("Only dreams marked for narration (suggest_voice)", value=True)  # noqa: F821  # TODO: st
...
st.success(f"{len(filtered)} dreams match your filters.")  # noqa: F821  # TODO: st
st.json(filtered[:3], expanded=False)  # noqa: F821  # TODO: st

# Export
if st.button("📤 Export Filtered Dreams"):  # noqa: F821  # TODO: st
    EXPORT_PATH.parent.mkdir(parents=True, exist_ok=True)
    with open(EXPORT_PATH, "w") as f:
        for d in filtered:
            f.write(json.dumps(d) + "\n")
    st.success(f"Exported to {EXPORT_PATH}")  # noqa: F821  # TODO: st
