...
def create_delivery_widget(timezone, vendor, delivery_id, user_tier, estimated_eta, delivery_status="in_transit"):
    ...
    widget = {
        ...
        "cta": "Track Delivery" if user_tier >= 2 else "Status Only",  # noqa: invalid-syntax
        "animation": {  # noqa: invalid-syntax
            "type": "roadmap_path",
            "pulse": True,
            "loop_eta": estimated_eta,
        },
        "DST_hooks": {  # noqa: invalid-syntax
            "auto_refresh": True,
...
def update_delivery_status(widget, new_status, new_eta=None):
    ...
    if new_eta:  # noqa: invalid-syntax
        widget["eta"] = new_eta  # noqa: invalid-syntax
