...
async def demo_integrated_system():
    ...
    try:
        ...
        await system.create_colony("reasoning-specialist-001", ReasoningColony)  # noqa: F821

        await system.create_colony("memory-specialist-001", MemoryColony)  # noqa: F821

        await system.create_colony("creative-specialist-001", CreativityColony)  # noqa: F821
