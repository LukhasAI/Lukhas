...
class MockImages:
     async def generate(self, **kwargs) -> Any:
        return type("ImageResponse", (), {"data": [type("Image", (), {"url": f"https://openai.example.com/image_{random.randint(1000, 9999)}.png"})()]})()

class MockAudio:
    async def create(self, **kwargs) -> Any:
        return type("AudioResponse", (), {"url": f"https://openai.example.com/audio_{random.randint(1000, 9999)}.mp3"})()
