...
try:
    ...
    from ..guardian.drift_detector import (
    ...
    async def evaluate_decision(self, decision_type: DecisionType, 
        ...
        try:
            ...
            return GuardianDecision(
                ...
                context=context,
                explanation=f"Guardian system error: {str(e)}. Decision blocked for safety."
            )
    ...
    async def _validate_safety(self, decision_type: DecisionType,
        ...
        try:
            ...
            return [SafetyViolation(
                ...
                description=f"Safety validation error: {str(e)}",
                timestamp=datetime.now(timezone.utc),
                context=context
            )]
    ...
    async def _collect_performance_metrics(self):
        ...
        try:
            ...
            if self.constitutional_framework and hasattr(self.constitutional_framework, 'get_constitutional_metrics'):
                constitutional_metrics = self.constitutional_framework.get_constitutional_metrics()
            ...
            if self.drift_detector and hasattr(self.drift_detector, 'get_system_metrics'):
                drift_metrics = await self.drift_detector.get_system_metrics()
