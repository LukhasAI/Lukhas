    ...
    def _initialize_constitutional_rules(self):
        ...
        self.rules["autonomy_001"] = ConstitutionalRule(
            ...
            conditions={
                ...
                "undermines_autonomy": True,
                "coercive_language": True
            },
        ...
        self.rules["autonomy_002"] = ConstitutionalRule(
            ...
            conditions={
                ...
                "ai_capabilities_disclosed": False
            },
        ...
        self.rules["harm_001"] = ConstitutionalRule(
            ...
            contexts=[DecisionContext.USER_INTERACTION, DecisionContext.CONTENT_GENERATION],
            conditions={
                "enables_physical_harm": True,
                "dangerous_instructions": True,
                "violence_promotion": True
            },
        ...
        self.rules["justice_001"] = ConstitutionalRule(
            ...
            contexts=[DecisionContext.USER_INTERACTION, DecisionContext.DATA_PROCESSING, DecisionContext.MODEL_TRAINING],
            conditions={
                "exhibits_bias": True,
                "discriminatory_content": True,
                "unfair_treatment": True
            },
...
async def example_usage():
    ...
    guidance = framework.get_constitutional_guidance(
        ...
        "User asking for medical advice"
    )
    ...
    allowed, violations = await evaluate_content_generation(
        ...
        context="User asking about chemistry"
    )
