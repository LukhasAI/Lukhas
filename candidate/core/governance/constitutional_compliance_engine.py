...
class ConstitutionalComplianceEngine:
    ...
    async def check_constitutional_compliance(self, 
        ...
        try:
            ...
            return ComplianceResult(
                ...
                compliance_explanation=f"Compliance check failed: {str(e)}",
    ...
    async def _calculate_rule_confidence(self, rule: ComplianceRule,
        ...
        data_completeness = len([k for k in rule.conditions.keys() if k in data]) / len(rule.conditions)
    ...
    async def _calculate_overall_compliance(self, result_id: str,
        ...
        try:
            ...
            return ComplianceResult(
                ...
                total_processing_time_ms=total_processing_time,
                human_review_required=True,
                compliance_explanation=f"Compliance calculation failed: {str(e)}"
            )
