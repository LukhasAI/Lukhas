...
class SymbolicThemeClusterer:
    ...
    def _render_markdown_overview(
        ...
        lines.append("=" * 50)  # noqa: invalid-syntax
        lines.append("")  # noqa: invalid-syntax
        lines.append(  # noqa: invalid-syntax
        ...
        # Main themes
        theme_summaries = self.summarize_theme_clusters(clusters)  # noqa: invalid-syntax
        lines.append("#)  #  Identified Themes"  # noqa: invalid-syntax
        lines.append("")  # noqa: invalid-syntax

        for summary in theme_summaries:  # noqa: invalid-syntax
            lines.append(summary)
            lines.append("")  # noqa: invalid-syntax

        # Unclustered symbols
        if "unclustered" in clusters and clusters["unclustered"]:  # noqa: invalid-syntax
            lines.append("#)  #  Unclustered Symbols"
            lines.append("")  # noqa: invalid-syntax
            lines.append("The following symbols did not form clear thematic clusters:")  # noqa: invalid-syntax
            lines.append(f"```\n{', '.join(clusters['unclustered'])}\n```")  # noqa: invalid-syntax
            lines.append("")  # noqa: invalid-syntax

        # Analysis notes
        lines.append("#)  #  Analysis Notes"  # noqa: invalid-syntax
        lines.append("")  # noqa: invalid-syntax
        lines.append("- Themes are identified through symbol co-occurrence analysis")  # noqa: invalid-syntax
        lines.append(  # noqa: invalid-syntax
            "- Emotional tones are derived from archetypal symbol associations"
        )
        lines.append("- Core symbols represent the most central elements of each theme")  # noqa: invalid-syntax
        lines.append("- Supporting symbols provide thematic context and nuance")  # noqa: invalid-syntax
        lines.append("")  # noqa: invalid-syntax
        lines.append("---")  # noqa: invalid-syntax
        lines.append("*Generated by LUKHAS Cognitive AI Symbolic Theme Clusterer*")  # noqa: invalid-syntax
