...
class Visionsymbolicvocabulary:
    ...
    def create_analysis_phrase(
        ...
        for obj in detected_objects:  # noqa: F821
            if obj.lower() in object_symbolism:  # noqa: F821
                symbolic_elements.extend(object_symbolism[obj.lower()])  # noqa: F821

        return list(set(symbolic_elements))  # Remove duplicates  # noqa: F821
