...
class SecurityAwareLogger:
    ...
    def log_mfa_event(self, user_id: str, method: str, success: bool) -> None:
        ...
        self.logger.info(
            f"MFA {status}: user_hash={user_hash}, method={method}"
        )
    ...
    def log_api_key_usage(self, key_id: str, endpoint: str, success: bool) -> None:
        ...
        self.logger.info(
            f"API Key {status}: key_id={safe_key_id}, endpoint={endpoint}"
        )
    ...
    def log_consent_event(self, user_id: str, consent_type: str, granted: bool) -> None:
        ...
        self.logger.info(
            f"CONSENT_{status}: user_hash={user_hash}, type={consent_type}",
            extra={"compliance": True}
        )
...
if __name__ == "__main__":
    ...
    sec_logger.info("JWT token: eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.dozjgNryP4J3jVmNHl0w5N_XgL0n3I9PlFUP0THsR8U")
