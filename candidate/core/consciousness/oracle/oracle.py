...
class ConsciousnessOracle:
    ...
    async def get_full_consciousness_profile(self, user_id: str) -> dict[str, Any]:
        """
        ...
        receptivity_windows = await self.receptivity_calculator.calculate_receptivity_windows(
            user_id
        )
