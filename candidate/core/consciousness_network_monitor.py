...
class ConsciousnessNetworkMonitor:
    ...
    async def _calculate_network_health(self) -> NetworkHealth:
        ...
        if self.adapter:
            ...
            adapter_metrics = {"triad_compliance_rate": 0.0}
        ...
        adapter_metrics.get("triad_compliance_rate", 0.0)
