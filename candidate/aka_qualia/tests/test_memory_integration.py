...
class TestSQLQueryCorrectness:
    ...
    @pytest.mark.integration
    def test_risk_severity_filtering(self, sql_memory, high_risk_scene, low_risk_scene, test_glyphs, test_policy, test_metrics):
...
class TestDatabaseSchemaValidation:
    ...
    def test_required_columns_exist(self, sql_memory):
        ...
        with sql_memory.engine.begin() as conn:
            ...
            scene_columns = conn.execute(text("""
            ...
            required_scene_cols = [
                ...
                'proto', 'proto_vec', 'risk', 'context', 
                'drift_phi', 'congruence_index', 'neurosis_risk'
            ]
            ...
            glyph_columns = conn.execute(text("""
                SELECT column_name, data_type, is_nullable
                FROM information_schema.columns
