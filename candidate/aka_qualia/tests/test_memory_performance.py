...
from .conftest import create_test_scene, create_test_glyph, create_varying_scene
    ...
    def test_1k_scene_insert_performance(self, sql_memory, performance_timer):
        ...
        for i in range(num_scenes):
            ...
            glyph_data = [
                ...
                create_test_glyph(f"batch:test", batch_id=i // 100)  # Group by hundreds
            ]
        ...
        total_scenes = sum(len(sql_memory.get_scene_history(user_id=f"perf_user_{i}", limit=1000)) 
                          for i in range(10))
...
class TestQueryPerformance:
    ...
    def test_glyph_search_performance(self, sql_memory, performance_timer):
        ...
        unique_results = sql_memory.search_by_glyph(
            user_id="glyph_search_perf_test",
            glyph_key=f"{unique_prefix}_100"
        )
...
class TestConcurrentPerformance:
    ...
    def test_concurrent_write_throughput(self, sql_memory):
        ...
        print(f"Concurrent write performance:")
    ...
    def test_connection_contention_handling(self, sql_memory):
        ...
        print(f"Connection contention test:")
