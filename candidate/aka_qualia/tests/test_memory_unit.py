...
from .conftest import create_test_scene, create_test_glyph
...
class TestContractValidation:
    ...
    def test_transform_chain_required_for_high_risk(self, sql_memory, high_risk_scene, test_glyphs, test_policy, test_metrics):
        ...
        regulation_present = any(
            "sublimate" in str(op) or "teq.enforce" in str(op) 
