...
def main():
    ...
    test_categories = [
        ...
        },
        {
            ...
            "cmd": ["python", "-m", "pytest", "candidate/aka_qualia/tests/test_memory_unit.py", "-v", "--tb=short", "-x"],
            "critical": True
        },
        {
        ...
        },
        {
            ...
            "cmd": ["python", "-m", "pytest", "candidate/aka_qualia/tests/test_memory_integration.py", "-v", "--tb=short", "-x"],
            "critical": False
        },
        {
            "name": "Security Tests - Fault Injection", 
            "cmd": ["python", "-m", "pytest", "candidate/aka_qualia/tests/test_memory_security.py", "-m", "fault", "-v", "--tb=short"],
            "critical": False
        },
        {
            "name": "GDPR Compliance Tests",
            "cmd": ["python", "-m", "pytest", "candidate/aka_qualia/tests/test_memory_gdpr.py", "-v", "--tb=short", "-x"],
            "critical": False
        },
        {
            "name": "Performance Tests - Benchmarks", 
            "cmd": ["python", "-m", "pytest", "candidate/aka_qualia/tests/test_memory_performance.py", "-m", "perf and not slow", "-v", "--tb=short"],
            "critical": False
        }
    ]
    ...
    print(f"🔍 Critical: {len([r for r in results if r['critical']]) - critical_failures}/{len([r for r in results if r['critical']])} critical tests passed")
