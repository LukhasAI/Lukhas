...
class PrometheusExporter:
    ...
    def get_metrics_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "scenes_processed": akaq_scenes_processed_total._value._value
            if hasattr(akaq_scenes_processed_total, "_value")
            else 0,
            "regulations_applied": akaq_regulations_applied_total._value._value
            if hasattr(akaq_regulations_applied_total, "_value")
            else 0,
            "energy_violations": akaq_energy_conservation_violations_total._value._value
            if hasattr(akaq_energy_conservation_violations_total, "_value")
            else 0,
            "current_metrics": {
                "energy_conservation_ratio": akaq_energy_conservation_ratio._value._value
                if hasattr(akaq_energy_conservation_ratio, "_value")
                else 1.0,
                "vivox_drift_score": akaq_vivox_drift_score._value._value
                if hasattr(akaq_vivox_drift_score, "_value")
                else 0.0,
                "regulation_gain": akaq_regulation_gain._value._value
                if hasattr(akaq_regulation_gain, "_value")
                else 1.0,
                "regulation_pace": akaq_regulation_pace._value._value
