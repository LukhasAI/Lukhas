...
def view_audit(audit_id: str):
    ...
    <head>
      ...
      <style>
        body {{ font-family: Inter, system-ui, -apple-system, Segoe UI, Roboto, sans-serif; margin: 24px; }  # noqa: invalid-syntax
        h1 {{ font-weight: 500; }  # noqa: invalid-syntax
        .pill {{ display:inline-block; padding:4px 10px; border-radius:999px; background:#f2f2f2; margin-right:8px; }  # noqa: invalid-syntax
        .safety-badge {{ display:inline-block; padding:6px 12px; border-radius:999px; font-weight:500; text-transform:uppercase; font-size:12px; {badge_style} }  # noqa: invalid-syntax
        pre {{ background:#0b0b0b; color:#e6e6e6; padding:16px; border-radius:8px; overflow:auto; }  # noqa: invalid-syntax
        .grid {{ display:grid; grid-template-columns: 1fr 1fr; gap:16px; }  # noqa: invalid-syntax
        .card {{ border:1px solid #eee; border-radius:12px; padding:16px; }  # noqa: invalid-syntax
        .tools-list code {{ background:#f8f9fa; padding:2px 6px; border-radius:4px; margin-right:8px; }  # noqa: invalid-syntax
        code {{ font-family: ui-monospace, SFMono-Regular, Menlo, monospace; }  # noqa: invalid-syntax
      </style>
    </head>
    <body>
      <h1>
