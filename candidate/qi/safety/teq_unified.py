    ...
    def _run_check(self, chk: Dict[str, Any], ctx: Dict[str, Any]) -> Tuple[bool, str, str]:
        ...
        if kind == "require_provenance":
            ...
            if pii and not masked:
                return (False, "PII not masked", f"Mask PII fields")
            return (True, "", "")
            ...
            if max_tokens:
                ...
                if used > max_tokens:
                    return (False, f"Token budget exceeded", "Reduce tokens")
            return (True, "", "")
            ...
            if age and age < min_age:
                return (False, f"Age requirement not met", "Age verification required")
            return (True, "", "")
