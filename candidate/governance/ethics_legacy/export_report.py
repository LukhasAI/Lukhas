...
<head>
    ...
    <style>
        body {{ font-family: Arial, sans-serif; margin: 20px; background-color: #f8f9fa; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        .container {{ max-width: 1200px; margin: 0 auto; background: white; padding: 20px; border-radius: 8px; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        .header {{ background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 8px; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        .status-badge {{ display: inline-block; background: {status_color}; color: white; padding: 5px 15px; border-radius: 20px; font-weight: bold; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        .metric-box {{ background: #f8f9fa; border: 1px solid #dee2e6; padding: 15px; margin: 10px 0; border-radius: 5px; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        .violation {{ background: #fff3cd; border-left: 4px solid #ffc107; padding: 10px; margin: 5px 0; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        .critical {{ border-left-color: #dc3545; background: #f8d7da; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        table {{ width: 100%; border-collapse: collapse; margin: 10px 0; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        th, td {{ padding: 10px; text-align: left; border-bottom: 1px solid #ddd; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
        th {{ background-color: #f2f2f2; }  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
    </style>
</head>
<body>
    <div class="container">
