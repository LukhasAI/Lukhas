...
try:
    ...
    class MockStreamlit:
        ...
        def dataframe(self, df):
            print(f"DATAFRAME: {len(df) if hasattr(df, '__len__')} else 'N/A'} rows")  # noqa: invalid-syntax
...
from lukhas.core.interfaces.voice.core.sayit import trace_tools  # assuming trace_tools.py is importable
