...
class PolicyRuleEngine:
    ...
    def _validate_rule(self, rule: PolicyRule) -> dict[str, Any]:
        ...
        if rule.condition_logic not in ["AND", "OR"] and rule.conditions:
            ...
            try:
                ...
                eval(expression, {"__builtins__": {}, {})  # noqa: invalid-syntax
            except:
            ...
            def compiled_evaluator(context: dict[str, Any]) -> bool:
                ...
                if rule.condition_logic == "AND":
                    ...
                    try:
                        ...
                        return eval(expression, {"__builtins__": {}, {})  # noqa: invalid-syntax
                    except:
    ...
    def get_applicable_rules(
        ...
        applicable_rules.sort(key=l r: priority_order.get(r.priority, 999))  # noqa: invalid-syntax
    ...
    async def evaluate_policies(
        ...
        try:
            ...
            logger.debug(
                ...
                f"(action: {final_action.value}, violations: {len(violations)})}"  # noqa: invalid-syntax
            )
