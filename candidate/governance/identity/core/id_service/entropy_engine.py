...
class LambdaIDEntropyEngine:
        ...
        if components:
            ...
            if symbolic_char not in high_entropy_symbols:
                optimizations.append(
                    f"Replace '{symbolic_char}' with higher-entropy symbol like {high_entropy_symbols[:3]}"
                )
    ...
    def _load_boost_factors(self) -> dict[str, dict[str, float]]:
        ...
        return {
            ...
            "pattern_complexity": {"high": 1.4, "medium": 1.2, "low": 1.0},
            "character_diversity": {"high": 1.3, "medium": 1.1, "low": 1.0},
        }
