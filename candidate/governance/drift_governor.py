...
class EthicalDriftGovernor:
    ...
    def __init__(self):
        self.governance_log_path = "logs/fold/ethical_governance.jsonl"
        self.intervention_log_path = "logs/fold/interventions.jsonl"
        self.warnings_path = "logs/fold/ethical_warnings.jsonl"
    ...
    def monitor_drift(self, *args, **kwargs):
        """Alias for monitor_memory_drift for backward compatibility"""
        return self.monitor_memory_drift(*args, **kwargs)
    ...
    def generate_governance_report(self, time_window_hours: int = 24) -> dict[str, Any]:
        ...
        recent_interventions = [
            ...
            if datetime.fromisoformat(intervention["timestamp_utc"].replace("Z", "+00:00"))
            >= cutoff_time
        ]
