...
class GuardianDashboard(GlyphIntegrationMixin):
    ...
    def _generate_threat_metadata(self, threat_type: str) -> dict:
        ...
        return {
            ...
            "constellation_framework_impact": {
    ...
    async def _render_governance_view(self):
        ...
        print(
            f"{Console.BOLD}{Console.CYAN}║ 🛡️ LUKHAS GOVERNANCE MONITOR - CONSTELLATION FRAMEWORK STATUS ⚛️🧠🛡️            ║{Console.RESET}",
            end="",
        )
        ...
        print(f"{Console.BOLD}CONSTELLATION FRAMEWORK STATUS{Console.RESET}", end="")
    ...
    async def _render_system_status(self):
        ...
        if self.emergency_state.active_emergency_level:
            ...
            print(f"Constellation Framework: ⚛️🧠🛡️ {constellation_color}ACTIVE{Console.RESET}", end="")
    ...
    def get_governance_summary(self) -> dict[str, any]:
        ...
        return {
            ...
            "constellation_framework_status": {
