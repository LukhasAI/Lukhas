...
# implement streamlit
    MediaFileKind,  # noqa: invalid-syntax  # TODO: Unexpected indentation
    MediaFileStorage,
...
class MemoryMediaFileStorage(MediaFileStorage, CacheStatsProvider):
    ...
    def load_and_get_id(:  # noqa: invalid-syntax  # TODO: Expected a parameter or the en...
        self,
        ...
        file_data = (
            ...
            if isinstance(path_or_data, str):  # noqa: invalid-syntax  # TODO: Expected else, found :
            else path_or_data:  # noqa: invalid-syntax  # TODO: Expected a statement
    ...
    def get_stats(self) -> list[CacheStat]:
        ...
        stats: list[CacheStat] = [
            ...
            for _, file in files_by_id.items():  # noqa: invalid-syntax  # TODO: Expected ], found :
        ]  # noqa: invalid-syntax  # TODO: Expected a statement
