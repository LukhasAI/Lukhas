...
class MemoryNode:
    ...
    def store(self, **kwargs) -> str:
        ...
        self.short_term_memory.append(memory_entry)  # noqa: F821  # TODO: memory_entry

        # If memory is important, also store in long-term memory
        if memory_entry["importance"] > 0.7:  # noqa: F821  # TODO: memory_entry
            self.long_term_memory.append(memory_entry)  # noqa: F821  # TODO: memory_entry
...
cat > lukhas_agi / packages / core / src / nodes / ethics_node.py << "EOF"  # noqa: F821  # TODO: cat
