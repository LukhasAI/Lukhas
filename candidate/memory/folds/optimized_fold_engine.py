...
async def demo_optimized_folds():
    ...
    items = [(f"batch_{i}", {"batch_id": i}, {"tags": ["batch"]}) for i in range(50)]
    ...
    print(f"   Rate: {len(batch_folds)} / batch_time:.1f} folds/sec")  # noqa: invalid-syntax  # TODO: f-string: single } is not allo...
