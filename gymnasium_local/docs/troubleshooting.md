...
# Gymnasium_Local Troubleshooting Guide
...
2. Validate configuration: `python -c "import gymnasium_local; print('OK')"`
3. Review logs in `logs/gymnasium_local.log`
...
```bash
# Check module health
python -m gymnasium_local --health-check

# Validate configuration
python -m gymnasium_local --validate-config

# Test connections
python -m gymnasium_local --test-connections

# Generate diagnostic report
python -m gymnasium_local --diagnostic-report
```
