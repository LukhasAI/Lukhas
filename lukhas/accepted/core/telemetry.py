...
class AgentSpans:
    ...
    def consent_record(user_id: str, purpose: str, granted: bool):
        ...
        with span('consent_ledger.record', {
            'user_id': user_id,
            'purpose': purpose,
            'granted': granted
        }) as s:
    ...
    def consent_check(user_id: str, purpose: str):
        ...
        with span('consent_ledger.check', {
            'user_id': user_id,
            'purpose': purpose
        }) as s:
            yield s
    ...
    def adapter_metadata(service: str, action: str):
        ...
        with span(f'adapter.{service}.{action}', {
            'service': service,
            'action': action,
