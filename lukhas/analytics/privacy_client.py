# T4: code=UP035x3 | ticket=ruff-cleanup | owner=lukhas-cleanup-team | status=resolved
# reason: Fixed multiple deprecated typing imports (Dict, List, Set) in privacy analytics
# estimate: 6min | priority: high | dependencies: privacy-libs
