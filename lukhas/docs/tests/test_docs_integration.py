...
class TestDocsExternalIntegration:
    ...
    def test_database_integration(self):
        ...
        try:
            ...
            with patch('lukhas.docs.database.connect') as mock_db:
...
class TestDocsErrorRecoveryIntegration:
    ...
    def test_graceful_degradation(self):
        ...
        try:
            ...
            with patch('lukhas.docs.external_service.call') as mock_service:
    ...
    def test_circuit_breaker_integration(self):
        ...
        try:
            ...
            with patch('lukhas.docs.circuit_breaker.is_open') as mock_cb:
