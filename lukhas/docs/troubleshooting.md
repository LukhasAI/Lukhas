...
2. Validate configuration: `python -c "import lukhas; print('OK')"`
3. Review logs in `logs/lukhas.log`
...
python -m lukhas --validate-config

# Test connections
python -m lukhas --test-connections

# Generate diagnostic report
python -m lukhas --diagnostic-report
```
