...
class TestSchemaExternalIntegration:
    ...
    def test_database_integration(self):
        ...
        try:
            ...
            with patch('lukhas.schema.database.connect') as mock_db:
...
class TestSchemaErrorRecoveryIntegration:
    ...
    def test_graceful_degradation(self):
        ...
        try:
            ...
            with patch('lukhas.schema.external_service.call') as mock_service:
    ...
    def test_circuit_breaker_integration(self):
        ...
        try:
            ...
            with patch('lukhas.schema.circuit_breaker.is_open') as mock_cb:
