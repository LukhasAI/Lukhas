"""Bridge for `lukhas.security.secure_random`.

Auto-generated bridge following canonical pattern:
  1) lukhas_website.lukhas.lukhas.security.secure_random
  2) candidate.lukhas.security.secure_random
...
_CANDIDATES = (
    "lukhas_website.lukhas.lukhas.security.secure_random",
    "candidate.lukhas.security.secure_random",
