"""Bridge for `lukhas.aka_qualia.palette`.

Auto-generated bridge following canonical pattern:
  1) lukhas_website.lukhas.lukhas.aka_qualia.palette
  2) candidate.lukhas.aka_qualia.palette
...
_CANDIDATES = (
    "lukhas_website.lukhas.lukhas.aka_qualia.palette",
    "candidate.lukhas.aka_qualia.palette",
    "aka_qualia.palette",
)
