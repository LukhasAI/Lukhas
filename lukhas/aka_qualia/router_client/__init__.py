"""Bridge for `lukhas.aka_qualia.router_client`.

Auto-generated bridge following canonical pattern:
  1) lukhas_website.lukhas.lukhas.aka_qualia.router_client
  2) candidate.lukhas.aka_qualia.router_client
...
_CANDIDATES = (
    "lukhas_website.lukhas.lukhas.aka_qualia.router_client",
    "candidate.lukhas.aka_qualia.router_client",
