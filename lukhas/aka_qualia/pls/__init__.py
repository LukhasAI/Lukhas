"""Bridge for `lukhas.aka_qualia.pls`.

Auto-generated bridge following canonical pattern:
  1) lukhas_website.lukhas.lukhas.aka_qualia.pls
  2) candidate.lukhas.aka_qualia.pls
  3) aka_qualia.pls
...
_CANDIDATES = (
    "lukhas_website.lukhas.lukhas.aka_qualia.pls",
    "candidate.lukhas.aka_qualia.pls",
    "aka_qualia.pls",
)
