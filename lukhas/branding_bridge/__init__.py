...
try:
    from labs.branding_bridge import get_constellation_context
except ImportError:
...
try:
    from labs.branding_bridge import get_system_signature
except ImportError:
...
try:
    from labs.branding_bridge import initialize_branding
except ImportError:
    try:
        from branding.initializer import initialize_branding
    except Exception:
