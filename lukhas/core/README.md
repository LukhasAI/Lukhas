...
**Getting Started**: LUKHAS core module. This module integrates with the LUKHAS system to provide essential functionality.
...
```bash
# Run module tests
pytest /Users/agi_dev/LOCAL-REPOS/Lukhas/lukhas/core/tests/ -v

# Run with coverage
pytest /Users/agi_dev/LOCAL-REPOS/Lukhas/lukhas/core/tests/ --cov=core --cov-report=html
```
