...
class TestCoreExternalIntegration:
    ...
    def test_database_integration(self):
        ...
        try:
            ...
            with patch('lukhas.core.database.connect') as mock_db:
...
class TestCoreErrorRecoveryIntegration:
    ...
    def test_graceful_degradation(self):
        ...
        try:
            ...
            with patch('lukhas.core.external_service.call') as mock_service:
    ...
    def test_circuit_breaker_integration(self):
        ...
        try:
            ...
            with patch('lukhas.core.circuit_breaker.is_open') as mock_cb:
