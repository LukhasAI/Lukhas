...
class ConsciousnessPolicy(nn.Module):
    ...
    def __init__(
        ...
        logger.info("🧠 ConsciousnessPolicy initialized: state_dim=%d, action_dim=%d, hidden_dim=%d", 
...
class ConsciousnessValueNetwork(nn.Module):
    ...
    def __init__(
        ...
        self.awareness_value = nn.Sequential(
            nn.Linear(hidden_dim, 128),
            nn.ReLU(),
            nn.Linear(128, 1)
        )
        
        self.coherence_value = nn.Sequential(
            nn.Linear(hidden_dim, 128), 
            nn.ReLU(),
            nn.Linear(128, 1)
        )
        
        self.growth_value = nn.Sequential(
            nn.Linear(hidden_dim, 128),
            nn.ReLU(), 
            nn.Linear(128, 1)
        )
        ...
        self.value_confidence = nn.Sequential(
            nn.Linear(hidden_dim, 64),
            nn.ReLU(),
            nn.Linear(64, 1),
            nn.Sigmoid()
        ...
        logger.info("🧠 ConsciousnessValueNetwork initialized: state_dim=%d, hidden_dim=%d", 
