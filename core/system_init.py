...
class LUKHASSystem:
    ...
    def _print_summary(self, module_report: Dict[str, Any], init_time: float):
        ...
        # Critical modules
        print("\n🔑 Critical Systems:")
        critical_modules = ["identity_system", "memory_systems", "signal_system"]
...
def initialize_lukhas(priority: str = "HIGH") -> LUKHASSystem:
    ...
    Args:
        priority: Module loading priority ("CRITICAL", "HIGH", "MEDIUM", "LOW", "OPTIONAL")
...
def main():
    ...
    # Initialize system
    with LUKHASContext(args.priority) as system:
