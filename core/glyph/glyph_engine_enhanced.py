...
class EnhancedGlyphEngine:
    ...
    def translate_for_module(
        ...
        module_preferences = {
            ...
            "quantum": (
                {SymbolModality.QUANTUM},
                {SymbolDomain.QUANTUM}
            ),
            "colony": (
                {SymbolModality.TEXT},
                {SymbolDomain.SOCIAL}
    ...
    def create_cognitive_chain(
        self,
        concepts: List[str],
        source_module: str = "consciousness"
