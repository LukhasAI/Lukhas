...
class ModuleManager:
    ...
    def _initialize_core_modules(self):
        ...
        # Identity System
        self.register_module(ModuleConfig(
    ...
    def _check_dependencies(self, config: ModuleConfig) -> bool:
        ...
        for dep in config.dependencies:
            ...
            if dep_info.status not in [ModuleStatus.LOADED, ModuleStatus.FALLBACK]:
...
def initialize_system(priority: ModulePriority = ModulePriority.HIGH) -> Dict[str, Any]:
    """
    ...
    results = manager.load_all(priority)
