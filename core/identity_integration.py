...
class TierMappingConfig:
    ...
    ONEIRIC_TO_LAMBDA: ClassVar[dict[str, object]] = {  # TODO[T4-ISSUE]: {"code":"RUF012","ticket":"GH-1031","owner":"consciousness-team","status":"planned","reason":"Mutable class attribute needs ClassVar annotation for type safety","estimate":"15m","priority":"medium","dependencies":"typing imports","id":"_Users_agi_dev_LOCAL_REPOS_Lukhas_core_identity_integration_py_L65"}
        1: "LAMBDA_TIER_1",
        2: "LAMBDA_TIER_2",
        3: "LAMBDA_TIER_3",
        4: "LAMBDA_TIER_4",
    ...
    EMOTIONAL_TO_LAMBDA: ClassVar[dict[str, object]] = {  # TODO[T4-ISSUE]: {"code":"RUF012","ticket":"GH-1031","owner":"consciousness-team","status":"planned","reason":"Mutable class attribute needs ClassVar annotation for type safety","estimate":"15m","priority":"medium","dependencies":"typing imports","id":"_Users_agi_dev_LOCAL_REPOS_Lukhas_core_identity_integration_py_L74"}
