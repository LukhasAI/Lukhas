...
class TagRegistry:
    ...
    def __init__(self):
        ...
        self.category_index: Dict[TagCategory, Set[str]] = {cat: set() for cat in TagCategory}
    ...
    def _initialize_core_tags(self):
        ...
        # Core system tags
        self.register_tag(TagDefinition(
            name="#TAG:core",
            ...
            effects=["Provides essential functionality", "Cannot be disabled"],
            priority=1
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            triggers=["High stress", "System overload", "Learning opportunity"],
            effects=["Module reorganization", "New connection formation", "Behavioral adaptation"],
        ...
        self.register_tag(TagDefinition(
            ...
            effects=["Self-replication", "Distributed processing", "Fault tolerance"],
        ...
        self.register_tag(TagDefinition(
            ...
            effects=["Emotional state changes", "Mood regulation", "Empathy responses"],
            priority=4
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            human_meaning="Measures emotions on three scales: pleasantness, intensity, and control",
            parent_tags={"#TAG:emotion"},
            effects=["Precise emotion measurement", "Emotional state tracking"],
            priority=5
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            triggers=["Decision completion", "Error detection", "Learning events"],
            effects=["Self-improvement", "Pattern recognition", "Behavioral adjustment"],
            priority=3
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            effects=["Experience retention", "Knowledge accumulation", "Pattern learning"],
            priority=2
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            effects=["Memory compression", "Emotional association", "Causal linking"],
            priority=4
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            triggers=["Rest cycles", "High memory load", "Unresolved conflicts"],
            effects=["Memory consolidation", "Creative insights", "Problem solving"],
            priority=3
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            effects=["Action filtering", "Risk assessment", "Ethical validation"],
            priority=1
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            triggers=["Action requests", "Decision points", "Risk detection"],
            effects=["Action approval/denial", "Risk mitigation", "Value alignment"],
        ...
        self.register_tag(TagDefinition(
            ...
            related_tags={"#TAG:neuroplastic", "#TAG:mood", "#TAG:emotion"},
            child_tags={"#TAG:cortisol", "#TAG:dopamine", "#TAG:serotonin", "#TAG:oxytocin"},
            effects=["System-wide modulation", "Behavioral tendencies", "Stress response"],
            priority=3
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            triggers=["System overload", "Threat detection", "Resource scarcity"],
            effects=["Heightened alertness", "Resource conservation", "Module reorganization"],
            priority=4
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            parent_tags={"#TAG:hormone"},
            triggers=["Goal achievement", "Learning success", "Positive feedback"],
            effects=["Motivation increase", "Pattern reinforcement", "Exploration drive"],
            priority=4
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            human_meaning="Promotes emotional balance and well-being, reduces anxiety",
            parent_tags={"#TAG:hormone"},
            triggers=["Social connection", "Routine completion", "Environmental safety"],
            effects=["Mood stabilization", "Anxiety reduction", "Contentment"],
            priority=4
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            parent_tags={"#TAG:hormone"},
            triggers=["Positive interactions", "Trust building", "Cooperation"],
            effects=["Empathy enhancement", "Trust increase", "Social bonding"],
            priority=4
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            related_tags={"#TAG:consciousness", "#TAG:ethics", "#TAG:emotion"},
            triggers=["Multiple options", "Action requests", "Goal conflicts"],
            effects=["Choice selection", "Action initiation", "Consequence evaluation"],
            priority=2
        ))
        ...
        self.register_tag(TagDefinition(
            ...
            related_tags={"#TAG:memory", "#TAG:neuroplastic", "#TAG:dream"},
            triggers=["New experiences", "Errors", "Pattern detection"],
            effects=["Skill improvement", "Knowledge update", "Behavior modification"],
            priority=3
        ))
    ...
    def explain_tag_activation(self, tag_name: str, context: Dict[str, Any]) -> str:
        ...
        for trigger in tag.triggers:
            ...
            if any(keyword in str(context).lower() for keyword in trigger.lower().split()):
