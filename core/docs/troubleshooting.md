...
2. Validate configuration: `python -c "import core; print('OK')"`
3. Review logs in `logs/core.log`
...
python -m core --validate-config

# Test connections
python -m core --test-connections

# Generate diagnostic report
python -m core --diagnostic-report
```
