...
from .config import get_config, ModuleConfig
from .glyph import GLYPHToken, GLYPHSymbol, create_response_glyph, create_error_glyph
from .exceptions import ModuleNotFoundError, ModuleTimeoutError, LukhasError
...
class BaseModule(ABC):
    ...
    async def handle_glyph(self, token: GLYPHToken) -> GLYPHToken:
        ...
        try:
            # Guardian validation
            if self.guardian and token.get_metadata('skip_guardian') != True:
