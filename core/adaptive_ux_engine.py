    ...
    def _init_interface_templates(self) -> Dict[InterfaceMode, Dict[str, Any]]:
        ...
        return {
            ...
            InterfaceMode.ADVANCED: {
                "components": ["input", "output", "tools", "analytics", "customization"],
                "complexity": 0.8,
                "guidance_level": 0.3
            },
...
async def demo():
    ...
    scenarios = [
        ("user_001", "create a new machine learning model", InterfaceMode.STANDARD),
        ("user_002", "analyze complex dataset with quantum algorithms", InterfaceMode.EXPERT),
        ("user_003", "help me get started", InterfaceMode.MINIMAL)
    ]
    
    for user_id, input_text, expected_mode in scenarios:
        print(f"\n{'='*60}")
