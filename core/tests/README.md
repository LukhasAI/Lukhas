...
This directory contains the test suite for the core module.
...
- **`test_core_unit.py`** - Unit tests for individual components
- **`test_core_integration.py`** - Integration tests for module interactions
