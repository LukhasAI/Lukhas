...
class TierAwareColonyProxy:
    ...
    async def _validate_method_access(self, user_context: QIUserContext, method_name: str):
    ...
    async def _check_rate_limits(self, user_context: QIUserContext, method_name: str):
...
class ColonyProxyManager:
    ...
    def create_proxy(self, colony: BaseColony | object, proxy_id: Optional[str] = None) -> TierAwareColonyProxy:
        """
...
def create_identity_aware_proxy(
    colony: BaseColony | object, proxy_id: Optional[str] = None
