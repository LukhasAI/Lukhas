...
# Packages Troubleshooting Guide
...
2. Validate configuration: `python -c "import packages; print('OK')"`
3. Review logs in `logs/packages.log`
...
```bash
# Check module health
python -m packages --health-check

# Validate configuration
python -m packages --validate-config

# Test connections
python -m packages --test-connections

# Generate diagnostic report
python -m packages --diagnostic-report
```
