# Oneiric_Core Troubleshooting Guide
...
2. Validate configuration: `python -c "import oneiric_core; print('OK')"`
3. Review logs in `logs/oneiric_core.log`
...
```bash
# Check module health
python -m oneiric_core --health-check

# Validate configuration
python -m oneiric_core --validate-config

# Test connections
python -m oneiric_core --test-connections

# Generate diagnostic report
python -m oneiric_core --diagnostic-report
```
