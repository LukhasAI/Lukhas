...
This directory contains the test suite for the oneiric_core module.
...
- **`test_oneiric_core_unit.py`** - Unit tests for individual components
- **`test_oneiric_core_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=oneiric_core --cov-report=html
```
