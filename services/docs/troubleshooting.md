...
2. Validate configuration: `python -c "import services; print('OK')"`
3. Review logs in `logs/services.log`
...
```bash
# Check module health
python -m services --health-check

# Validate configuration
python -m services --validate-config

# Test connections
python -m services --test-connections

# Generate diagnostic report
python -m services --diagnostic-report
```
