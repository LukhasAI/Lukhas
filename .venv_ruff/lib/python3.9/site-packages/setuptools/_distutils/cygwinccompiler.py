    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        if ("gcc" in self.cc): # Start gcc workaround
            self.gcc_version, self.ld_version, self.dllwrap_version = \
                get_versions()
            self.debug_print(self.compiler_type + f": gcc {self.gcc_version}, ld {self.ld_version}, dllwrap {self.dllwrap_version}\n" )
        ...
        self.set_executables(compiler=f"{self.cc} -mcygwin -O -Wall",
...
class Mingw32CCompiler(CygwinCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        self.set_executables(compiler=f"{self.cc} -O -Wall",
