...
def find_vcvarsall(version):
    ...
    try:
        productdir = Reg.get_value(rf"{vsbase}\Setup\VC",
                                   "productdir")
    except KeyError:
...
if VERSION < 8.0:
    raise DistutilsPlatformError(f"VC {VERSION:0.1f} is not supported by this module")
    ...
    def initialize(self, plat_name=None):
        ...
        if "DISTUTILS_USE_SDK" in os.environ and "MSSdk" in os.environ and self.find_exe("cl.exe"):
            ...
            if len(self.__paths) == 0:
                raise DistutilsPlatformError(f"Python was built with {self.__product}, "
