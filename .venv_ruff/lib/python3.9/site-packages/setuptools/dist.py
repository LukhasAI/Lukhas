...
class Distribution(_Distribution):
    ...
    def _validate_version(version):
        ...
        if version is not None:
            try:
                ...
                warnings.warn(
                    f"The version specified ({version!r}) is an invalid version, this "
    ...
    def warn_dash_deprecation(self, opt, section):
        ...
        if "-" in opt:
            warnings.warn(
                f"Usage of dash-separated '{opt}' will not be supported in future "
                f"versions. Please use the underscore name '{underscore_opt}' instead"
            )
        return underscore_opt
    ...
    def make_option_lowercase(self, opt, section):
        ...
        warnings.warn(
            f"Usage of uppercase key '{opt}' in '{section}' will be deprecated in future "
            f"versions. Please use lowercase '{lowercase_opt}' instead"
        )
