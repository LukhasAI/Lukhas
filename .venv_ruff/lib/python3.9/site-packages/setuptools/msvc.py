...
class PlatformInfo:
    ...
    def cross_dir(self, forcex86=False):
        ...
        return (
            ...
            self.target_dir().replace("\\", f"\\{current}_")
        )
...
class SystemInfo:
    ...
    def find_programdata_vs_vers(self):
        ...
        for name in hashed_names:
            try:
                ...
                with builtins.open(state_path, encoding="utf-8") as state_file:
    ...
    def VSInstallDir(self):
        ...
        default = join(self.ProgramFilesx86,
                       f"Microsoft Visual Studio {self.vs_ver:0.1f}")
    ...
    def OSIncludes(self):
        ...
        if self.vs_ver <= 10.0:
            ...
            if self.vs_ver >= 14.0:
                ...
                sdkver = ""
            return [join(include, f"{sdkver}shared"),
        ...
        if self.vs_ver >= 14.0:
            libpath += [
                ...
                join(
                    ...
                    f"{self.vs_ver:0.1f}", "References", "CommonConfiguration",
                    "neutral"),
            ]
        return libpath
