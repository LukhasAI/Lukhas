...
class HTTPConnection(_HTTPConnection):
    ...
    def putheader(self, header, *values):
        ...
        if not any(isinstance(v, str) and v == SKIP_HEADER for v in values):
            ...
            raise ValueError(
                "urllib3.util.SKIP_HEADER only supports '{}'".format("', '".join(map(str.title, sorted(SKIPPABLE_HEADERS))))
            )
    ...
    def connect(self):
        ...
        if (
            ...
            warnings.warn(
                ...
                f"'{self.host}' with '{self.sock.version()}' can be enabled by explicitly opting-in "
                "with 'ssl_version'",
                DeprecationWarning,
            )
