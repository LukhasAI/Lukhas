...
from typing import (
	Any,
	AnyStr,
	Callable,  # Replaced by `collections.abc.Collection` in 3.9.
	Generic,  # Replaced by `collections.abc.Iterator` in 3.9.
	Optional,  # Replaced by `collections.abc.Sequence` in 3.9.
	TypeVar,
...
class AlreadyRegisteredError(Exception):
	...
	def message(self) -> str:
		...
		*message* (:class:`str`) is the error message.
		"""
		return f"{self.name!r} is already registered for pattern factory:{self.pattern_factory!r}."
...
class RecursionError(Exception):
	...
	def message(self) -> str:
		...
		*message* (:class:`str`) is the error message.
		"""
		return f"Real path {self.real_path!r} was encountered at {self.first_path!r} and then {self.second_path!r}."
