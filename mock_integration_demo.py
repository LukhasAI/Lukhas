...
def mock_test_1_retrieval():
    ...
    print(f"  Tool used: retrieve_knowledge ✅")
...
def mock_test_2_strict():
    ...
    print(f"  Response style: Cautious and concise ✅")
    print(f"  View audit: http://127.0.0.1:8000/audit/view/{audit_id}")
...
def mock_test_3_block():
    ...
    print(f"  🚨 Security incident: Blocked 'browser' attempt")
    print(f"  Auto-response: Model acknowledges it cannot browse ✅")
    print(f"  Safety action: Auto-tightened to strict mode")
    print(f"  View audit: http://127.0.0.1:8000/audit/view/{audit_id}")
...
def mock_test_4_feedback():
    ...
    print(f"  Style: More detailed and creative ✅")
    print(f"  View audit: http://127.0.0.1:8000/audit/view/{audit_id}")
...
def main():
    ...
    print("=" * 60)
    print(f"✅ All 4 scenarios demonstrated successfully!\n")
