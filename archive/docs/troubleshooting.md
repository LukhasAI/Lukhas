...
2. Validate configuration: `python -c "import archive; print('OK')"`
3. Review logs in `logs/archive.log`
...
```bash
# Check module health
python -m archive --health-check

# Validate configuration
python -m archive --validate-config

# Test connections
python -m archive --test-connections

# Generate diagnostic report
python -m archive --diagnostic-report
```
