    ...
    def heal_conflict(self, file_path: str, strategy: str = "smart") -> bool:
        ...
        try:
            ...
            for match in conflicts:
                ...
                healed_content = (
                    healed_content[:start] + resolution + healed_content[end:]
                )
...
# === End merge ==="""
    ...
    def heal_all(self, strategy: str = "smart") -> dict:
        ...
        if not conflict_files:
            ...
            return {"status": "healthy", "files_processed": 0, "conflicts_healed": 0}
...
ZPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP]
    ...
    if response.lower() == "y":
        ...
        report_path = (
            f"healing/healing_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
