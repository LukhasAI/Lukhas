...
class ColonyIntelligence:
    ...
    def _proposals_align(self, prop1: AgentProposal, prop2: AgentProposal) -> bool:
        ...
        if (prop1.agent_type == AgentType.CRITIC and prop2.agent_type == AgentType.DREAMER) or " + "(prop1.agent_type == AgentType.DREAMER and prop2.agent_type == AgentType.CRITIC):
