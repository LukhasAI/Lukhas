...
# Quarantine Troubleshooting Guide
...
2. Validate configuration: `python -c "import quarantine; print('OK')"`
3. Review logs in `logs/quarantine.log`
...
```bash
# Check module health
python -m quarantine --health-check

# Validate configuration
python -m quarantine --validate-config

# Test connections
python -m quarantine --test-connections

# Generate diagnostic report
python -m quarantine --diagnostic-report
```
