...
- **Generation Time**: {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M:%S")}
- **Documentation Version**: v2.0.0
...
*This metrics report was generated by the LUKHAS Documentation Orchestrator on {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M:%S")}.*
"""
