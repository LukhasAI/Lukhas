...
class TestDreamweaverHelpersBundleModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {"module_name": "dreamweaver_helpers_bundle", "test_mode": True}
    ...
    def test_module_version(self):
        ...
        self.assertTrue(
            hasattr(dreamweaver_helpers_bundle, "__version__") or hasattr(dreamweaver_helpers_bundle, "VERSION")
        )
