...
class TestFinalSweepModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {"module_name": "final-sweep", "test_mode": True}
    ...
    def test_module_version(self):
        ...
        self.assertTrue(
            hasattr(final - sweep, "__version__") or hasattr(final - sweep, "VERSION")  # noqa: F821  # TODO: final
        )  # noqa: F821  # TODO: final
