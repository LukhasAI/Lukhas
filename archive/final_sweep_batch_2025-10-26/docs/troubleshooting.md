...
# Final-Sweep Troubleshooting Guide
...
2. Validate configuration: `python -c "import final-sweep; print('OK')"`
3. Review logs in `logs/final-sweep.log`
...
```bash
# Check module health
python -m final-sweep --health-check

# Validate configuration
python -m final-sweep --validate-config

# Test connections
python -m final-sweep --test-connections

# Generate diagnostic report
python -m final-sweep --diagnostic-report
```
