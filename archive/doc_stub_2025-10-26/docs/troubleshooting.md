...
2. Validate configuration: `python -c "import doc; print('OK')"`
3. Review logs in `logs/doc.log`
...
```bash
# Check module health
python -m doc --health-check

# Validate configuration
python -m doc --validate-config

# Test connections
python -m doc --test-connections

# Generate diagnostic report
python -m doc --diagnostic-report
```
