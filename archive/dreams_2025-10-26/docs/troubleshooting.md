...
2. Validate configuration: `python -c "import dreams; print('OK')"`
3. Review logs in `logs/dreams.log`
...
```bash
# Check module health
python -m dreams --health-check

# Validate configuration
python -m dreams --validate-config

# Test connections
python -m dreams --test-connections

# Generate diagnostic report
python -m dreams --diagnostic-report
```
