...
- **`test_dreams_unit.py`** - Unit tests for individual components
- **`test_dreams_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=dreams --cov-report=html
```
