...
- `dreams.DREAMS_ACTIVE`
- `dreams.DreamLoopGenerator`
- `dreams.DreamMemoryManager`
- `dreams.DreamStatistics`
- `dreams.activate_consciousness_dream_bridge`
- `dreams.analyze_dream_patterns`
- `dreams.create_dream_session`
- `dreams.dream_stats`
- `dreams.get_dreams_status`
- `dreams.logger`
...

## Documentation

See manifest: `dreams/module.manifest.json`
