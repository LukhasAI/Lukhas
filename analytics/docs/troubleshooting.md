...
2. Validate configuration: `python -c "import analytics; print('OK')"`
3. Review logs in `logs/analytics.log`
...
```bash
# Check module health
python -m analytics --health-check

# Validate configuration
python -m analytics --validate-config

# Test connections
python -m analytics --test-connections

# Generate diagnostic report
python -m analytics --diagnostic-report
```
