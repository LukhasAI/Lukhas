...
class DΛST:
    ...
    def _infer_symbols_from_app(self, app_name: str) -> list[tuple[str, SymbolCategory]]:
        ...
        app_mappings = {
            "code": [
                ("coding", SymbolCategory.ACTIVITY),
                ("focus", SymbolCategory.FOCUS),
            ],
            "vscode": [
                ("coding", SymbolCategory.ACTIVITY),
                ("development", SymbolCategory.FOCUS),
            ],
            "slack": [
            ...
            "spotify": [
                ("music", SymbolCategory.MOOD),
                ("creative", SymbolCategory.CREATIVE),
            ],
            "notion": [
...
if __name__ == "__main__":
    ...
    async def demo():
        ...
        await dast.add_symbol(
            ...
            SymbolSource.ACTIVITY_TRACKER,
            0.8,
        )
        await dast.add_symbol(
            "alice",
            "creative-flow",
            SymbolCategory.CREATIVE,
