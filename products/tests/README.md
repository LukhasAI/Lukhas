...
- **`test_products_unit.py`** - Unit tests for individual components
- **`test_products_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=products --cov-report=html
```
