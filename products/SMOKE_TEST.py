...
def test_basic_imports() -> List[TestResult]:
    ...
    for category in categories:
        try:
            ...
            results.append(TestResult(f"products.{category}", "pass", 
                                    details={"modules": getattr(module, '__all__', [])}))
        except Exception as e:
...
def test_experience_components() -> List[TestResult]:
    ...
    for comp_name, module_path in components.items():
        try:
            ...
            results.append(TestResult(f"experience.{comp_name}", "pass",
                                    details={"path": module_path, "attrs": dir(module)}))
        except Exception as e:
...
def test_deep_imports() -> List[TestResult]:
    ...
    deep_tests = [
        ...
        ("content.poetica.creativity_engines.creative_core", "products.content.poetica.creativity_engines.creative_core"),
    ]
    ...
    for test_name, module_path in deep_tests:
        try:
            ...
            results.append(TestResult(f"deep.{test_name}", "pass",
...
def test_class_instantiation() -> List[TestResult]:
    ...
    for test_name, module_path, class_name in class_tests:
        try:
            ...
            results.append(TestResult(f"class.{test_name}", "pass",
