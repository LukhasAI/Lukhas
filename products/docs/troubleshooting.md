...
2. Validate configuration: `python -c "import products; print('OK')"`
3. Review logs in `logs/products.log`
...
```bash
# Check module health
python -m products --health-check

# Validate configuration
python -m products --validate-config

# Test connections
python -m products --test-connections

# Generate diagnostic report
python -m products --diagnostic-report
```
