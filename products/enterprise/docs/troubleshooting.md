...
2. Validate configuration: `python -c "import enterprise; print('OK')"`
3. Review logs in `logs/enterprise.log`
...
```bash
# Check module health
python -m enterprise --health-check

# Validate configuration
python -m enterprise --validate-config

# Test connections
python -m enterprise --test-connections

# Generate diagnostic report
python -m enterprise --diagnostic-report
```
