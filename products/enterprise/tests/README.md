...
- **`test_enterprise_unit.py`** - Unit tests for individual components
- **`test_enterprise_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=enterprise --cov-report=html
```
