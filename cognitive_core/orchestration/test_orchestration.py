...
from .capability_matrix import CapabilityDimension, CapabilityMatrix, TaskRequirements, TaskType
from .consensus_engine import ConsensusEngine, ConsensusMethod, ConsensusResult
from .cost_optimizer import CostConstraints, CostOptimizer, CostTier, OptimizationStrategy
from .model_router import ModelResponse, ModelRouter, RoutingDecision, RoutingRequest
...
class TestCostOptimizer:
    ...
    def test_cost_constraint_checking(self):
        ...
        assert optimizer.check_cost_constraints(0.02, constraints) is False
...
class TestConsensusEngine:
    ...
    async def test_dream_integrated_consensus(self, engine):
        ...
        with patch("cognitive_core.reasoning.dream_integration.DreamReasoningBridge") as mock_dream:
