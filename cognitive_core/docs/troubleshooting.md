# Cognitive_Core Troubleshooting Guide
...
2. Validate configuration: `python -c "import cognitive_core; print('OK')"`
3. Review logs in `logs/cognitive_core.log`
...
```bash
# Check module health
python -m cognitive_core --health-check

# Validate configuration
python -m cognitive_core --validate-config

# Test connections
python -m cognitive_core --test-connections

# Generate diagnostic report
python -m cognitive_core --diagnostic-report
```
