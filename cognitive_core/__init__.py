"""
Cognitive Core Infrastructure for LUKHAS
...
dream system for consciousness-aware Cognitive functionality.
"""
...
MODULES = {
    ...
    "tests": {
        "description": "Comprehensive Cognitive testing framework",
...
def get_cognitive_core_info():
    """Get information about Cognitive core capabilities."""
    return {
        "version": __version__,
        "modules": MODULES,
        "total_components": sum(len(module["components"]) for module in MODULES.values()),
        "description": "Advanced Cognitive infrastructure for LUKHAS with dream integration",
    }
