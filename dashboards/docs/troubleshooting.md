...
# Dashboards Troubleshooting Guide
...
2. Validate configuration: `python -c "import dashboards; print('OK')"`
3. Review logs in `logs/dashboards.log`
...
```bash
# Check module health
python -m dashboards --health-check

# Validate configuration
python -m dashboards --validate-config

# Test connections
python -m dashboards --test-connections

# Generate diagnostic report
python -m dashboards --diagnostic-report
```
