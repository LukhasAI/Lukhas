...
2. Validate configuration: `python -c "import design-system; print('OK')"`
3. Review logs in `logs/design-system.log`
...
```bash
# Check module health
python -m design-system --health-check

# Validate configuration
python -m design-system --validate-config

# Test connections
python -m design-system --test-connections

# Generate diagnostic report
python -m design-system --diagnostic-report
```
