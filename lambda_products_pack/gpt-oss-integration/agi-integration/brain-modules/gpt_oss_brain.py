        ...
        try:
            ...
            if not self.model_path.exists():
                ...
                result = subprocess.run(
                    ["python", "-c", f"import ollama; print(ollama.list())"],
                    capture_output=True,
                    text=True
                )
...
Provide clear, structured, and insightful reasoning."""
    ...
    def _check_lukhas_patterns(self, reasoning: Dict[str, Any]) -> Dict[str, bool]:
        ...
        return {
            ...
            "quantum_concepts": "quantum" in raw_output or "superposition" in raw_output,
    ...
    def _fallback_reasoning(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "reasoning": {
                ...
                "key_insights": ["Pattern recognition active", "Heuristic processing engaged"],
