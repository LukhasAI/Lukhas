    ...
    try:
        ...
        if session:
            ...
            if 'emotional_gating' in phases:
                ...
                print(f"   Emotional Gating:")
                print(f"     - Emotional State: {gating_phase.get('emotional_state')}")
                print(f"     - Attention State: {gating_phase.get('attention_state', 'N/A')}")
                print(f"     - ABAS Decision: {gating_phase.get('abas_decision', 'N/A')}")
        ...
        if 'message' in result and 'attention_enhancement' in result['message']:
            ...
            print(f"   Attention Enhancement Applied:")
