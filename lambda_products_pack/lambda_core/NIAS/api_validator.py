            ...
            "vendor_request": ValidationSchema(
                ...
                rules=[
                    ...
                    ValidationRule(
                        field="request_type",
                        validation_type=ValidationType.ENUM,
                        params={"values": ["create_seed", "update_seed", "delete_seed", "get_analytics"]},
                        error_message="Invalid request type"
                    ),
                    ValidationRule(
                        field="tier",
                        validation_type=ValidationType.ENUM,
                        params={"values": ["trial", "basic", "professional", "enterprise", "strategic"]},
        ...
        if rule.validation_type == ValidationType.REQUIRED:
            if field_value is None or field_value == "":
                raise ValidationError(
                    rule.field,
                    rule.error_message or f"{rule.field} is required"
                )
            return field_value
