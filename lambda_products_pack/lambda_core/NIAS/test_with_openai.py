...
async def test_openai_dream_generation():
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        try:
            ...
            if dream.image_url:
                ...
                print("   (Open this URL in a browser to see the dream image)")
    ...
    if unethical_dream.ethical_score < 0.8:
        print("   ✅ Correctly identified as unethical (score < 0.8)")
    else:
        print("   ⚠️ May need additional ethical validation")
