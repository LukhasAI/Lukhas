...
class WidgetEngine:
    ...
    async def _configure_interactions(self, template: Dict[str, Any], tier: str) -> Dict[str, List]:
        ...
        for interaction in available_interactions:
            ...
            if tier == "T3" and gesture in [InteractionType.SWIPE_LEFT.value, InteractionType.HOLD.value]:
    ...
    async def _generate_fallback_widget(self, message: Dict[str, Any], tier: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "interactions": {
                "enabled_gestures": [InteractionType.TAP.value, InteractionType.SWIPE_LEFT.value],
                "action_mappings": {
    ...
    async def handle_interaction(
        ...
        try:
            ...
            if interaction_type not in interaction_config.get("enabled_gestures", []):
                return {"success": False, "error": f"Interaction {interaction_type} not enabled"}
    ...
    async def _execute_action(
        ...
        if action == "show_pitch":
            ...
            return {
                ...
                "detailed_view": {
                    "description": widget["content"].get("detailed_description", widget["content"].get("description", "")),
