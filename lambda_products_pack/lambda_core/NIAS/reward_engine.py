...
class NIASRewardEngine:
    ...
    def get_user_rewards_dashboard(self, user_id: str) -> Dict[str, Any]:
        ...
        level_progress = ((profile.total_points - current_level_threshold) / 
    ...
    def _check_requirements(
        ...
        for req_type, req_value in requirements.items():
            if req_type == "credits" and profile.total_credits < req_value:
                return False
            elif req_type == "points" and profile.total_points < req_value:
                return False
            elif req_type == "level" and profile.experience_level < req_value:
                return False
    ...
    def _check_unlockables(
        ...
        for content_id, content in self.exclusive_content.items():
            ...
            if (self._check_requirements(profile, content.unlock_requirements) and
                content.access_level == ContentAccessLevel.BASIC):
                profile.unlocked_content.append(content_id)
    ...
    def _check_achievements(
        ...
        for milestone in milestones:
            ...
            if (total_engagements >= milestone and 
                achievement_name not in profile.achievements):
