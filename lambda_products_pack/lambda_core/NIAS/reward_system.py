...
class RewardEngine:
    ...
    async def process_engagement(self, user_id: str, dream_id: str, 
                                 engagement_level: EngagementLevel,
                                 engagement_data: Dict[str, Any]) -> Reward:
        """
    ...
    async def _check_achievements(self, profile: UserRewardProfile,
                                  engagement_level: EngagementLevel,
        ...
        if engagement_level == EngagementLevel.SHARED:
            share_count = sum(1 for r in profile.reward_history 
        ...
        unique_dreams = set(r.metadata.get("dream_id") for r in profile.reward_history 
    ...
    def get_user_rewards_summary(self, user_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "pending_rewards": [
                ...
                for r in profile.pending_rewards if not r.redeemed
            ],
            "available_catalog": [
                {
                    "id": item_id,
            ...
            "next_level_xp": self.config["level_thresholds"][profile.current_level] 
