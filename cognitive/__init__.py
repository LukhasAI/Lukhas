...
if os.getenv("MATRIZ_COMPAT_IMPORTS", "1") == "1":
    try:
        # Import from candidate.core.matrix.nodes when available
        from candidate.core.matrix.nodes import *  # noqa: F401,F403
    except ImportError:
    ...
    # from candidate.memory import *  # noqa: F401,F403
