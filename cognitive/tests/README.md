...
- **`test_cognitive_unit.py`** - Unit tests for individual components
- **`test_cognitive_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=cognitive --cov-report=html
```
