...
# Cognitive Troubleshooting Guide
...
2. Validate configuration: `python -c "import cognitive; print('OK')"`
3. Review logs in `logs/cognitive.log`
...
```bash
# Check module health
python -m cognitive --health-check

# Validate configuration
python -m cognitive --validate-config

# Test connections
python -m cognitive --test-connections

# Generate diagnostic report
python -m cognitive --diagnostic-report
```
