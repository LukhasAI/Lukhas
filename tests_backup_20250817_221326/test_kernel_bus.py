...
async def test_kernel_bus():
    ...
    print("  Emitted memory fold event with effects")
    ...
    print("  Triggered drift detection")
    ...
    print("  Plugin loaded event sent")
    ...
    print("  Safety boundary event (CRITICAL priority)")
