...
class LLMAssistedValidator:
    ...
    async def _analyze_behavioral_patterns(self, context: LLMAnalysisContext) -> Dict[str, Any]:
        ...
        # Generate summary
        analysis["summary"] = f"User shows {analysis['evolution_trend']} behavioral patterns with {analysis['consistency_score']:.1f} consistency score. "
    ...
    def _create_fallback_response(self, context: LLMAnalysisContext) -> LLMValidationResponse:
        ...
        return LLMValidationResponse(
            ...
            recommendations=["Manual security review recommended", "Monitor for unusual patterns"],
...
def create_llm_analysis_context(user_id: str, auth_context: Dict[str, Any], historical_data: Optional[List] = None) -> LLMAnalysisContext:
