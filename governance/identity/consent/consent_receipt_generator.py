...
class ConsentReceiptGenerator:
    ...
    def generate_receipt(self,
                        ...
                        trusthelix_url: Optional[str] = None) -> str:
...
<svg width="400" height="600" xmlns="http://www.w3.org/2000/svg">
    ...
    def generate_batch_receipt(self,
                              user_id: str,
                              consent_events: List[Dict[str, Any]]) -> str:
...
def main():
    ...
    print(f"Open the SVG files to view the visual receipts")
