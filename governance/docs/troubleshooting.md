...
2. Validate configuration: `python -c "import governance; print('OK')"`
3. Review logs in `logs/governance.log`
...
```bash
# Check module health
python -m governance --health-check

# Validate configuration
python -m governance --validate-config

# Test connections
python -m governance --test-connections

# Generate diagnostic report
python -m governance --diagnostic-report
```
