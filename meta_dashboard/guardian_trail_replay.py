...
def print_summary(events: List[Dict[str, Any]]):
    ...
    print(f"Success Rate: {Colors.GREEN}{successful}/{interventions}{Colors.RESET} "
          f"({successful/interventions*100:.0f}%)" if interventions > 0 else "")
...
def main():
    ...
    print(f"Time span: {Colors.CYAN}{events[0].get('timestamp', 'Unknown')} "
