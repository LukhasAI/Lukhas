...
2. Validate configuration: `python -c "import samples; print('OK')"`
3. Review logs in `logs/samples.log`
...
```bash
# Check module health
python -m samples --health-check

# Validate configuration
python -m samples --validate-config

# Test connections
python -m samples --test-connections

# Generate diagnostic report
python -m samples --diagnostic-report
```
