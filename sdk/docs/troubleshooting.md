...
2. Validate configuration: `python -c "import sdk; print('OK')"`
3. Review logs in `logs/sdk.log`
...
```bash
# Check module health
python -m sdk --health-check

# Validate configuration
python -m sdk --validate-config

# Test connections
python -m sdk --test-connections

# Generate diagnostic report
python -m sdk --diagnostic-report
```
