...
2. Validate configuration: `python -c "import rl; print('OK')"`
3. Review logs in `logs/rl.log`
...
```bash
# Check module health
python -m rl --health-check

# Validate configuration
python -m rl --validate-config

# Test connections
python -m rl --test-connections

# Generate diagnostic report
python -m rl --diagnostic-report
```
