    ...
    <div className="min-h-screen bg-consciousness-deep">
      ...
      <Header className="fixed top-0 left-0 right-0 z-50 bg-consciousness-deep/80 backdrop-blur-md border-b border-enterprise-amber/20">
        ...
        <HeaderActions>
          ...
          <Button className="bg-enterprise-amber text-white">
            Explore Playground
          </Button>
        </HeaderActions>
      </Header>
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <Shield className="w-16 h-16 text-enterprise-amber animate-pulse" strokeWidth={1.5} />
          </div>
      ...
      <section className="py-8 px-6">
        <div className="max-w-5xl mx-auto">
          <GlassCard className="border-enterprise-amber/30">
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-enterprise-amber flex items-center gap-3">
      ...
      <section className="py-8 px-6">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Database className="w-6 h-6 text-enterprise-amber" />
                Information We Collect
              </h2>
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Eye className="w-6 h-6 text-enterprise-amber" />
                How We Use Your Information
              </h2>
              <div className="space-y-4 text-awareness-silver/80">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-enterprise-amber flex-shrink-0 mt-1" />
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Lock className="w-6 h-6 text-enterprise-amber" />
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Shield className="w-6 h-6 text-enterprise-amber" />
                Data Security
              </h2>
              <div className="space-y-4 text-awareness-silver/80">
                <p className="leading-relaxed">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <UserX className="w-6 h-6 text-enterprise-amber" />
                Your Privacy Rights
              </h2>
              <div className="space-y-4 text-awareness-silver/80">
                <p className="leading-relaxed">
                ...
                <p className="leading-relaxed mt-6">
                  ...
                  <a href="mailto:privacy@lukhas.com" className="text-enterprise-amber hover:underline">
                    privacy@lukhas.com
                  </a>
                </p>
              </div>
          ...
          <GlassCard>
            <div className="p-8">
              ...
              <div className="space-y-4 text-awareness-silver/80">
                ...
                <p className="leading-relaxed mt-4">
                  For EU users, see our <a href="https://lukhas.eu/privacy" className="text-enterprise-amber hover:underline">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <FileText className="w-6 h-6 text-enterprise-amber" />
          ...
          <GlassCard className="border-enterprise-amber/30">
            <div className="p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href="mailto:privacy@lukhas.com">
                  <Button className="bg-enterprise-amber text-white">
                    Email: privacy@lukhas.com
                  </Button>
                </a>
                <a href="/contact">
                  <Button variant="ghost" className="border border-enterprise-amber/30 text-awareness-silver">
                    Contact Form
                  </Button>
                </a>
              </div>
      ...
      <Footer>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="https://lukhas.eu" className="text-sm text-awareness-silver/70 hover:text-enterprise-amber transition-colors">EU/GDPR</a></li>
            <li><a href="https://lukhas.com" className="text-sm text-awareness-silver/70 hover:text-enterprise-amber transition-colors">US Compliance</a></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="https://lukhas.cloud" className="text-sm text-awareness-silver/70 hover:text-enterprise-amber transition-colors">Cloud</a></li>
          </ul>
        </div>
      </Footer>
    </div>
