      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <MessageSquare className="w-16 h-16 text-trust-blue animate-pulse" strokeWidth={1.5} />
          </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@lukhas.eu" className="text-trust-blue hover:underline">
                      hello@lukhas.eu
                    </a>
                  </div>
                </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@lukhas.eu" className="text-trust-blue hover:underline">
                      support@lukhas.eu
                    </a>
                  </div>
                </div>
            ...
            <div className="p-8">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full px-4 py-3 bg-consciousness-deep border border-trust-blue/30 rounded-lg text-awareness-silver focus:outline-none focus:border-trust-blue"
                ...
                <div>
                  ...
                  <textarea 
                    rows={6}
                    className="w-full px-4 py-3 bg-consciousness-deep border border-trust-blue/30 rounded-lg text-awareness-silver focus:outline-none focus:border-trust-blue resize-none"
                    placeholder="Tell us how we can help..."
                  />
                </div>
                <Button className="w-full bg-trust-blue text-white py-3">
                  Send Message
                </Button>
              </form>
            </div>
