      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <Scale className="w-16 h-16 text-trust-blue animate-pulse" strokeWidth={1.5} />
          </div>
            ...
            <div className="p-8">
              ...
              <div className="space-y-4 text-awareness-silver/80">
                ...
                <p className="leading-relaxed">
                  ...
                  shall apply. See <a href="https://lukhas.eu/terms" className="text-trust-blue hover:underline">
                  EU-specific terms</a>.
                </p>
              </div>
            </div>
          ...
          <GlassCard className="border-trust-blue/30">
            <div className="p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href="mailto:legal@lukhas.eu">
                  <Button className="bg-trust-blue text-white">
                    Email: legal@lukhas.eu
                  </Button>
                </a>
                <a href="/contact">
