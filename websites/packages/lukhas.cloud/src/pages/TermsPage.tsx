      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <Scale className="w-16 h-16 text-cloud-gradient animate-pulse" strokeWidth={1.5} />
          </div>
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <CheckCircle className="w-6 h-6 text-cloud-gradient" />
            ...
            <div className="p-8">
              ...
              <div className="space-y-4 text-awareness-silver/80">
                ...
                <p className="leading-relaxed">
                  ...
                  shall apply. See <a href="https://lukhas.eu/terms" className="text-cloud-gradient hover:underline">
                  EU-specific terms</a>.
                </p>
              </div>
            </div>
          ...
          <GlassCard className="border-cloud-gradient/30">
            <div className="p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href="mailto:legal@lukhas.cloud">
                  <Button className="bg-cloud-gradient text-white">
                    Email: legal@lukhas.cloud
                  </Button>
                </a>
                <a href="/contact">
