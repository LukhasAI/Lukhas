      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <Cookie className="w-16 h-16 text-integration-orange animate-pulse" strokeWidth={1.5} />
          </div>
      ...
      <section className="py-8 px-6">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Settings className="w-6 h-6 text-integration-orange" />
              ...
              <ul className="space-y-3 text-awareness-silver/80">
                <li className="flex items-start gap-3">
                  <Settings className="w-5 h-5 text-integration-orange flex-shrink-0 mt-1" />
                  <div>
