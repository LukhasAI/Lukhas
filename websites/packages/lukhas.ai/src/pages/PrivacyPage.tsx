      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <Shield className="w-16 h-16 text-dream-ethereal animate-pulse" strokeWidth={1.5} />
          </div>
      ...
      <section className="py-8 px-6">
        <div className="max-w-5xl mx-auto">
          <GlassCard className="border-dream-ethereal/30">
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-dream-ethereal flex items-center gap-3">
      ...
      <section className="py-8 px-6">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Database className="w-6 h-6 text-dream-ethereal" />
                Information We Collect
              </h2>
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Eye className="w-6 h-6 text-dream-ethereal" />
                How We Use Your Information
              </h2>
              <div className="space-y-4 text-awareness-silver/80">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-dream-ethereal flex-shrink-0 mt-1" />
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Lock className="w-6 h-6 text-dream-ethereal" />
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <Shield className="w-6 h-6 text-dream-ethereal" />
                Data Security
              </h2>
              <div className="space-y-4 text-awareness-silver/80">
                <p className="leading-relaxed">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <UserX className="w-6 h-6 text-dream-ethereal" />
                Your Privacy Rights
              </h2>
              <div className="space-y-4 text-awareness-silver/80">
                <p className="leading-relaxed">
                ...
                <p className="leading-relaxed mt-6">
                  ...
                  <a href="mailto:privacy@lukhas.ai" className="text-dream-ethereal hover:underline">
                    privacy@lukhas.ai
                  </a>
                </p>
              </div>
          ...
          <GlassCard>
            <div className="p-8">
              ...
              <div className="space-y-4 text-awareness-silver/80">
                ...
                <p className="leading-relaxed mt-4">
                  For EU users, see our <a href="https://lukhas.eu/privacy" className="text-dream-ethereal hover:underline">
          ...
          <GlassCard>
            <div className="p-8">
              <h2 className="text-2xl font-light tracking-wide mb-6 text-awareness-silver flex items-center gap-3">
                <FileText className="w-6 h-6 text-dream-ethereal" />
          ...
          <GlassCard className="border-dream-ethereal/30">
            <div className="p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href="mailto:privacy@lukhas.ai">
                  <Button className="bg-dream-gradient text-white">
