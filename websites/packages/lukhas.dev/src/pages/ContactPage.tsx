      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <MessageSquare className="w-16 h-16 text-developer-teal animate-pulse" strokeWidth={1.5} />
          </div>
            ...
            <GlassCard>
              <div className="p-8">
                <div className="flex items-center gap-4 mb-4">
                  <Mail className="w-8 h-8 text-developer-teal" />
                  <div>
                    <h3 className="text-xl font-light text-awareness-silver">General Inquiries</h3>
                    <a href="mailto:hello@lukhas.dev" className="text-developer-teal hover:underline">
                      hello@lukhas.dev
                    </a>
                  </div>
                </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@lukhas.dev" className="text-developer-teal hover:underline">
                      support@lukhas.dev
                    </a>
                  </div>
                </div>
            ...
            <div className="p-8">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full px-4 py-3 bg-consciousness-deep border border-developer-teal/30 rounded-lg text-awareness-silver focus:outline-none focus:border-developer-teal"
                ...
                <div>
                  ...
                  <textarea 
                    rows={6}
                    className="w-full px-4 py-3 bg-consciousness-deep border border-developer-teal/30 rounded-lg text-awareness-silver focus:outline-none focus:border-developer-teal resize-none"
                    placeholder="Tell us how we can help..."
                  />
                </div>
                <Button className="w-full bg-developer-teal text-white py-3">
                  Send Message
                </Button>
              </form>
            </div>
