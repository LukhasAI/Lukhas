...
```
brain/
├── __init__.py                  # 14 entrypoints, core brain functionality
...
|------|--------|-------------------|
| Anchor | ⚛️ | Identity validation, authentication |
| Trail | ✦ | Memory retrieval, fold management |
| Horizon | 🔬 | Vision and prediction integration |
| Watch | 🛡️ | Guardian safety validation |
| Flow | 🌊 | Adaptive response generation |
| Spark | ⚡ | Creative personality expression |
| Persona | 🎭 | Brand voice application |
| Oracle | 🔮 | Predictive reasoning coordination |
