...
2. Validate configuration: `python -c "import brain; print('OK')"`
3. Review logs in `logs/brain.log`
...
```bash
# Check module health
python -m brain --health-check

# Validate configuration
python -m brain --validate-config

# Test connections
python -m brain --test-connections

# Generate diagnostic report
python -m brain --diagnostic-report
```
