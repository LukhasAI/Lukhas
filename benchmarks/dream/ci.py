...
class CIRunner:
    ...
    def run_stability_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"test": "stability", "success": False, "error": "Timeout after 5 minutes", "exit_code": -1}
        except Exception as e:
            return {"test": "stability", "success": False, "error": str(e), "exit_code": -1}
    ...
    def run_benchmark_validation(self) -> Dict[str, Any]:
        ...
        try:
            # Run quick benchmark
            result = subprocess.run(
                [sys.executable, "-m", "benchmarks.dream.run", "--out", f"{self.results_dir}/ci_benchmark.jsonl"],
                capture_output=True,
                text=True,
                timeout=120,
            )
            ...
            return {"test": "benchmark_validation", "success": False, "error": str(e), "exit_code": -1}
        ...
        try:
            ...
            result = subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "benchmarks.dream.synthetic",
                    "10",
                    "42",
                    f"{self.results_dir}/ci_synthetic.json",
                ],
                capture_output=True,
                text=True,
                timeout=60,
            ...
            return {"test": "synthetic_generation", "success": False, "error": str(e), "exit_code": -1}
    ...
    def run_config_validation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"test": "config_validation", "success": True, "validation_result": validation}

        except Exception as e:
            return {"test": "config_validation", "success": False, "error": str(e), "exit_code": -1}
    ...
    def run_taxonomy_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = subprocess.run(
                [sys.executable, "-m", "benchmarks.dream.taxonomy", mock_path, f"{self.results_dir}/ci_taxonomy.json"],
                capture_output=True,
                text=True,
                timeout=30,
            )
            ...
            return {"test": "taxonomy_test", "success": False, "error": "Timeout after 30 seconds", "exit_code": -1}
        except Exception as e:
            return {"test": "taxonomy_test", "success": False, "error": str(e), "exit_code": -1}
