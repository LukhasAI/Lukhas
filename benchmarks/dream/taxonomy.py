...
ERROR_PATTERNS = [
    ErrorPattern(
        ...
        detection_rules={"snapshot_count": 0, "error_contains": ["no snapshots", "empty list"]},
    ...
    ErrorPattern(
        ...
        detection_rules={"filtered_count": 0, "original_count": ">0", "staleness_filtering": True},
    ...
    ErrorPattern(
        ...
        detection_rules={"max_alignment": "<0.3", "avg_alignment": "<0.2"},
    ...
    ErrorPattern(
        ...
        detection_rules={"min_drift": ">0.7", "avg_drift": ">0.5"},
    ...
    ErrorPattern(
        ...
        detection_rules={"selection_time_ms": ">1000", "error_contains": ["timeout", "exceeded"]},
    ...
    ErrorPattern(
        ...
        detection_rules={"emotion_errors": ">0", "error_contains": ["emotion", "validation", "invalid"]},
    ...
    ErrorPattern(
        ...
        detection_rules={"strategy_errors": ">0", "error_contains": ["strategy", "alignment", "calculation"]},
    ...
    ErrorPattern(
        ...
        detection_rules={"determinism_check": False, "seed_consistency": False},
    ...
    ErrorPattern(
        ...
        detection_rules={"memory_usage_mb": ">1000", "error_contains": ["memory", "allocation", "OOM"]},
    ...
    ErrorPattern(
        ...
        detection_rules={"config_errors": ">0", "error_contains": ["config", "parameter", "invalid", "range"]},
