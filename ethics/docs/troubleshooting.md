...
2. Validate configuration: `python -c "import ethics; print('OK')"`
3. Review logs in `logs/ethics.log`
...
```bash
# Check module health
python -m ethics --health-check

# Validate configuration
python -m ethics --validate-config

# Test connections
python -m ethics --test-connections

# Generate diagnostic report
python -m ethics --diagnostic-report
```
