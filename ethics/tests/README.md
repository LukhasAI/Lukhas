...
This directory contains the test suite for the ethics module.
...
- **`test_ethics_unit.py`** - Unit tests for individual components
- **`test_ethics_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=ethics --cov-report=html
```
