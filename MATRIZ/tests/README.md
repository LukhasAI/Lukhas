...
- **`test_matriz_unit.py`** - Unit tests for individual components
- **`test_matriz_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=matriz --cov-report=html
```
