...
- **Uniform contracts:** Skill Capsules emit `node_out` that validates against `matriz_node_v1.json` (schema v1.1).
...
- **Schema:** `matriz_node_v1.json` (v1.1) is the only canonical format.
