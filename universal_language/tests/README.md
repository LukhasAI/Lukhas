...
- **`test_universal_language_unit.py`** - Unit tests for individual components
- **`test_universal_language_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=universal_language --cov-report=html
```
