...
# Universal_Language Troubleshooting Guide
...
2. Validate configuration: `python -c "import universal_language; print('OK')"`
3. Review logs in `logs/universal_language.log`
...
```bash
# Check module health
python -m universal_language --health-check

# Validate configuration
python -m universal_language --validate-config

# Test connections
python -m universal_language --test-connections

# Generate diagnostic report
python -m universal_language --diagnostic-report
```
