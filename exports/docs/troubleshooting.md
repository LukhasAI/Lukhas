...
2. Validate configuration: `python -c "import exports; print('OK')"`
3. Review logs in `logs/exports.log`
...
```bash
# Check module health
python -m exports --health-check

# Validate configuration
python -m exports --validate-config

# Test connections
python -m exports --test-connections

# Generate diagnostic report
python -m exports --diagnostic-report
```
