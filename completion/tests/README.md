...
- **`test_completion_unit.py`** - Unit tests for individual components
- **`test_completion_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=completion --cov-report=html
```
