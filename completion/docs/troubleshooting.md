...
2. Validate configuration: `python -c "import completion; print('OK')"`
3. Review logs in `logs/completion.log`
...
```bash
# Check module health
python -m completion --health-check

# Validate configuration
python -m completion --validate-config

# Test connections
python -m completion --test-connections

# Generate diagnostic report
python -m completion --diagnostic-report
```
