...
async def test_tool_integration():
    ...
    if not has_api_key:
        print("⚠️  No OpenAI API key found. Set OPENAI_API_KEY to test actual API calls.")
    ...
    print(f"   - Expected: GPT can use retrieval and browser tools only")
...
def main():
    ...
    try:
        # Run async tests
        test_params = asyncio.run(test_tool_integration())
        ...
        print("\n🚀 Next Steps:")
        print("1. Start the API server: python -m lukhas_pwm.api.app")
