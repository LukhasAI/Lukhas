...
This directory contains the test suite for the health_reports module.
...
- **`test_health_reports_unit.py`** - Unit tests for individual components
- **`test_health_reports_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=health_reports --cov-report=html
```
