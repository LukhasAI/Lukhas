# Health_Reports Troubleshooting Guide
...
2. Validate configuration: `python -c "import health_reports; print('OK')"`
3. Review logs in `logs/health_reports.log`
...
```bash
# Check module health
python -m health_reports --health-check

# Validate configuration
python -m health_reports --validate-config

# Test connections
python -m health_reports --test-connections

# Generate diagnostic report
python -m health_reports --diagnostic-report
```
