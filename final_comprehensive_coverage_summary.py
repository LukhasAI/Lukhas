...
def generate_final_coverage_summary():
    ...
    total_meaningful_coverage = comprehensive_systems_covered + (partial_systems_covered * 0.75)  # Weight partial coverage
    ...
    summary = {
        ...
        "coverage_progression": {
            ...
            "priority_1_2": {
                ...
                "systems_covered": priority_1_2_coverage["systems_with_full_coverage"] + priority_1_2_coverage["systems_with_partial_coverage"],
...
def save_and_display_summary():
    ...
    for phase, data in progression.items():
        print(f"  {phase.replace('_', ' ').title()}: {data['coverage_percentage']}% "
