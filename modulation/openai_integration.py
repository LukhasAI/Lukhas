...
class ModulatedOpenAIClient:
    ...
    def create_completion(self, user_message: str, signals: List[Signal], 
    ...
    def _build_messages(self, user_message: str, context_snippets: Optional[List[str]], 
                       params: ModulationParams) -> List[Dict[str, str]]:
        ...
        messages.append({
            "role": "user", 
            "content": user_prefix + user_message
        })
        ...
        "search": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "domain": {
                        "type": "string", 
                        "enum": ["consciousness", "memory", "identity", "ethics", "bio", "quantum"],
