# Modulation Troubleshooting Guide
...
2. Validate configuration: `python -c "import modulation; print('OK')"`
3. Review logs in `logs/modulation.log`
...
```bash
# Check module health
python -m modulation --health-check

# Validate configuration
python -m modulation --validate-config

# Test connections
python -m modulation --test-connections

# Generate diagnostic report
python -m modulation --diagnostic-report
```
