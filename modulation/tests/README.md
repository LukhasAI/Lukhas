...
- **`test_modulation_unit.py`** - Unit tests for individual components
- **`test_modulation_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=modulation --cov-report=html
```
