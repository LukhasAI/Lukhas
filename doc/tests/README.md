...
This directory contains the test suite for the doc module.
...
- **`test_doc_unit.py`** - Unit tests for individual components
- **`test_doc_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=doc --cov-report=html
```
