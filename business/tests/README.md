...
This directory contains the test suite for the business module.
...
- **`test_business_unit.py`** - Unit tests for individual components
- **`test_business_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=business --cov-report=html
```
