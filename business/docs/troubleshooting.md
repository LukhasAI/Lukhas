...
2. Validate configuration: `python -c "import business; print('OK')"`
3. Review logs in `logs/business.log`
...
```bash
# Check module health
python -m business --health-check

# Validate configuration
python -m business --validate-config

# Test connections
python -m business --test-connections

# Generate diagnostic report
python -m business --diagnostic-report
```
