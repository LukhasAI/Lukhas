...
2. Validate configuration: `python -c "import healing; print('OK')"`
3. Review logs in `logs/healing.log`
...
```bash
# Check module health
python -m healing --health-check

# Validate configuration
python -m healing --validate-config

# Test connections
python -m healing --test-connections

# Generate diagnostic report
python -m healing --diagnostic-report
```
