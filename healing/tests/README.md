...
- **`test_healing_unit.py`** - Unit tests for individual components
- **`test_healing_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=healing --cov-report=html
```
