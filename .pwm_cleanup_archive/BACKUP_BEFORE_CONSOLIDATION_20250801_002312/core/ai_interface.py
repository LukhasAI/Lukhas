...
from typing import (  # Dict, Any, List not in signatures, but good for context
    Optional,
)
...
class LukhusAI:
    ...
    def generate_response(
        ...
        """
        self.instance_logger.info(
            f"ΛTRACE: generate_response called. TaskType: {task_type.value}, Debug: {debug}, Prompt (first 50): '{prompt[:50]}...'"
        )
