...
_ENTITY_REGISTRY = {
    ...
    "DecisionAuditLevel": (
        "audit.audit_decision_embedding_engine",
        "DecisionAuditLevel",
    ),
    ...
    "ConsciousnessQuantumBridge": (
        "bridges.consciousness_quantum_bridge",
        "ConsciousnessQuantumBridge",
    ),
    "CoreConsciousnessBridge": (
        "bridges.core_consciousness_bridge",
        "CoreConsciousnessBridge",
    ),
    ...
    "MemoryConsciousnessBridge": (
        "bridges.memory_consciousness_bridge",
        "MemoryConsciousnessBridge",
    ),
    ...
    "OrchestrationCoreBridge": (
        "bridges.orchestration_core_bridge",
        "OrchestrationCoreBridge",
    ),
    ...
    "NIASDeliveryLoop": (
        "interfaces.as_agent.sys.nias.delivery_loop",
        "NIASDeliveryLoop",
    ),
    ...
    "SystemIntegrationStatus": (
        "meta_learning.enhancement_system",
        "SystemIntegrationStatus",
    ),
    ...
    "MetaLearningMonitorDashboard": (
        "meta_learning.monitor_dashboard",
        "MetaLearningMonitorDashboard",
    ),
    ...
    "AdvancedMemoryManager": (
        "meta_learning.remediator_agent",
        "AdvancedMemoryManager",
    ),
    ...
    "NeuralArchitectureType": (
        "neural_architectures.neural_integrator",
        "NeuralArchitectureType",
    ),
    ...
    "EnergyAwareExecutionPlanner": (
        "orchestration.energy_aware_execution_planner",
        "EnergyAwareExecutionPlanner",
    ),
    ...
    "FederatedLearningManager": (
        "personality.creative_personality",
        "FederatedLearningManager",
    ),
    ...
    "MetaLearningSystem": (
        "personality.creative_personality_clean",
        "MetaLearningSystem",
    ),
    "FederatedLearningManager": (
        "personality.creative_personality_clean",
    ...
    "PreventiveIntervention": (
        "safety.predictive_harm_prevention",
        "PreventiveIntervention",
    ),
    ...
    "LukhasIntegrationOrchestrator": (
        "spine.integration_orchestrator",
        "LukhasIntegrationOrchestrator",
    ),
    ...
    "TraceRepairEngine": (
        "symbolic_diagnostics.trace_repair_engine",
        "TraceRepairEngine",
    ),
...
_FUNCTION_REGISTRY = {
    ...
    "get_memory_learning_bridge": (
        "bridges.memory_learning_bridge",
        "get_memory_learning_bridge",
    ),
    ...
    "get_nias_dream_bridge": (
        "integrations.nias_dream_bridge",
        "get_nias_dream_bridge",
    ),
    ...
    "get_user_preferences": (
        "interfaces.as_agent.auth.registry",
        "get_user_preferences",
    ),
    ...
    "pair_with_vendor": (
        "interfaces.as_agent.auth.vendor_hospitality_sync",
        "pair_with_vendor",
    ),
    "generate_symbolic_image": (
        "interfaces.as_agent.core.generate_image",
        "generate_symbolic_image",
    ),
    ...
    "log_referral_click": (
        "interfaces.as_agent.news_and_social.affiliate_log",
        "log_referral_click",
    ),
    "load_pending_posts": (
        "interfaces.as_agent.news_and_social.s_dispatcher",
        "load_pending_posts",
    ),
    "simulate_publish": (
        "interfaces.as_agent.news_and_social.s_dispatcher",
    ...
    "aggregate_dast_tags": (
        "interfaces.as_agent.sys.dast.aggregator",
        "aggregate_dast_tags",
    ),
    ...
    "handle_dream_summary": (
        "interfaces.as_agent.sys.dast.dast",
        "handle_dream_summary",
    ),
    ...
    "receive_partner_input": (
        "interfaces.as_agent.sys.dast.partner_sdk",
        "receive_partner_input",
    ),
    "receive_partner_input": (
        "interfaces.as_agent.sys.dast.partner_sdk",
    ...
    "is_time_to_deliver": (
        "interfaces.as_agent.sys.dast.schedule_manager",
        "is_time_to_deliver",
    ),
    "save_tags_to_file": ("interfaces.as_agent.sys.dast.store", "save_tags_to_file"),
    "load_tags_from_file": (
        "interfaces.as_agent.sys.dast.store",
        "load_tags_from_file",
    ),
    "save_tags_to_file": ("interfaces.as_agent.sys.dast.store", "save_tags_to_file"),
    "load_tags_from_file": (
    ...
    "extract_narratable_dreams": (
        "interfaces.as_agent.sys.nias.dream_narrator_queue",
        "extract_narratable_dreams",
    ),
    "record_dream_message": (
        "interfaces.as_agent.sys.nias.dream_recorder",
        "record_dream_message",
    ),
    "view_feedback": (
        "interfaces.as_agent.sys.nias.feedback_log_viewer",
        "view_feedback",
    ),
    "record_feedback": (
        "interfaces.as_agent.sys.nias.feedback_loop",
        "record_feedback",
    ),
    "generate_payload": (
        "interfaces.as_agent.sys.nias.generate_payload_cli",
        "generate_payload",
    ),
    "load_user_settings": (
    ...
    "push_symbolic_message": (
        "interfaces.as_agent.sys.nias.nias_core",
        "push_symbolic_message",
    ),
    "load_replay_data": (
        "interfaces.as_agent.sys.nias.replay_heatmap",
        "load_replay_data",
    ),
    "plot_heatmap": ("interfaces.as_agent.sys.nias.replay_heatmap", "plot_heatmap"),
    "color_emotion": (
        "interfaces.as_agent.sys.nias.replay_visualizer",
        "color_emotion",
    ),
    "visualize_replays": (
        "interfaces.as_agent.sys.nias.replay_visualizer",
    ...
    "match_message_to_context": (
        "interfaces.as_agent.sys.nias.symbolic_matcher",
        "match_message_to_context",
    ),
    ...
    "validate_payload": (
        "interfaces.as_agent.sys.nias.validate_payload",
        "validate_payload",
    ),
    ...
    "summarize_emotion_vector": (
        "interfaces.as_agent.utils.symbolic_utils",
        "summarize_emotion_vector",
    ),
    "create_delivery_widget": (
        "interfaces.as_agent.widgets.delivery_tracker_widget",
        "create_delivery_widget",
    ),
    ...
    "render_widget_preview": (
        "interfaces.as_agent.widgets.live_renderer_widget",
        "render_widget_preview",
    ),
    "render_terminal_widget": (
        "interfaces.as_agent.widgets.terminal_widget",
        "render_terminal_widget",
    ),
    "show_dst_status": (
        "interfaces.as_agent.widgets.terminal_widget",
    ...
    "suggest_travel_action": (
        "interfaces.as_agent.widgets.travel_widget",
        "suggest_travel_action",
    ),
    ...
    "render_widget_preview": (
        "interfaces.as_agent.widgets.widget_archive",
        "render_widget_preview",
    ),
    ...
    "initialize_agent": (
        "interfaces.logic.agent_logic_architecture",
        "initialize_agent",
    ),
    ...
    "build_user_context": (
        "interfaces.logic.context.context_builder",
        "build_user_context",
    ),
    ...
    "generate_nias_documentation": (
        "interfaces.nias.generate_nias_docs",
        "generate_nias_documentation",
    ),
    ...
    "log_session_end": (
        "interfaces.tools.research.research_dashboard",
        "log_session_end",
    ),
    "is_access_allowed": (
        "interfaces.tools.security.session_logger",
        "is_access_allowed",
    ),
    "log_session_event": (
        "interfaces.tools.security.session_logger",
    ...
    "generate_filename": (
        "interfaces.ui.components.audio_exporter",
        "generate_filename",
    ),
    ...
    "set_user_preference": (
        "interfaces.ui.config.dashboard_settings",
        "set_user_preference",
    ),
    "get_user_preference": (
        "interfaces.ui.config.dashboard_settings",
    ...
    "get_nias_openai_adapter": (
        "modules.nias.openai_adapter",
        "get_nias_openai_adapter",
    ),
    "integrate_collapse_tracking": (
        "monitoring.collapse_integration",
        "integrate_collapse_tracking",
    ),
    ...
    "load_inspiration_profile": (
        "personality.creative_expressions",
        "load_inspiration_profile",
    ),
