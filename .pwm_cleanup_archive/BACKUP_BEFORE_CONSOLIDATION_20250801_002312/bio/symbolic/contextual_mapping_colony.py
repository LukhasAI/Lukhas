...
class ContextualMappingColony(BaseColony):
    ...
    def _initialize_fuzzy_boundaries(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "ΛPOWER_ABUNDANT": {"center": 0.9, "width": 0.15, "type": "gaussian"},
            "ΛPOWER_BALANCED": {"center": 0.7, "width": 0.2, "type": "gaussian"},
            "ΛPOWER_CONSERVE": {"center": 0.5, "width": 0.2, "type": "gaussian"},
            "ΛPOWER_CRITICAL": {"center": 0.2, "width": 0.15, "type": "gaussian"},
            # Stress GLYPHs with sigmoid membership
            "ΛSTRESS_TRANSFORM": {"threshold": 0.8, "slope": 10, "type": "sigmoid"},
            "ΛSTRESS_ADAPT": {"center": 0.6, "width": 0.3, "type": "gaussian"},
            "ΛSTRESS_BUFFER": {"center": 0.4, "width": 0.2, "type": "gaussian"},
            "ΛSTRESS_FLOW": {"threshold": 0.3, "slope": -10, "type": "sigmoid"},
