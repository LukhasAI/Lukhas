...
2. Validate configuration: `python -c "import assets; print('OK')"`
3. Review logs in `logs/assets.log`
...
```bash
# Check module health
python -m assets --health-check

# Validate configuration
python -m assets --validate-config

# Test connections
python -m assets --test-connections

# Generate diagnostic report
python -m assets --diagnostic-report
```
