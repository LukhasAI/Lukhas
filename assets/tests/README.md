...
- **`test_assets_unit.py`** - Unit tests for individual components
- **`test_assets_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=assets --cov-report=html
```
