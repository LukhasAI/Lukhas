...
2. Validate configuration: `python -c "import TODO; print('OK')"`
3. Review logs in `logs/TODO.log`
...
```bash
# Check module health
python -m TODO --health-check

# Validate configuration
python -m TODO --validate-config

# Test connections
python -m TODO --test-connections

# Generate diagnostic report
python -m TODO --diagnostic-report
```
