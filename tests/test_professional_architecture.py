...
╚══════════════════════════════════════════════════════════════╝
    ...
    if consciousness:
        ...
        logger.info(
            f"  ✓ Awareness processed: delta={awareness.get('awareness_delta', 0)}"
        )
    ...
    if emotion:
        ...
        logger.info(
            f"  ✓ Emotion analyzed: V={vad.get('valence', 0.5):.2f}, "
    ...
    logger.info(f"  - Event types: { {e.event_type for e in events_received} }")
