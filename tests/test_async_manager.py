...
class TestConsciousnessTaskManager:
    ...
    async def test_graceful_shutdown(self, task_manager):
        ...
        assert all("cancelled_" in result or "completed_" in result 
...
class TestGlobalManagers:
    ...
    async def test_shutdown_all_managers(self):
        ...
        task1 = consciousness_mgr.create_task(
            asyncio.sleep(1),
            name="long_consciousness_task",
            component="test"
        )
        task2 = orchestration_mgr.create_task(
            asyncio.sleep(1),
            name="long_orchestration_task", 
            component="test"
        )
