...
from core.api.service_stubs import (
    SymbolicEngine, UnifiedConsciousness, MemoryManager,
    GuardianSystem, EmotionEngine, DreamEngine, CoordinationManager
)
...
class TestEnhancedAPI:
    ...
    async def api_system(self):
        ...
        # Initialize stubs
        for service in [system.symbolic_engine, system.consciousness, 
                       system.memory, system.guardian, system.emotion,
                       system.dream, system.coordination]:
            await service.initialize()
            
        # Mock security
        system.security = AsyncMock()
        system.security.validate_request = AsyncMock(return_value=(True, None))
        system.security.create_secure_session = AsyncMock(return_value={
    ...
    async def test_capabilities_endpoint(self, api_system):
        ...
        expected_modules = ['consciousness', 'memory', 'guardian', 
                          'emotion', 'dream', 'symbolic']
