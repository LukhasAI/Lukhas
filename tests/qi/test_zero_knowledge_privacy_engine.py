...
async def test_adaptive_proof_prefers_zksnark_for_small_circuits():
    ...
    statement = PrivacyStatement(public_input={"balance": 42}, requires_non_interactive=True, circuit_size=512)
...
async def test_verify_private_computation_matches_expected_hash():
    engine = ZeroKnowledgePrivacyEngine()
    statement = PrivacyStatement(public_input={"balance": 7}, requires_non_interactive=False, circuit_size=4096)
