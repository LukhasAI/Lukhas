...
2. Validate configuration: `python -c "import tests; print('OK')"`
3. Review logs in `logs/tests.log`
...
```bash
# Check module health
python -m tests --health-check

# Validate configuration
python -m tests --validate-config

# Test connections
python -m tests --test-connections

# Generate diagnostic report
python -m tests --diagnostic-report
```
