...
# This is a mock for the _bridgeutils module, which is not available in the test environment.
# This allows the tests to run without raising a ModuleNotFoundError.
class MockBridgeUtils:
    def bridge_from_candidates(self, *args, **kwargs):
        return (mock.MagicMock(), mock.MagicMock())

import sys
sys.modules['_bridgeutils'] = MockBridgeUtils()
