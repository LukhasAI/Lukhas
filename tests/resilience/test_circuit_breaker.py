...
from resilience.circuit_breaker import (
    CircuitBreaker, CircuitBreakerConfig, CircuitState, FailurePattern,
    CallResult, CircuitBreakerStats, DefaultFailureDetector,
    AdaptiveThresholdCalculator, CircuitBreakerOpenError,
    CircuitBreakerRegistry, circuit_breaker, RestartServiceAction
)
...
class TestRestartServiceAction:
    ...
    def test_can_handle_unhealthy_service(self):
        ...
        from monitoring.health_system import ComponentHealth, HealthStatus, ComponentType
