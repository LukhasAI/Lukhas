...
from labs.consciousness.guardian_integration import (
...
class TestConsciousnessGuardianIntegration:
    ...
    def guardian_integration(self, guardian_config, mock_guardian_system, mock_ethics_engine):
        ...
        with patch('labs.consciousness.guardian_integration.GUARDIAN_AVAILABLE', True):
            with patch('labs.consciousness.guardian_integration.GuardianSystem', return_value=mock_guardian_system):
                with patch('labs.consciousness.guardian_integration.EthicsEngine', return_value=mock_ethics_engine):
