...
**Canary tests for simulation lane: ethics gates, consent checks, feature flags, and adapter isolation**
...
```bash
# Run module tests
pytest /Users/agi_dev/LOCAL-REPOS/Lukhas/tests/consciousness/simulation/tests/ -v

# Run with coverage
pytest /Users/agi_dev/LOCAL-REPOS/Lukhas/tests/consciousness/simulation/tests/ --cov=simulation --cov-report=html
```
