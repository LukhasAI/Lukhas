...
class TestCoreSystemIntegration:
    ...
    def setup_dependency_injection(self):
        ...
        from core.interfaces.dependency_injection import clear_registry, register_service
        ...
        mock_memory = Mock()
        mock_memory.store = AsyncMock(return_value={"status": "stored", "id": "test_memory_001"})
        mock_memory.retrieve = AsyncMock(return_value={"data": "test_data", "metadata": {}})
        
        mock_consciousness = Mock()
        mock_consciousness.process = AsyncMock(return_value={"awareness_level": 0.8, "decision": "proceed"})
        
        mock_guardian = Mock()
        mock_guardian.validate = AsyncMock(return_value={"approved": True, "risk_level": "low"})
    ...
    async def test_memory_consciousness_integration(self, setup_dependency_injection):
        ...
        test_data = {"input": "test decision scenario", "context": "integration_test"}
...
class TestCriticalSystemPaths:
    ...
    async def test_memory_storage_retrieval_path(self):
        ...
        with patch('core.interfaces.dependency_injection.get_service') as mock_get_service:
            ...
            mock_memory.store.return_value = {"id": "mem_001", "status": "stored"}
            mock_memory.retrieve.return_value = {"data": "test_data", "timestamp": "2025-08-03"}
    ...
    def test_module_imports_critical_path(self):
        ...
        assert success_rate >= 0.8, f"Only {success_rate:.1%} of critical modules imported successfully. Failed: {failed_modules}"
...
class TestErrorHandlingPaths:
    ...
    async def test_dependency_injection_fallback(self):
        ...
        from core.interfaces.dependency_injection import get_service, clear_registry
