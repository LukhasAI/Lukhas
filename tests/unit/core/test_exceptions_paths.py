...
def test_exception_none_handling():
    ...
    err = ResourceExhaustedError(message="Test error", resource_type="lukhas.memory", current_usage=None, limit=100.0)
    assert err.details["usage_percentage"] == 100

    # Test with valid values
    err2 = ResourceExhaustedError(message="Test error", resource_type="lukhas.memory", current_usage=50.0, limit=100.0)
