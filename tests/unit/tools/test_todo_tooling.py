...
def test_categorize_todos_prioritizes_keywords() -> None:
    sample_lines = [
        "candidate/security/auth.py:10:# TODO: Fix security vulnerability immediately",
...
def test_generate_priority_files_creates_markdown(tmp_path: Path) -> None:
    record = categorize.TODORecord(
        ...
        priority="HIGH",
        raw="candidate/core/module.py:12:# TODO: Implement identity verification for guardian compliance",
    )
