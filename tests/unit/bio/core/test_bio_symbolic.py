...
class TestBioSymbolic:
    ...
    @pytest.mark.parametrize("frequency, expected_glyph", [
    ...
    @pytest.mark.parametrize("level, expected_glyph", [
    ...
    @pytest.mark.parametrize("operation, expected_glyph", [
    ...
    @pytest.mark.parametrize("response_type, expected_glyph", [
    ...
    @pytest.mark.parametrize("balance, expected_glyph", [
    ...
    @pytest.mark.parametrize("phase, expected_glyph", [
    ...
    @pytest.mark.parametrize("data, expected_coherence", [
