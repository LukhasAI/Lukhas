...
class TestAnomalyDetection:
    ...
    async def test_thermal_stress_detection(self, detector):
        ...
        thermal_anomalies = [a for a in anomalies if 'thermal' in a.anomaly_type]
    ...
    async def test_motion_distress_detection(self, detector):
        ...
        for i in range(10):
            ...
            erratic = np.sin(np.linspace(0, 20*np.pi, 512)) * (1 + np.random.randn(512) * 0.5)
...
class TestSensoryIntegration:
    ...
    async def test_multimodal_fusion(self):
        ...
        vectors.append(PerceptualVector(
...
class TestIntegration:
    ...
    async def test_real_world_scenario(self):
        ...
        morning_anomalies = await evrn.detect_anomalies(
            morning_vectors,
            context={'routine_check': 'morning'}
        )
