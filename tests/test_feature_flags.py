...
from lukhas_pwm.flags import get_flags, is_enabled, when_enabled, require_feature
...
def test_default_flags():
    ...
    # Check some defaults
    assert flags.is_enabled("tool_governance") == True
    assert flags.is_enabled("dna_helix_memory") == False
    assert flags.is_enabled("auto_safety_tightening") == True
...
def test_override():
    ...
    assert flags.is_enabled("dna_helix_memory") == True
...
def test_env_override():
    ...
    assert flags.is_enabled("quantum_processing") == True
...
def test_require_feature():
    ...
    try:
        ...
        assert False, "Should not raise for enabled feature"
