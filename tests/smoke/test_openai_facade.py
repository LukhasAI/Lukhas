...
def test_responses_minimal():
    ...
    r = client.post("/v1/responses", json=payload, headers={"Authorization": "Bearer sk-lukhas-test-1234567890abcdef"})
...
def test_models_list():
    client = TestClient(get_app())
    r = client.get("/v1/models", headers={"Authorization": "Bearer sk-lukhas-test-1234567890abcdef"})
    assert r.status_code == 200
