...
class TestDriftManager:
    ...
    def test_threshold_exceedance(self):
        ...
        threshold_events = [e for e in manager.drift_ledger if e.get("event") == "threshold_exceeded"]
        ...
        repair_events = [e for e in manager.drift_ledger if e.get("event", "").startswith("auto_repair")]
    ...
    def test_drift_history(self):
        ...
        states = [{"compliance": 0.9 + i * 0.01, "drift_score": 0.1 + i * 0.01} for i in range(5)]
...
class TestIntegrityProbeIntegration:
    ...
    def test_integrity_probe_drift_consumption(self):
        ...
        state = {"ethical": {"compliance": 0.9}, "memory": {"fold_count": 500}, "identity": {"coherence": 0.95}}
        ...
        state2 = {"ethical": {"compliance": 0.85}, "memory": {"fold_count": 520}, "identity": {"coherence": 0.93}}
