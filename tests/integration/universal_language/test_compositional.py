...
def _load_module(module_name: str, rel_path: str):
    root = Path(__file__).resolve().parents[3]  # Go up to repo root, not tests/
...
comp_mod = _load_module("ul_compositional", "products/experience/universal_language/core/compositional.py")
