...
class TestTop25HiddenGemsIntegration:
    ...
    def test_all_schemas_exist(self):
        ...
        schemas = ['matriz/consciousness/reflection/id_reasoning_engine.schema.json', 'matriz/consciousness/reflection/swarm.schema.json', 'matriz/consciousness/reflection/orchestration_service.schema.json', 'matriz/consciousness/reflection/memory_hub.schema.json', 'matriz/consciousness/reflection/dreamseed_unified.schema.json', 'matriz/consciousness/reflection/reflection_layer.schema.json', 'matriz/consciousness/reflection/symbolic_drift_analyzer.schema.json', 'matriz/consciousness/reflection/integrated_safety_system.schema.json', 'matriz/consciousness/cognitive/adapter.schema.json', 'matriz/consciousness/core/engine_poetic.schema.json', 'matriz/memory/core/unified_memory_orchestrator.schema.json', 'matriz/memory/temporal/hyperspace_dream_simulator.schema.json', 'matriz/orchestration/async_orchestrator.schema.json', 'core/governance/guardian_system_integration.schema.json', 'core/governance/consent_ledger/ledger_v1.schema.json', 'core/glyph/glyph_memory_integration.schema.json', 'core/integration/executive_decision_integrator.schema.json', 'core/symbolic/vocabulary_creativity_engine.schema.json', 'core/orchestration/gpt_colony_orchestrator.schema.json', 'core/bridge/dream_commerce.schema.json', 'core/consciousness/id_reasoning_engine.schema.json', 'core/oracle_nervous_system.schema.json', 'core/api/service_stubs.schema.json', 'core/verifold/verifold_unified.schema.json', 'core/colonies/oracle_colony.schema.json', 'core/identity/constitutional_ai_compliance.schema.json', 'core/audit/audit_decision_embedding_engine.schema.json']
    ...
    def test_performance_requirements_defined(self):
        ...
        schemas_to_check = ['core/governance/guardian_system_integration.schema.json', 'matriz/consciousness/reflection/swarm.schema.json', 'core/audit/audit_decision_embedding_engine.schema.json']
        for schema_rel_path in schemas_to_check:
            ...
            with open(schema_path) as f:
                ...
                assert schema['performance']['max_latency_ms'] <= 10000
    ...
    def test_all_modules_importable_smoke(self):
        ...
        modules = ['matriz.consciousness.reflection.id_reasoning_engine', 'matriz.consciousness.reflection.swarm', 'matriz.consciousness.reflection.orchestration_service', 'matriz.consciousness.reflection.memory_hub', 'matriz.consciousness.reflection.dreamseed_unified', 'matriz.consciousness.reflection.reflection_layer', 'matriz.consciousness.reflection.symbolic_drift_analyzer', 'matriz.consciousness.reflection.integrated_safety_system', 'matriz.consciousness.cognitive.adapter', 'matriz.consciousness.core.engine_poetic', 'matriz.orchestration.async_orchestrator', 'matriz.memory.core.unified_memory_orchestrator', 'matriz.memory.temporal.hyperspace_dream_simulator', 'core.governance.guardian_system_integration', 'core.governance.consent_ledger.ledger_v1', 'core.glyph.glyph_memory_integration', 'core.integration.executive_decision_integrator', 'core.symbolic.vocabulary_creativity_engine', 'core.orchestration.gpt_colony_orchestrator', 'core.bridge.dream_commerce', 'core.consciousness.id_reasoning_engine', 'core.oracle_nervous_system', 'core.api.service_stubs', 'core.verifold.verifold_unified', 'core.colonies.oracle_colony', 'core.identity.constitutional_ai_compliance', 'core.audit.audit_decision_embedding_engine']
        import_count = 0
        failed_imports = []
