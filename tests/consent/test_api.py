...
from consent.api import router, ConsentService, get_consent_service
...
def test_grant_consent():
    ...
    mock_service.grant_consent.return_value = ("grant_id", {"token": "test_token", "expires_at": "2025-01-01T00:00:00Z", "scopes": ["email.read.headers"], "caveats": {}})
    ...
    response = client.post("/consent/grant", json={
        "lid": "gonzo",
        "service": "gmail",
