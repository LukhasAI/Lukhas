...
This directory contains the test suite for the mcp-server module.
...
- **`test_mcp-server_unit.py`** - Unit tests for individual components
- **`test_mcp-server_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=mcp-server --cov-report=html
```
