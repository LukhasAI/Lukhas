...
2. Validate configuration: `python -c "import tools; print('OK')"`
3. Review logs in `logs/tools.log`
...
```bash
# Check module health
python -m tools --health-check

# Validate configuration
python -m tools --validate-config

# Test connections
python -m tools --test-connections

# Generate diagnostic report
python -m tools --diagnostic-report
```
