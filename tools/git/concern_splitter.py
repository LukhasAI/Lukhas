...
"""
    ...
    def create_concern_branches_and_prs(self, groups: Dict[str, ConcernGroup], base_branch: str = "main") -> Dict[str, Dict]:
...
def main():
    ...
    parser.add_argument("--base", default="HEAD~1", 
                       help="Base reference for git diff (default: HEAD~1)")
    parser.add_argument("--analyze-only", action="store_true",
                       help="Only analyze, don't create branches")
