...
def generate_system_report() -> Dict[str, Any]:
    ...
    env_vars = ["OPENAI_API_KEY", "ANTHROPIC_API_KEY", "PERPLEXITY_API_KEY", "GOOGLE_API_KEY"]
    for var in env_vars:
    ...
    # Check missing files
    missing_files = [name for name, data in report["file_system"].items() 
