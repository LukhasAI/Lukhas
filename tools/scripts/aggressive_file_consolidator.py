...
class AggressiveFileConsolidator:
    def __init__(self):
        ...
        with open('docs/planning/PWM_AGGRESSIVE_CONSOLIDATION_PLAN.json', 'r') as f:
    ...
    def analyze_file(self, filepath):
        ...
        try:
            ...
            if module_scores:
                ...
                best_submodule = submodule_assignment.get(best_module, 
                                list(self.submodule_keywords[best_module].keys())[0])
    ...
    def consolidate_files(self):
        ...
        for root, dirs, files in os.walk('.'):
            ...
            if any(skip in root for skip in ['.git', '__pycache__', '.venv', 'quarantine', '.pwm_cleanup_archive']):
                continue
