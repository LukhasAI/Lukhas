...
class RootDirectoryCleaner:
    def __init__(self):
        ...
        self.directory_map = {
            ...
            'docs/reports/analysis/': ['*_REPORT.json', '*_ANALYSIS.json', '*_report.json'],
            'docs/planning/': ['*_PLAN.md', '*_ROADMAP.md'],
            'tools/analysis/': ['PWM_*.py', '*_analyzer.py', '*_finder.py'],
            'tools/scripts/': ['*_consolidator.py', 'bootstrap.py', 'health_monitor.py'],
            'tests/': ['test_*.py'],
...
def main():
    ...
    print(f"  - Report saved: docs/reports/status/ROOT_CLEANUP_REPORT.md")
