...
class TrackBadgeGenerator:
    ...
    def analyze_contract(self, contract_path: str) -> Dict[str, Any]:
        ...
        return {"module": module, "contract_path": contract_path, "tracks": tracks, "gates": contract.get("gates", [])}
...
def main():
    ...
    parser.add_argument("--no-update", action="store_true", help="Generate report only, don't update READMEs")
