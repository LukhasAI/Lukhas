...
class MatrixTestGenerator:
    ...
    TIER_MAPPING: ClassVar[dict[str, object]] = {  # TODO[T4-ISSUE]: {"code":"RUF012","ticket":"GH-1031","owner":"consciousness-team","status":"planned","reason":"Mutable class attribute needs ClassVar annotation for type safety","estimate":"15m","priority":"medium","dependencies":"typing imports","id":"_Users_agi_dev_LOCAL_REPOS_Lukhas_tools_matrix_test_generator_py_L24"}
        'guest': 0,
        'visitor': 1,
        'friend': 2,
        'trusted': 3,
            ...
            for function in functions:
                ...
                test_case = {
                    ...
                    'input': {
                        ...
                        'env': {
                            'mfa': False,
                            'webauthn_verified': webauthn_required
                        }
                    },
                    'expected': is_allowed,
