...
"""
    ...
    def _generate_tags(self, decision: Decision, template: str) -> List[str]:
        ...
        keywords = ["refactor", "feature", "bug", "architecture", "api", "ui", "performance", "security"]
...
"""
    ...
    def suggest_decision_improvements(self) -> List[str]:
        ...
        if analysis["potentially_rushed"]:
            suggestions.append(f"Review these potentially rushed decisions: {', '.join(analysis['potentially_rushed'][:3])}")
...
if __name__ == "__main__":
    ...
    quick = tracker.quick_decision("Add decision tracking to journal system because we need to remember why we made choices")
