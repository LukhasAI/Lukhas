...
class HardcodedSecretsFixer:
    ...
    def _scan_file(self, file_path: Path):
        ...
        try:
            ...
            for line_num, line in enumerate(lines, 1):
                ...
                # Skip enum definitions (lines that look like: FIELD_NAME = "field_value")
                ...
                for pattern, secret_type in self.secret_patterns:
                    ...
                    if match:
                        ...
                        if any(placeholder in secret_value.lower() for placeholder in 
                               ['your', 'placeholder', 'test', 'mock', 'fake', 'dummy', 'example']):
                            continue
                        ...
                        issue = SecurityIssue(
                            ...
                            severity="HIGH",
                            suggested_fix=self._generate_fix_suggestion(secret_type, line)
                        )
    ...
    def _apply_fix_to_line(self, original_line: str, issue: SecurityIssue) -> str:
        ...
        import_line = "from governance.security.secret_manager import get_secret\n"
...
def main():
    ...
    # Save report
    report_path = Path("/Users/agi_dev/Lukhas_PWM/docs/reports/HARDCODED_SECRETS_AUDIT.md")
