...
class MatrixTestRunner:
    ...
    def load_contract(self, module: str) -> Dict[str, Any]:
        ...
        contract_patterns = [f"matrix_{module.replace('.', '_')}.json", f"matrix_{module}.json"]
    ...
    def run_test_case(self, test_case: Dict[str, Any], contract: Dict[str, Any]) -> Dict[str, Any]:
        ...
        input_data = {
            ...
            "env": {"mfa": test_case.get("mfa", False), "webauthn_verified": test_case.get("webauthn", True)},
        }
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Authorization Matrix Test Runner", formatter_class=argparse.RawDescriptionHelpFormatter
    )

    parser.add_argument("--fixtures", type=str, help="Directory containing test fixtures")
    parser.add_argument("--output", type=str, help="Output file for JSON results")
    parser.add_argument("--min-pass-rate", type=float, default=0.95, help="Minimum pass rate threshold (default: 0.95)")
