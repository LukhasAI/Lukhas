...
class OwnershipAssigner:
    ...
    def update_ownership(self, assignments: dict[str, str]) -> None:
            ...
            try:
                ...
                if module_name in assignments:
                    ...
                    if current_owner != new_owner:
                        ...
                        print(f"Updated {schema_file.name}: {current_owner} → {new_owner}")
                        updated_count += 1
        ...
        print(f"\n✅ Updated ownership for {updated_count} modules")
...
def main():
    ...
    print("🚀 LUKHAS Module Ownership Assignment Tool")
