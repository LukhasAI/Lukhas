...
def generate_vocabulary_aware_readme(module_path: Path, vocab_loader: ModuleVocabularyLoader) -> str:
    ...
    if entrypoints:
        readme_lines.append(
            f" It provides {len(entrypoints)} consciousness-aligned interfaces for seamless integration with the LUKHAS ecosystem."
        )
    ...
    readme_lines.append(
        f"*Generated with {vocab_note}consciousness-aware documentation systems, following LUKHAS 3-Layer Tone System and Constellation Framework principles.*"
    )
