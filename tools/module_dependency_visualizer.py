...
class DependencyVisualizer:
    ...
    def generate_dot_graph(self, output_file: Path, focus_module: str = None) -> None:
        ...
        layer_colors = {
            'foundational': '#FF6B6B',      # Red - Foundation
            'infrastructure': '#4ECDC4',    # Teal - Infrastructure  
            'application': '#45B7D1',       # Blue - Application
        ...
        for lane, modules in lanes.items():
            ...
            for module_name in modules:
                if module_name in self.modules:
                    ...
                    dot_content.append(f'      style="rounded,filled"')
    ...
    def generate_mermaid_diagram(self, output_file: Path, focus_module: str = None) -> None:
...
def main():
    ...
    parser.add_argument("--format", choices=["dot", "mermaid", "html", "summary", "all"], 
