{
  ...
  "properties": {
    ...
    "observability": {
      ...
      "additionalProperties": false,  # noqa: F821  # TODO: false
      "properties": {
        "required_spans": { "type": "array", "items": { "type": "string" }, "uniqueItems": true },  # noqa: F821  # TODO: true
  ...
  "allOf": [
    ...
    {
      "if": { "properties": { "identity": { "properties": { "requires_auth": { "const": true } }, "required": ["requires_auth"] } } },  # noqa: F821  # TODO: true
      "then": { "properties": { "identity": { "required": ["tiers"], "properties": { "tiers": { "minItems": 1 } } } } }
    },
    {
      "if": { "properties": { "tokenization": { "properties": { "enabled": { "const": true } }, "required": ["enabled"] } } },  # noqa: F821  # TODO: true
