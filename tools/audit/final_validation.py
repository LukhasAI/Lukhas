            ...
            if (
                ...
                and len(
                    [
                        ...
                        and "@" in line
                        and any(
                            len(part) == 40 and all(c in "0123456789abcdef" for c in part.lower())
...
def validate_performance_benchmarks() -> Dict:
    ...
    required_benchmarks = ["memory_performance.py", "matriz_pipeline.py"]
...
def validate_router_metrics() -> Dict:
    ...
    return {
        ...
        "comprehensive": all([has_prometheus, has_fallback_metrics, has_deprecation_metrics, has_resolution_metrics]),
    }
