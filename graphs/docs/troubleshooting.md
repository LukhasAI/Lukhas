...
2. Validate configuration: `python -c "import graphs; print('OK')"`
3. Review logs in `logs/graphs.log`
...
```bash
# Check module health
python -m graphs --health-check

# Validate configuration
python -m graphs --validate-config

# Test connections
python -m graphs --test-connections

# Generate diagnostic report
python -m graphs --diagnostic-report
```
