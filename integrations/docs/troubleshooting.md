...
2. Validate configuration: `python -c "import integrations; print('OK')"`
3. Review logs in `logs/integrations.log`
...
```bash
# Check module health
python -m integrations --health-check

# Validate configuration
python -m integrations --validate-config

# Test connections
python -m integrations --test-connections

# Generate diagnostic report
python -m integrations --diagnostic-report
```
