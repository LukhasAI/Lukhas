...
This directory contains the test suite for the identity module.
...
- **`test_identity_unit.py`** - Unit tests for individual components
- **`test_identity_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=identity --cov-report=html
```
