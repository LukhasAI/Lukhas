...
2. Validate configuration: `python -c "import identity; print('OK')"`
3. Review logs in `logs/identity.log`
...
```bash
# Check module health
python -m identity --health-check

# Validate configuration
python -m identity --validate-config

# Test connections
python -m identity --test-connections

# Generate diagnostic report
python -m identity --diagnostic-report
```
