...
TemplateType = Literal['guardian_invitation', 'recovery_started', 'recovery_approved', 'recovery_denied', 'alias_rotation', 'magic_link_login', 'magic_link_signup', 'sms_magic_link_login', 'sms_magic_link_signup', 'code_verification', 'sms_code_verification']
...
class EmailTemplate:
    ...
    def validate_accessibility(self) -> list[str]:
        ...
        if self.html and 'img' in self.html and not re.search(r'alt="[^"]*"', self.html):
    ...
    def _validate_tone_layers(self) -> list[str]:
        ...
        # Note: Temporarily disabled due to algorithm being too strict
...
class TemplateEngine:
    ...
    def validate_template_variables(
        ...
        required_vars = {
            ...
            'code_verification': [
                'verification_code', 'expires_at', 'user_email'
            ],
    ...
    def get_available_templates(self, language: LanguageCode) -> list[TemplateType]:
        ...
        for template_file in lang_dir.glob("*.json"):
            ...
            if template_name in [
                ...
                'code_verification', 'sms_code_verification'
            ]:
