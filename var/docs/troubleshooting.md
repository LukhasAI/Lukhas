...
2. Validate configuration: `python -c "import var; print('OK')"`
3. Review logs in `logs/var.log`
...
```bash
# Check module health
python -m var --health-check

# Validate configuration
python -m var --validate-config

# Test connections
python -m var --test-connections

# Generate diagnostic report
python -m var --diagnostic-report
```
