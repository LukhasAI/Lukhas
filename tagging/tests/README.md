...
- **`test_tagging_unit.py`** - Unit tests for individual components
- **`test_tagging_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=tagging --cov-report=html
```
