...
2. Validate configuration: `python -c "import tagging; print('OK')"`
3. Review logs in `logs/tagging.log`
...
```bash
# Check module health
python -m tagging --health-check

# Validate configuration
python -m tagging --validate-config

# Test connections
python -m tagging --test-connections

# Generate diagnostic report
python -m tagging --diagnostic-report
```
