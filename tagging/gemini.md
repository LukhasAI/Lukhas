...
from tagging import TagPriority
from tagging import TagScope
```

## Components (7 entrypoints)

- `tagging.AdvancedTagResolver`
- `tagging.SimpleTagResolver`
- `tagging.SymbolicTag`
- `tagging.TagPriority`
- `tagging.TagScope`
- `tagging.create_tag`
- `tagging.quick_resolve`

## Module Metadata

- **Lane**: L2
- **Schema Version**: 3.0.0
- **Tags**: consciousness, tagging
