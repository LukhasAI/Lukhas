...
2. Validate configuration: `python -c "import quantum; print('OK')"`
3. Review logs in `logs/quantum.log`
...
```bash
# Check module health
python -m quantum --health-check

# Validate configuration
python -m quantum --validate-config

# Test connections
python -m quantum --test-connections

# Generate diagnostic report
python -m quantum --diagnostic-report
```
