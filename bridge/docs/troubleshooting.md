...
2. Validate configuration: `python -c "import bridge; print('OK')"`
3. Review logs in `logs/bridge.log`
...
```bash
# Check module health
python -m bridge --health-check

# Validate configuration
python -m bridge --validate-config

# Test connections
python -m bridge --test-connections

# Generate diagnostic report
python -m bridge --diagnostic-report
```
