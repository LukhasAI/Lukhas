...
This directory contains the test suite for the consent module.
...
- **`test_consent_unit.py`** - Unit tests for individual components
- **`test_consent_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=consent --cov-report=html
```
