...
2. Validate configuration: `python -c "import consent; print('OK')"`
3. Review logs in `logs/consent.log`
...
```bash
# Check module health
python -m consent --health-check

# Validate configuration
python -m consent --validate-config

# Test connections
python -m consent --test-connections

# Generate diagnostic report
python -m consent --diagnostic-report
```
