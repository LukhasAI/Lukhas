# System_Claude_Audit Troubleshooting Guide
...
2. Validate configuration: `python -c "import SYSTEM_CLAUDE_AUDIT; print('OK')"`
3. Review logs in `logs/SYSTEM_CLAUDE_AUDIT.log`
...
```bash
# Check module health
python -m SYSTEM_CLAUDE_AUDIT --health-check

# Validate configuration
python -m SYSTEM_CLAUDE_AUDIT --validate-config

# Test connections
python -m SYSTEM_CLAUDE_AUDIT --test-connections

# Generate diagnostic report
python -m SYSTEM_CLAUDE_AUDIT --diagnostic-report
```
