...
# Lukhas-Ai-Intro Troubleshooting Guide
...
2. Validate configuration: `python -c "import lukhas-ai-intro; print('OK')"`
3. Review logs in `logs/lukhas-ai-intro.log`
...
```bash
# Check module health
python -m lukhas-ai-intro --health-check

# Validate configuration
python -m lukhas-ai-intro --validate-config

# Test connections
python -m lukhas-ai-intro --test-connections

# Generate diagnostic report
python -m lukhas-ai-intro --diagnostic-report
```
