...
# Codex_Artifacts Troubleshooting Guide
...
2. Validate configuration: `python -c "import codex_artifacts; print('OK')"`
3. Review logs in `logs/codex_artifacts.log`
...
```bash
# Check module health
python -m codex_artifacts --health-check

# Validate configuration
python -m codex_artifacts --validate-config

# Test connections
python -m codex_artifacts --test-connections

# Generate diagnostic report
python -m codex_artifacts --diagnostic-report
```
