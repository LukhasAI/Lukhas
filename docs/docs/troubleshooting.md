...
2. Validate configuration: `python -c "import docs; print('OK')"`
3. Review logs in `logs/docs.log`
...
```bash
# Check module health
python -m docs --health-check

# Validate configuration
python -m docs --validate-config

# Test connections
python -m docs --test-connections

# Generate diagnostic report
python -m docs --diagnostic-report
```
