...
|--------|----------------|---------------|-----------------|--------|--------|
| **memory** | 📊 **report-only** | ⏳ **pending** | ⚪ not configured | 1/3 🌟 | Core |
| **unknown** | ⚪ not configured | ⚪ not configured | ⚪ not configured | 0/3  | Unknown |

---

## 📈 Track Adoption Details

### Memory Module (1/3 tracks)

**Owner:** Core | **Contract:** `memory/matrix_memoria.json`

- ✅ **Verification**: 📊 report-only
  - Implementation: PRISM model: models/memory/cascade.pm
  - Last Result: Model verified (mock result)

- ⚠️ **Provenance**: ⏳ pending
  - Implementation: CAR structure ready
  - Last Result: Awaiting first run

- ⚪ **Attestation**: ⚪ not-configured
  - Implementation: No RATS configuration
  - Last Result: Not implemented

### Unknown Module (0/3 tracks)

**Owner:** Unknown | **Contract:** `reports/slo/matrix_tracks_slo_report_20250926_121703.json`
...
🥇 **Memory** - 1/3 tracks enabled

### 🚀 Rising Stars (Pending Tracks)

⭐ **Memory** - 1 track(s) pending
