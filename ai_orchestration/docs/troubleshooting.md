...
# Ai_Orchestration Troubleshooting Guide
...
2. Validate configuration: `python -c "import ai_orchestration; print('OK')"`
3. Review logs in `logs/ai_orchestration.log`
...
```bash
# Check module health
python -m ai_orchestration --health-check

# Validate configuration
python -m ai_orchestration --validate-config

# Test connections
python -m ai_orchestration --test-connections

# Generate diagnostic report
python -m ai_orchestration --diagnostic-report
```
