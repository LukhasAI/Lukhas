...
2. Validate configuration: `python -c "import rats; print('OK')"`
3. Review logs in `logs/rats.log`
...
```bash
# Check module health
python -m rats --health-check

# Validate configuration
python -m rats --validate-config

# Test connections
python -m rats --test-connections

# Generate diagnostic report
python -m rats --diagnostic-report
```
