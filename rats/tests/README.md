...
- **`test_rats_unit.py`** - Unit tests for individual components
- **`test_rats_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=rats --cov-report=html
```
