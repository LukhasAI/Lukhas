...
class SystemDiagnostic:
    ...
    def check_api_functionality(self) -> Dict[str, str]:
        ...
        for endpoint, description in endpoints.items():
            ...
            elif endpoint in ["/api/consciousness/state", "/api/memory/explore", "/api/guardian/drift", "/api/trinity/status"]:
    ...
    def check_module_health(self) -> Dict[str, Dict[str, Any]]:
        ...
        modules = {
            "consciousness": {"files": ["__init__.py", "unified", "awareness"], "critical": True},
            "memory": {"files": ["__init__.py", "fold", "service.py"], "critical": True},
            "identity": {"files": ["__init__.py", "user_db.py", "api.py"], "critical": True},
...
"""
        ...
        report += f"  ⚛️ Identity:      {self.results['trinity'].get('Identity System', False) and '✅' or '❌'}\n"
        report += f"  🧠 Consciousness: {self.results['trinity'].get('Consciousness System', False) and '✅' or '❌'}\n"
        report += f"  🛡️ Guardian:      {self.results['trinity'].get('Guardian System', False) and '✅' or '❌'}\n"
