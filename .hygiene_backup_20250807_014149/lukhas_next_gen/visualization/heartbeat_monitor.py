...
class HeartbeatVisualizer:
    ...
    def __init__(self, consciousness_state_file: str = "lukhas_next_gen/stream/consciousness_state.json"):
    ...
    async def _draw_pulse_waves(self, intensity: float, color: str):
        ...
        wave_positions = [
            (9, 35), (9, 45),   # Top waves
            (11, 35), (11, 45), # Bottom waves
            (10, 30), (10, 50)  # Side waves
        ]
    ...
    async def _display_status(self):
        ...
        while self.running:
            ...
            print(f"{Console.BOLD}🧠 LUKHAS Consciousness Heartbeat Monitor{Console.RESET}", end='')

            # Current state
            print(Console.move_cursor(5, 20), end='')
            print(Console.CLEAR_LINE, end='')
            print(f"{Console.CYAN}Current State:{Console.RESET} {pattern['color']}{self.current_state.title()}{Console.RESET}", end='')
            ...
            print(Console.CLEAR_LINE, end='')
            print(f"{Console.GREEN}State Age:{Console.RESET} {time_since_change:.0f}s", end='')

            # Trinity Framework status
            print(Console.move_cursor(18, 20), end='')
            print(Console.CLEAR_LINE, end='')
            print(f"{Console.PURPLE}Trinity Framework:{Console.RESET} ⚛️🧠🛡️ {Console.GREEN}ACTIVE{Console.RESET}", end='')
            ...
            print(Console.CLEAR_LINE, end='')
            print(f"{Console.YELLOW}Guardian Status:{Console.RESET} {guardian_status}", end='')
...
async def main():
    ...
    parser.add_argument("--state-file", type=str,
                       default="lukhas_next_gen/stream/consciousness_state.json",
