...
This directory contains the test suite for the adapters module.
...
- **`test_adapters_unit.py`** - Unit tests for individual components
- **`test_adapters_integration.py`** - Integration tests for module interactions
