...
2. Validate configuration: `python -c "import adapters; print('OK')"`
3. Review logs in `logs/adapters.log`
...
```bash
# Check module health
python -m adapters --health-check

# Validate configuration
python -m adapters --validate-config

# Test connections
python -m adapters --test-connections

# Generate diagnostic report
python -m adapters --diagnostic-report
```
