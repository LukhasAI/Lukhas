    ...
    def handle(self, msg: MatrizMessage) -> MatrizResult:
        ...
        try:
            ...
            return MatrizResult(
                ...
                payload={},
                trace={"error": str(e), "legacy_node": self.legacy.__class__.__name__, "shim_version": self.version},
                guardian_log=[token],
            )
...
__all__ = ["LegacyShim", "create_shim", "is_legacy_available", "migrate_legacy_nodes", "logger"]
