...
2. Validate configuration: `python -c "import matriz; print('OK')"`
3. Review logs in `logs/matriz.log`
...
```bash
# Check module health
python -m matriz --health-check

# Validate configuration
python -m matriz --validate-config

# Test connections
python -m matriz --test-connections

# Generate diagnostic report
python -m matriz --diagnostic-report
```
