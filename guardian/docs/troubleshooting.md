...
# Guardian Troubleshooting Guide
...
2. Validate configuration: `python -c "import guardian; print('OK')"`
3. Review logs in `logs/guardian.log`
...
```bash
# Check module health
python -m guardian --health-check

# Validate configuration
python -m guardian --validate-config

# Test connections
python -m guardian --test-connections

# Generate diagnostic report
python -m guardian --diagnostic-report
```
