# Reasoning Troubleshooting Guide
...
2. Validate configuration: `python -c "import reasoning; print('OK')"`
3. Review logs in `logs/reasoning.log`
...
```bash
# Check module health
python -m reasoning --health-check

# Validate configuration
python -m reasoning --validate-config

# Test connections
python -m reasoning --test-connections

# Generate diagnostic report
python -m reasoning --diagnostic-report
```
