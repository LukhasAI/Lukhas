...
This directory contains the test suite for the presentations module.
...
- **`test_presentations_unit.py`** - Unit tests for individual components
- **`test_presentations_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=presentations --cov-report=html
```
