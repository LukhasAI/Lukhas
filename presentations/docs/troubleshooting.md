...
# Presentations Troubleshooting Guide
...
2. Validate configuration: `python -c "import presentations; print('OK')"`
3. Review logs in `logs/presentations.log`
...
```bash
# Check module health
python -m presentations --health-check

# Validate configuration
python -m presentations --validate-config

# Test connections
python -m presentations --test-connections

# Generate diagnostic report
python -m presentations --diagnostic-report
```
