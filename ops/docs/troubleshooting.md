...
2. Validate configuration: `python -c "import ops; print('OK')"`
3. Review logs in `logs/ops.log`
...
```bash
# Check module health
python -m ops --health-check

# Validate configuration
python -m ops --validate-config

# Test connections
python -m ops --test-connections

# Generate diagnostic report
python -m ops --diagnostic-report
```
