...
2. Validate configuration: `python -c "import orchestration; print('OK')"`
3. Review logs in `logs/orchestration.log`
...
```bash
# Check module health
python -m orchestration --health-check

# Validate configuration
python -m orchestration --validate-config

# Test connections
python -m orchestration --test-connections

# Generate diagnostic report
python -m orchestration --diagnostic-report
```
...
4. Contact the Orchestration team
