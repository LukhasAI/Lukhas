...
from core.glyph.universal_symbol_protocol import (
    UniversalSymbol, SymbolModality, SymbolDomain
)
...
class UnifiedCognitiveOrchestrator:
    ...
    async def _setup_event_handlers(self):
        ...
        async def on_quantum_collapse(event: QuantumStateCollapsed):
        ...
        self.event_bus.subscribe(QuantumStateCollapsed, on_quantum_collapse)
