...
class ContextBusOrchestrator:
    ...
    def __init__(self):
        ...
        self.context_store: Dict[str, ContextHandoff] = {}
        ...
        self.workflow_narratives: Dict[str, List[str]] = {}
    
    async def execute_workflow(self, lid: str, workflow_name: str,
                              steps: List[WorkflowStep],
                              initial_context: Optional[Dict] = None) -> Dict:
        """
        ...
        try:
            ...
            self._add_narrative(workflow_id, f"❌ Failed: {str(e)}")
    ...
    async def _check_policy(self, lid: str, action: str, 
                           context: Dict) -> Dict:
        """
    ...
    async def _pause_for_step_up(self, workflow_id: str, 
                                policy_result: Dict):
        """
        ...
        await self.publish_event("step_up_required", {
            "workflow_id": workflow_id,
    ...
    def get_performance_metrics(self) -> Dict:
        ...
        return {
            "workflows": {
                ...
                "success_rate": (self.performance_metrics["completed_workflows"] / 
...
class WorkflowPipelines:
    ...
    @staticmethod
    def create_travel_analysis_pipeline(orchestrator: ContextBusOrchestrator) -> List[WorkflowStep]:
        """
        ...
        return [
            WorkflowStep(
                ...
                handler=lambda lid, ctx: orchestrator.identity_service.validate_access(
                    ctx.get("auth_token", "")
                ),
            ...
            WorkflowStep(
                ...
                handler=lambda lid, ctx: {"analysis": "GPT-4 analysis of travel documents"},
                required_scopes=["execute"],
                requires_policy_check=True,
                policy_context={"model": "gpt-4"}
            ),
            WorkflowStep(
                step_id="cross_reference",
                name="Cross-reference with Claude",
                handler=lambda lid, ctx: {"cross_reference": "Claude validation of analysis"},
                required_scopes=["execute"],
                requires_policy_check=True,
                policy_context={"model": "claude"}
            ),
            WorkflowStep(
