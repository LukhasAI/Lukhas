...
class SignalBus:
            ...
            try:
                with self._lock:
                    ...
                    self._active_signals = [
                        sig for sig in self._active_signals 
    ...
    def register_pattern(self, pattern: SignalPattern, handler: Callable[[List[Signal]], None]):
        """
    ...
    def get_signal_levels(self) -> Dict[SignalType, float]:
        ...
        levels = {sig_type: 0.0 for sig_type in SignalType}
