...
# Security-Reports Troubleshooting Guide
...
2. Validate configuration: `python -c "import security-reports; print('OK')"`
3. Review logs in `logs/security-reports.log`
...
```bash
# Check module health
python -m security-reports --health-check

# Validate configuration
python -m security-reports --validate-config

# Test connections
python -m security-reports --test-connections

# Generate diagnostic report
python -m security-reports --diagnostic-report
```
