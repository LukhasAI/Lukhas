...
async def test_tool_with_fallback():
    ...
    prompt = "Schedule a reminder for tomorrow at 3pm to review the LUKHAS documentation."
    ...
    scheduled = any(t['tool'] == 'schedule_task' and t['status'] == 'executed' for t in tools_used)
...
async def main():
    ...
    print(f"Testing complete OpenAI → Tool Executor → Response flow")
