...
2. Validate configuration: `python -c "import emotion; print('OK')"`
3. Review logs in `logs/emotion.log`
...
```bash
# Check module health
python -m emotion --health-check

# Validate configuration
python -m emotion --validate-config

# Test connections
python -m emotion --test-connections

# Generate diagnostic report
python -m emotion --diagnostic-report
```
