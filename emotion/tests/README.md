...
This directory contains the test suite for the emotion module.
...
- **`test_emotion_unit.py`** - Unit tests for individual components
- **`test_emotion_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=emotion --cov-report=html
```
