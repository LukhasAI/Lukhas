...
2. Validate configuration: `python -c "import hooks; print('OK')"`
3. Review logs in `logs/hooks.log`
...
```bash
# Check module health
python -m hooks --health-check

# Validate configuration
python -m hooks --validate-config

# Test connections
python -m hooks --test-connections

# Generate diagnostic report
python -m hooks --diagnostic-report
```
