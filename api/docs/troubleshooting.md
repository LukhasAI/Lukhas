...
2. Validate configuration: `python -c "import api; print('OK')"`
...
```bash
# Check module health
python -m api --health-check

# Validate configuration
python -m api --validate-config

# Test connections
python -m api --test-connections

# Generate diagnostic report
python -m api --diagnostic-report
```
