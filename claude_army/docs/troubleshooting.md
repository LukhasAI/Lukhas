...
# Claude_Army Troubleshooting Guide
...
2. Validate configuration: `python -c "import CLAUDE_ARMY; print('OK')"`
3. Review logs in `logs/CLAUDE_ARMY.log`
...
```bash
# Check module health
python -m CLAUDE_ARMY --health-check

# Validate configuration
python -m CLAUDE_ARMY --validate-config

# Test connections
python -m CLAUDE_ARMY --test-connections

# Generate diagnostic report
python -m CLAUDE_ARMY --diagnostic-report
```
