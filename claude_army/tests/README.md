...
- **`test_CLAUDE_ARMY_unit.py`** - Unit tests for individual components
- **`test_CLAUDE_ARMY_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=CLAUDE_ARMY --cov-report=html
```
