...
try:
    ...
    from agi_core.memory import VectorMemory, MemoryConsolidator, DreamMemory
    from agi_core.safety import ConstitutionalAI
    from agi_core.learning import DreamGuidedLearner
    from agi_core.integration import vocabulary_service, log_agi_operation
except ImportError:
...
if __name__ == "__main__":
    ...
    async def test_bridge():
        ...
        cot_adapter = await bridge.register_agi_service("chain_of_thought", cot)
        router_adapter = await bridge.register_agi_service("model_router", router)
