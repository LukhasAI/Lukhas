...
- **`test_agents_external_unit.py`** - Unit tests for individual components
- **`test_agents_external_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=agents_external --cov-report=html
```
