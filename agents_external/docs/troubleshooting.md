...
# Agents_External Troubleshooting Guide
...
2. Validate configuration: `python -c "import agents_external; print('OK')"`
3. Review logs in `logs/agents_external.log`
...
```bash
# Check module health
python -m agents_external --health-check

# Validate configuration
python -m agents_external --validate-config

# Test connections
python -m agents_external --test-connections

# Generate diagnostic report
python -m agents_external --diagnostic-report
```
