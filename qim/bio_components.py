    ...
    def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if num_items == 0: gradient_strength = 0.0
                ...
                gradient_strength = (total_numeric_sum / max(1, len(numeric_values)) if numeric_values else 0) + " + "(total_string_len_sum / max(1, len(string_lengths)) / 10.0 if string_lengths else 0)
