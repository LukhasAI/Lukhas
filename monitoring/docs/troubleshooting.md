...
2. Validate configuration: `python -c "import monitoring; print('OK')"`
3. Review logs in `logs/monitoring.log`
...
python -m monitoring --validate-config

# Test connections
python -m monitoring --test-connections

# Generate diagnostic report
python -m monitoring --diagnostic-report
```
