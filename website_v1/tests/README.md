...
- **`test_website_v1_unit.py`** - Unit tests for individual components
- **`test_website_v1_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=website_v1 --cov-report=html
```
