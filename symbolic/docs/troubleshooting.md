...
# Symbolic Troubleshooting Guide
...
2. Validate configuration: `python -c "import symbolic; print('OK')"`
3. Review logs in `logs/symbolic.log`
...
```bash
# Check module health
python -m symbolic --health-check

# Validate configuration
python -m symbolic --validate-config

# Test connections
python -m symbolic --test-connections

# Generate diagnostic report
python -m symbolic --diagnostic-report
```
