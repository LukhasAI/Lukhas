...
def with_cleanup(func: Any) -> Any:
    ...
    def wrapper(self: RequirementCommand, options: Values, args: list[Any]) -> int | None:
...
class RequirementCommand(IndexGroupCommand):
    ...
    def get_requirements(
        ...
        if not (args or options.editables or options.requirements or options.dependency_groups):
            opts = {"name": self.name}
