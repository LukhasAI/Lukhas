...
class IncompleteDownloadError(DiagnosticPipError):
    ...
    def __init__(self, download: _FileDownload) -> None:
        ...
        download_status = f"{format_size(download.bytes_received)}/{format_size(download.size)}"
        ...
        message = Text(f"Download failed {retry_status}because not enough bytes " f"were received ({download_status})")
