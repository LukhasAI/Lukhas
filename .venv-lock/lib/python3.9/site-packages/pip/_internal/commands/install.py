...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options: Values, args: list[str]) -> int:
        ...
        try:
            ...
            reqs_to_build = [r for r in requirement_set.requirements_to_install if should_build_for_install_command(r)]
    ...
    def _determine_conflicts(self, to_install: list[InstallRequirement]) -> ConflictDetails | None:
        try:
...
def create_os_error_message(error: OSError, show_traceback: bool, using_user_site: bool) -> str:
    ...
    if type(error) is InvalidProxyURL:
        parts.append('Consider checking your local proxy configuration with "pip config debug"')
        parts.append(".\n")
