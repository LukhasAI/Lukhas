    ...
    def get_preference(
        ...
        * Alphabetical order for consistency (aids debuggability).
        ...
        if not has_information:
            ...
            directs, ireqs = zip(
                *((isinstance(r, ExplicitRequirement), r.get_candidate_lookup()[1]) for r, _ in information[identifier])
            )
            direct = any(directs)
        ...
        upper_bounded = any(((op in ("<", "<=", "~=")) or (op == "==" and "*" in ver)) for op, ver in operators)
