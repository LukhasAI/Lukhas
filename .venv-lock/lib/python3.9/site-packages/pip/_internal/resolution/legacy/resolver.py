...
def _check_dist_requires_python(
    ...
    raise UnsupportedPythonVersion(
        f"Package {dist.raw_name!r} requires a different Python: " f"{version} not in {requires_python!r}"
    )
...
class Resolver(BaseResolver):
    ...
    def _add_requirement_to_set(
        ...
        try:
            existing_req: InstallRequirement | None = requirement_set.get_requirement(install_req.name)
        except KeyError:
            existing_req = None
