...
class CyclicDependencyError(ValueError):
    ...
    def __init__(self, requested_group: str, group: str, include_group: str) -> None:
        ...
        super().__init__("Cyclic dependency group include while resolving " f"{requested_group}: {reason}")
...
class DependencyGroupResolver:
    ...
    def __init__(
        ...
        self._parsed_groups: dict[str, tuple[Requirement | DependencyGroupInclude, ...]] = {}
    ...
    def _parse_group(self, group: str) -> tuple[Requirement | DependencyGroupInclude, ...]:
        ...
        for item in parsed:
            if isinstance(item, Requirement):
                ...
                if include_group in self._include_graph_ancestors.get(group, ()):
                    raise CyclicDependencyError(requested_group, group, item.include_group)
                ...
                raise NotImplementedError(f"Invalid dependency group item after parse: {item}")
