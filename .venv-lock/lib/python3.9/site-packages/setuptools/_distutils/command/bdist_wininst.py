...
class bdist_wininst(Command):
    ...
    def __init__(self, *args, **kw):
        ...
        warnings.warn(
            "bdist_wininst command is deprecated since Python 3.8, " "use bdist_wheel (wheel packages) instead",
            DeprecationWarning,
            2,
        )
    ...
    def get_installer_filename(self, fullname):
        ...
        if self.target_version:
            ...
            installer_name = os.path.join(
                self.dist_dir, "%s.%s-py%s.exe" % (fullname, self.plat_name, self.target_version)
            )
        else:
