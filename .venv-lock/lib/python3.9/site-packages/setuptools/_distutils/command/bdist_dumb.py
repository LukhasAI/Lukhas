...
class bdist_dumb(Command):
    ...
    def finalize_options(self):
        ...
        self.set_undefined_options(
            "bdist", ("dist_dir", "dist_dir"), ("plat_name", "plat_name"), ("skip_build", "skip_build")
        )
    ...
    def run(self):
        ...
        filename = self.make_archive(
            pseudoinstall_root, self.format, root_dir=archive_root, owner=self.owner, group=self.group
        )
