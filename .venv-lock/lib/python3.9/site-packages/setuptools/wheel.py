...
class Wheel:
    ...
    def _convert_metadata(zf, destination_eggdir, dist_info, egg_info):
        ...
        extras_require = {
            extra: sorted(req for req in map(raw_req, dist.requires((extra,))) if req not in install_requires)
    ...
    def _move_data_entries(destination_eggdir, dist_data):
        ...
        for subdir in filter(
            os.path.exists, (os.path.join(dist_data, d) for d in ("data", "headers", "purelib", "platlib"))
        ):
