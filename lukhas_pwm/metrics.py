...
class MetricsCollector:
    ...
    def set_safety_mode(self, mode: str, session_id: str = "default"):
        ...
        current_safety_mode.labels(session_id=session_id).set(
            mode_values.get(mode, 1)
        )
