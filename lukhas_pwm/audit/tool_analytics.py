...
class ToolAnalytics:
    ...
    def complete_tool_call(self, call_id: str, status: str = "success", 
    ...
    def record_blocked_attempt(self, audit_id: str, attempted_tool: str,
                              allowed_tools: List[str], prompt: str) -> ToolIncident:
