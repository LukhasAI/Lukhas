...
identified by Ruff static analysis. Uses Constellation Framework consciousness patterns
...
class LocalLLMClient:
    ...
    def _build_fix_prompt(self, issue: CodeIssue, context: str) -> str:
        """Build Constellation Framework-aware prompt for code fixing"""

        return f"""⚛️🧠🛡️ LUKHAS Code Quality Consciousness Assistant

You are helping improve the LUKHAS AI consciousness development platform. Apply the Constellation Framework:
...
3. Ensure Constellation Framework compliance (authentic, aware, safe)
...
All fixes applied follow LUKHAS Constellation Framework principles:
...
*⚛️🧠🛡️ Constellation Framework Consciousness Technology*
""""
