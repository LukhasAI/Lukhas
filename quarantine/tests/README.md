...
- **`test_quarantine_unit.py`** - Unit tests for individual components
- **`test_quarantine_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=quarantine --cov-report=html
```
