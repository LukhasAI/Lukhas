...
2. Validate configuration: `python -c "import system; print('OK')"`
3. Review logs in `logs/system.log`
...
```bash
# Check module health
python -m system --health-check

# Validate configuration
python -m system --validate-config

# Test connections
python -m system --test-connections

# Generate diagnostic report
python -m system --diagnostic-report
```
