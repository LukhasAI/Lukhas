...
# Helper functions
def emit_event(event_type: str, source: str, payload: Optional[dict[str, Any]] = None):
    """Helper to emit events synchronously"""
    event = Event(event_type=event_type, source_module=source, payload=payload)
    event_bus.publish_sync(event)


async def emit_event_async(event_type: str, source: str, payload: Optional[dict[str, Any]] = None):
