...
This directory contains the test suite for the system module.
...
- **`test_system_unit.py`** - Unit tests for individual components
- **`test_system_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=system --cov-report=html
```
