...
# Vocabularies Troubleshooting Guide
...
2. Validate configuration: `python -c "import vocabularies; print('OK')"`
3. Review logs in `logs/vocabularies.log`
...
```bash
# Check module health
python -m vocabularies --health-check

# Validate configuration
python -m vocabularies --validate-config

# Test connections
python -m vocabularies --test-connections

# Generate diagnostic report
python -m vocabularies --diagnostic-report
```
