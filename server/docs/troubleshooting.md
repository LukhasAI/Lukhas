...
2. Validate configuration: `python -c "import server; print('OK')"`
...
```bash
# Check module health
python -m server --health-check

# Validate configuration
python -m server --validate-config

# Test connections
python -m server --test-connections

# Generate diagnostic report
python -m server --diagnostic-report
```
