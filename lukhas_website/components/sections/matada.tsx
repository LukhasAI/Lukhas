...
export function MatadaSection() {
  ...
  const features = {
    nodes: {
      ...
      details: 'Unlike traditional AI that processes information in black boxes, MATADA creates explicit nodes for each cognitive operation. These nodes contain complete context, decision paths, and evolutionary history.',
      icon: '🧩',
      applications: [
