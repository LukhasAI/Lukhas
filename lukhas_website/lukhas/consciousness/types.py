...
class DecisionContext:
    ...
    def add_proposed_action(self, action_type: str, parameters: Dict[str, Any], priority: str = "medium"):
        ...
        action = {"type": action_type, "parameters": parameters, "priority": priority, "timestamp": time.time()}
...
class CreativitySnapshot:
    ...
    def add_guardian_approval(self, item_id: str, approved: bool, reason: str):
        ...
        approval = {"item_id": item_id, "approved": approved, "reason": reason, "timestamp": time.time()}
    ...
    def add_validation_check(self, check_type: str, result: bool, details: str):
        ...
        check = {"type": check_type, "result": result, "details": details, "timestamp": time.time()}
...
DEFAULT_AWARENESS_CONFIG = {"drift_alpha": 0.3, "anomaly_threshold": 0.8, "load_smoothing_window": 10}

DEFAULT_REFLECTION_CONFIG = {"coherence_threshold": 0.85, "p95_target_ms": 10.0, "cv_target": 0.10}

DEFAULT_DREAM_CONFIG = {"max_duration_ms": 50, "consolidation_threshold": 100, "pattern_discovery_enabled": True}
