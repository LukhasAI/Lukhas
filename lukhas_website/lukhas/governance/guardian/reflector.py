...
**Canonical Location**: This is the official implementation location as of Phase 3.
"""
...
# Legacy compatibility aliases (maintained for Phase 3 transition)
DriftMetrics = DriftAnalysis
RemediationAction = dict  # Simplified type for legacy compatibility
