...
class ConstellationFrameworkIntegration:
    ...
    Aligns authentication with Constellation Framework principles across all modules.
    """
    ...
    async def _send_via_kernel_bus(self, message: AuthModuleMessage) -> bool:
        ...
        try:
            ...
            kernel_message = {
                ...
                "constellation": message.triad_context,
    ...
    async def get_user_module_contexts(self, user_id: str) -> dict[str, Any]:
        ...
        for module_type in self.registered_modules:
            ...
            return {
                ...
                "constellation_integration": self.constellation_integration.get_triad_context_for_module(
