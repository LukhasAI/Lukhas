...
class AuthorizationRequest(BaseRequest, ClientIdValidation, RedirectUriValidation, ScopeValidation):
    ...
    prompt: Optional[str] = Field(
        None, regex=r"^(none|login|consent|select_account)( (none|login|consent|select_account))*$"
    )
...
class ClientRegistrationRequest(BaseRequest):
    ...
    token_endpoint_auth_method: str = Field(
        "client_secret_basic", regex=r"^(client_secret_basic|client_secret_post|none)$"
    )
