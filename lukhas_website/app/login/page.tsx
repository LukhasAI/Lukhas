...
const UI_TEXT = {
  en: {
    ...
    securedBy: 'Protected by passkeys (WebAuthn) and layered security controls',
  ...
  es: {
    ...
    securedBy: 'Protegido por llaves de acceso (WebAuthn) y controles de seguridad por capas',
