...
class ConsciousnessMemory:
    ...
    def __init__(
        ...
        consciousness_state_file: str = "next_gen/stream/consciousness_state.json",
    ):
        ...
        logger.info("🧠 Consciousness Memory initialized")
    ...
    def _load_consciousness_state(self):
        ...
        if self.consciousness_state_file.exists():
            try:
                with open(self.consciousness_state_file) as f:
                    data = json.load(f)
