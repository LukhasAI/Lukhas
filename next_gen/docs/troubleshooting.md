...
# Next_Gen Troubleshooting Guide
...
2. Validate configuration: `python -c "import next_gen; print('OK')"`
3. Review logs in `logs/next_gen.log`
...
```bash
# Check module health
python -m next_gen --health-check

# Validate configuration
python -m next_gen --validate-config

# Test connections
python -m next_gen --test-connections

# Generate diagnostic report
python -m next_gen --diagnostic-report
```
