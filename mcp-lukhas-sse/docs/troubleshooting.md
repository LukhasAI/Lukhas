...
# Mcp-Lukhas-Sse Troubleshooting Guide
...
2. Validate configuration: `python -c "import mcp-lukhas-sse; print('OK')"`
3. Review logs in `logs/mcp-lukhas-sse.log`
...
```bash
# Check module health
python -m mcp-lukhas-sse --health-check

# Validate configuration
python -m mcp-lukhas-sse --validate-config

# Test connections
python -m mcp-lukhas-sse --test-connections

# Generate diagnostic report
python -m mcp-lukhas-sse --diagnostic-report
```
