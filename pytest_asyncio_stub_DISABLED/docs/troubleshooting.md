...
# Pytest_Asyncio Troubleshooting Guide
...
2. Validate configuration: `python -c "import pytest_asyncio; print('OK')"`
3. Review logs in `logs/pytest_asyncio.log`
...
```bash
# Check module health
python -m pytest_asyncio --health-check

# Validate configuration
python -m pytest_asyncio --validate-config

# Test connections
python -m pytest_asyncio --test-connections

# Generate diagnostic report
python -m pytest_asyncio --diagnostic-report
```
