...
2. Validate configuration: `python -c "import performance; print('OK')"`
3. Review logs in `logs/performance.log`
...
```bash
# Check module health
python -m performance --health-check

# Validate configuration
python -m performance --validate-config

# Test connections
python -m performance --test-connections

# Generate diagnostic report
python -m performance --diagnostic-report
```
