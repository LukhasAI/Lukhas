...
This directory contains the test suite for the observability module.
...
- **`test_observability_unit.py`** - Unit tests for individual components
- **`test_observability_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=observability --cov-report=html
```
