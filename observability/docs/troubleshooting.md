...
2. Validate configuration: `python -c "import observability; print('OK')"`
3. Review logs in `logs/observability.log`
...
```bash
# Check module health
python -m observability --health-check

# Validate configuration
python -m observability --validate-config

# Test connections
python -m observability --test-connections

# Generate diagnostic report
python -m observability --diagnostic-report
```
