...
2. Validate configuration: `python -c "import agents; print('OK')"`
3. Review logs in `logs/agents.log`
...
```bash
# Check module health
python -m agents --health-check

# Validate configuration
python -m agents --validate-config

# Test connections
python -m agents --test-connections

# Generate diagnostic report
python -m agents --diagnostic-report
```
