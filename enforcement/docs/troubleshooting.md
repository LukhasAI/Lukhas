...
2. Validate configuration: `python -c "import enforcement; print('OK')"`
3. Review logs in `logs/enforcement.log`
...
```bash
# Check module health
python -m enforcement --health-check

# Validate configuration
python -m enforcement --validate-config

# Test connections
python -m enforcement --test-connections

# Generate diagnostic report
python -m enforcement --diagnostic-report
```
