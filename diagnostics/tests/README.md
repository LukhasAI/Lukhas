...
- **`test_diagnostics_unit.py`** - Unit tests for individual components
- **`test_diagnostics_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=diagnostics --cov-report=html
```
