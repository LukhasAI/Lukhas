...
2. Validate configuration: `python -c "import diagnostics; print('OK')"`
3. Review logs in `logs/diagnostics.log`
...
```bash
# Check module health
python -m diagnostics --health-check

# Validate configuration
python -m diagnostics --validate-config

# Test connections
python -m diagnostics --test-connections

# Generate diagnostic report
python -m diagnostics --diagnostic-report
```
