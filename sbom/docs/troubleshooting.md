...
2. Validate configuration: `python -c "import sbom; print('OK')"`
3. Review logs in `logs/sbom.log`
...
```bash
# Check module health
python -m sbom --health-check

# Validate configuration
python -m sbom --validate-config

# Test connections
python -m sbom --test-connections

# Generate diagnostic report
python -m sbom --diagnostic-report
```
