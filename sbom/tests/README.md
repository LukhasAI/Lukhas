...
This directory contains the test suite for the sbom module.
...
- **`test_sbom_unit.py`** - Unit tests for individual components
- **`test_sbom_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=sbom --cov-report=html
```
