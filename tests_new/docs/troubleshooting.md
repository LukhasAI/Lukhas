...
# Tests_New Troubleshooting Guide
...
2. Validate configuration: `python -c "import tests_new; print('OK')"`
3. Review logs in `logs/tests_new.log`
...
```bash
# Check module health
python -m tests_new --health-check

# Validate configuration
python -m tests_new --validate-config

# Test connections
python -m tests_new --test-connections

# Generate diagnostic report
python -m tests_new --diagnostic-report
```
