...
This directory contains the test suite for the tests_new module.
...
- **`test_tests_new_unit.py`** - Unit tests for individual components
- **`test_tests_new_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=tests_new --cov-report=html
```
