...
2. Validate configuration: `python -c "import qi; print('OK')"`
3. Review logs in `logs/qi.log`
...
```bash
# Check module health
python -m qi --health-check

# Validate configuration
python -m qi --validate-config

# Test connections
python -m qi --test-connections

# Generate diagnostic report
python -m qi --diagnostic-report
```
