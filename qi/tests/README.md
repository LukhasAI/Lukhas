...
This directory contains the test suite for the qi module.
...
- **`test_qi_unit.py`** - Unit tests for individual components
- **`test_qi_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=qi --cov-report=html
```
