...
from qi.security import DEFAULT_COMPLIANCE_FRAMEWORKS, MultiJurisdictionComplianceEngine
...
class QIAGISystem:
    ...
    def __init__(self, config: SystemConfig):  # noqa: F821  # TODO: SystemConfig
        ...
        self.security_mesh = MultiJurisdictionComplianceEngine(
        ...
        self.compliance_registry = {
            "frameworks": self.security_mesh.frameworks,
    ...
    async def process_user_request(self, request: UserRequest, qi_session: QISecureSession) -> SecureResponse:  # noqa: F821  # TODO: UserRequest
        ...
        try:
            ...
            if not await self.security_mesh.validate_request(request):
                raise PermissionError("Request failed multi-jurisdiction compliance validation")
