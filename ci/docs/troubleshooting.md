...
2. Validate configuration: `python -c "import ci; print('OK')"`
3. Review logs in `logs/ci.log`
...
```bash
# Check module health
python -m ci --health-check

# Validate configuration
python -m ci --validate-config

# Test connections
python -m ci --test-connections

# Generate diagnostic report
python -m ci --diagnostic-report
```
