...
This directory contains the test suite for the ci module.
...
- **`test_ci_unit.py`** - Unit tests for individual components
- **`test_ci_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=ci --cov-report=html
```
