...
async def test_state_variety():
    ...
    for i in range(50):
        ...
        if i % 5 == 0:
            ...
            emotional_state = {"valence": 0.8, "arousal": 0.9, "dominance": 0.8}
            intensity = 0.9
            complexity = 0.8
        elif i % 5 == 1:
            # Negative valence, low arousal
            emotional_state = {"valence": -0.8, "arousal": 0.2, "dominance": 0.3}
            intensity = 0.3
            complexity = 0.2
        elif i % 5 == 2:
            # Creative state
            emotional_state = {"valence": 0.5, "arousal": 0.6, "dominance": 0.5}
            intensity = 0.7
            complexity = 0.6
        elif i % 5 == 3:
            # Low everything
            emotional_state = {"valence": 0.0, "arousal": 0.2, "dominance": 0.2}
            intensity = 0.2
            complexity = 0.1
        else:
            # Random
        ...
        print(f"{i:2d}: {state:15s} mag={magnitude:6.2f} "
