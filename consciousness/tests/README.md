...
This directory contains the test suite for the consciousness module.
...
- **`test_consciousness_unit.py`** - Unit tests for individual components
- **`test_consciousness_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=consciousness --cov-report=html
```
