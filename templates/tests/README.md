...
- **`test_templates_unit.py`** - Unit tests for individual components
- **`test_templates_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=templates --cov-report=html
```
