...
# Templates Troubleshooting Guide
...
2. Validate configuration: `python -c "import templates; print('OK')"`
3. Review logs in `logs/templates.log`
...
```bash
# Check module health
python -m templates --health-check

# Validate configuration
python -m templates --validate-config

# Test connections
python -m templates --test-connections

# Generate diagnostic report
python -m templates --diagnostic-report
```
