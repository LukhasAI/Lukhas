...
2. Validate configuration: `python -c "import dream; print('OK')"`
3. Review logs in `logs/dream.log`
...
```bash
# Check module health
python -m dream --health-check

# Validate configuration
python -m dream --validate-config

# Test connections
python -m dream --test-connections

# Generate diagnostic report
python -m dream --diagnostic-report
```
