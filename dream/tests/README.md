...
This directory contains the test suite for the dream module.
...
- **`test_dream_unit.py`** - Unit tests for individual components
- **`test_dream_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=dream --cov-report=html
```
