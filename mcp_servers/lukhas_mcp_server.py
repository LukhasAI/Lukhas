            ...
            return [
                types.Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "file_type": {"type": "string", "description": "Type of file (python, javascript, etc.)"},
                ...
                types.Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "signature": {"type": "string", "description": "Function/class signature"},
                            "context": {"type": "string", "description": "Additional context about purpose"}
                        },
                ...
                types.Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "purpose": {"type": "string", "description": "What the element does"},
                            "element_type": {"type": "string", "enum": ["function", "class", "variable", "module"]},
                            "domain": {"type": "string", "description": "Which LUKHAS domain (consciousness, quantum, guardian, etc.)"}
                        },
                ...
                types.Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "concept": {"type": "string", "description": "LUKHAS concept to explain"},
                            "audience": {"type": "string", "enum": ["developer", "user", "technical"], "default": "developer"}
                        },
                        "required": ["concept"]
                    }
                ),
                types.Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "category": {"type": "string", "enum": ["naming", "documentation", "api_design", "comments", "class_design"]},
