...
## Output
- One test file at: `tests/unit/serve/test_serve_streaming.py`
- Run locally:
```
pytest -q tests/unit/serve/test_serve_streaming.py --cov=serve --cov-report=term-missing
```
