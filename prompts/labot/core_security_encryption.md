...
## Output
- One test file at: `tests/unit/core/test_core_security_encryption.py`
- Run locally:
```
pytest -q tests/unit/core/test_core_security_encryption.py --cov=core --cov-report=term-missing
```
