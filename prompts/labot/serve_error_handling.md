...
## Output
- One test file at: `tests/unit/serve/test_serve_error_handling.py`
- Run locally:
```
pytest -q tests/unit/serve/test_serve_error_handling.py --cov=serve --cov-report=term-missing
```
