...
**File:** `serve/identity_middleware.py`
...
## Output
- One test file at: `tests/unit/serve/test_serve_identity_middleware.py`
- Run locally:
```
pytest -q tests/unit/serve/test_serve_identity_middleware.py --cov=serve --cov-report=term-missing
```
