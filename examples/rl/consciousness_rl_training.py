...
class MockMemorySystem:
    ...
    async def get_coherence_metrics(self) -> Dict[str, Any]:
        return {
            'coherence': 0.9,
            'salience_map': {'important': 0.8, 'recent': 0.6}
        }
...
class MockGuardianSystem:
    ...
    async def get_ethical_state(self) -> Dict[str, Any]:
        return {
            ...
            'active_constraints': {'harm_prevention': True}
        }
...
async def run_training_example():
    ...
    try:
        ...
        logger.info(f"  Final Average Reward: {training_results['consciousness_metrics'].get('final_average_reward', 0.0):.3f}")
        logger.info(f"  Consciousness Coherence: {training_results['consciousness_metrics'].get('final_consciousness_coherence', 0.0):.3f}")
        logger.info(f"  Ethical Compliance: {training_results['consciousness_metrics'].get('final_ethical_compliance', 0.0):.3f}")
...
async def test_individual_components():
    ...
    for step in range(3):
        ...
        logger.info(f"  Step {step}: reward={reward:.3f}, done={done}, consciousness_metrics={info.get('consciousness_metrics', {})}")
        ...
        try:
            ...
            if choice == "1":
                ...
                for step in range(3):
                    action = environment.action_space.sample()
                    obs, reward, done, truncated, info = await environment.step(action)
                    print(f"  Step {step}: reward={reward:.3f}, awareness={info.get('consciousness_metrics', {}).get('awareness_level', 0):.3f}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["train", "test", "interactive"], default="train",
