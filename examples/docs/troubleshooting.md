...
2. Validate configuration: `python -c "import examples; print('OK')"`
3. Review logs in `logs/examples.log`
...
```bash
# Check module health
python -m examples --health-check

# Validate configuration
python -m examples --validate-config

# Test connections
python -m examples --test-connections

# Generate diagnostic report
python -m examples --diagnostic-report
```
