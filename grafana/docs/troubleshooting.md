...
2. Validate configuration: `python -c "import grafana; print('OK')"`
3. Review logs in `logs/grafana.log`
...
```bash
# Check module health
python -m grafana --health-check

# Validate configuration
python -m grafana --validate-config

# Test connections
python -m grafana --test-connections

# Generate diagnostic report
python -m grafana --diagnostic-report
```
