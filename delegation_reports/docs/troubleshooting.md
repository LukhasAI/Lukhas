# Delegation_Reports Troubleshooting Guide
...
2. Validate configuration: `python -c "import delegation_reports; print('OK')"`
3. Review logs in `logs/delegation_reports.log`
...
```bash
# Check module health
python -m delegation_reports --health-check

# Validate configuration
python -m delegation_reports --validate-config

# Test connections
python -m delegation_reports --test-connections

# Generate diagnostic report
python -m delegation_reports --diagnostic-report
```
