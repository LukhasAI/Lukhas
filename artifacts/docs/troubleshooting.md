...
# Artifacts Troubleshooting Guide
...
2. Validate configuration: `python -c "import artifacts; print('OK')"`
3. Review logs in `logs/artifacts.log`
...
```bash
# Check module health
python -m artifacts --health-check

# Validate configuration
python -m artifacts --validate-config

# Test connections
python -m artifacts --test-connections

# Generate diagnostic report
python -m artifacts --diagnostic-report
```
