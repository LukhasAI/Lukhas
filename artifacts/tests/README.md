...
This directory contains the test suite for the artifacts module.
...
- **`test_artifacts_unit.py`** - Unit tests for individual components
- **`test_artifacts_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=artifacts --cov-report=html
```
