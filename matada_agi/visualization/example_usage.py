#!/usr/bin/env python3
"""
Example Usage of MATADA Graph Visualization System

This script demonstrates how to use the MATADAGraphViewer to visualize
cognitive nodes and their relationships in various ways.
"""

import time
from typing import Dict, Any
from graph_viewer import MATADAGraphViewer


def create_sample_matada_node(node_id: str, 
                             node_type: str,
                             confidence: float = 0.8,
                             salience: float = 0.7,
                             additional_state: Dict = None,
                             links: list = None) -> Dict[str, Any]:
    """Create a sample MATADA node for demonstration."""
    state = {
...
def main():
    ...
    print("MATADA Graph Visualization Example")
    print("=" * 40)
    ...
    # Sensory input
    sensory_node = create_sample_matada_node(
    ...
    # Memory retrieval
    memory_node = create_sample_matada_node(
        "memory_001", "MEMORY",
    ...
    # Emotional response
    emotion_node = create_sample_matada_node(
        "emotion_001", "EMOTION",
    ...
    # Decision making
    decision_node = create_sample_matada_node(
