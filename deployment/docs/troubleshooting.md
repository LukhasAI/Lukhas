...
2. Validate configuration: `python -c "import deployment; print('OK')"`
3. Review logs in `logs/deployment.log`
...
```bash
# Check module health
python -m deployment --health-check

# Validate configuration
python -m deployment --validate-config

# Test connections
python -m deployment --test-connections

# Generate diagnostic report
python -m deployment --diagnostic-report
```
