...
2. Validate configuration: `python -c "import utils; print('OK')"`
3. Review logs in `logs/utils.log`
...
```bash
# Check module health
python -m utils --health-check

# Validate configuration
python -m utils --validate-config

# Test connections
python -m utils --test-connections

# Generate diagnostic report
python -m utils --diagnostic-report
```
