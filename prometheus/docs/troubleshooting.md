...
2. Validate configuration: `python -c "import prometheus; print('OK')"`
3. Review logs in `logs/prometheus.log`
...
```bash
# Check module health
python -m prometheus --health-check

# Validate configuration
python -m prometheus --validate-config

# Test connections
python -m prometheus --test-connections

# Generate diagnostic report
python -m prometheus --diagnostic-report
```
