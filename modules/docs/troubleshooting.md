...
2. Validate configuration: `python -c "import modules; print('OK')"`
3. Review logs in `logs/modules.log`
...
```bash
# Check module health
python -m modules --health-check

# Validate configuration
python -m modules --validate-config

# Test connections
python -m modules --test-connections

# Generate diagnostic report
python -m modules --diagnostic-report
```
