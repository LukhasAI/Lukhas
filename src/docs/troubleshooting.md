...
2. Validate configuration: `python -c "import src; print('OK')"`
3. Review logs in `logs/src.log`
...
```bash
# Check module health
python -m src --health-check

# Validate configuration
python -m src --validate-config

# Test connections
python -m src --test-connections

# Generate diagnostic report
python -m src --diagnostic-report
```
