...
This directory contains the test suite for the personality module.
...
- **`test_personality_unit.py`** - Unit tests for individual components
- **`test_personality_integration.py`** - Integration tests for module interactions
...
### With Coverage
```bash
pytest tests/ --cov=personality --cov-report=html
```
