# Personality Troubleshooting Guide
...
2. Validate configuration: `python -c "import personality; print('OK')"`
3. Review logs in `logs/personality.log`
...
```bash
# Check module health
python -m personality --health-check

# Validate configuration
python -m personality --validate-config

# Test connections
python -m personality --test-connections

# Generate diagnostic report
python -m personality --diagnostic-report
```
